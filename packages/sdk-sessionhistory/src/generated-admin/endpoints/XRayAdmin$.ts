...
export class XRayAdmin$ {
  ...
  createXrayTicket_v2(data: XRayTicketObservabilityRequest): Promise<Response<XRayTicketObservabilityResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayTicketObservabilityResponse, 'XRayTicketObservabilityResponse')
  }
  ...
  createXrayTicketBulk_v2(data: XRayBulkTicketObservabilityRequest): Promise<Response<XRayBulkTicketObservabilityResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayBulkTicketObservabilityResponse, 'XRayBulkTicketObservabilityResponse')
  }
  
  /**
   * Query xray timeline by ticketID  
   */
  getXrayTicket_ByTicketId_v2(ticketId:string,  queryParams: {endDate: string | null, startDate: string | null, limit?: number, offset?: number}): Promise<Response<XRayTicketQueryResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayTicketQueryResponse, 'XRayTicketQueryResponse')
  }
  
  /**
   * Query total match.  
   */
  getXrayMetricsTotalMatch_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayMatchMatchmakingQueryResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchMatchmakingQueryResponse, 'XRayMatchMatchmakingQueryResponse')
  }
  
  /**
   * Query total success and failed claim DS.  
   */
  getXrayMetricsAcquiringDs_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayAcquiringDsQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/acquiring-ds'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayAcquiringDsQueryResponse, 'XRayAcquiringDsQueryResponse')
  }
  
  /**
   * Query xray match pool. query can using matchpool array with separate &#34;,&#34;  
   */
  getXrayMatchPool_ByPoolName_v2(poolName:string[],  queryParams: {endDate: string | null, startDate: string | null}): Promise<Response<XRayMatchPoolQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchPoolQueryResponse, 'XRayMatchPoolQueryResponse')
  }
  
  /**
   * Query xray timeline by userID or ticketID  
   */
  getTicketsXray_ByUserId_v2(userId:string,  queryParams: {endDate: string | null, startDate: string | null, limit?: number, offset?: number}): Promise<Response<XRayTicketQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
  ...
  getTicketsXray_ByMatchId_v2(matchId:string): Promise<Response<XRayMatchesQueryResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchesQueryResponse, 'XRayMatchesQueryResponse')
  }
  
  /**
   * Query total ticket match.  
   */
  getXrayMetricsTotalTicketMatch_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayMatchMatchmakingTicketQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-ticket-match'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchMatchmakingTicketQueryResponse, 'XRayMatchMatchmakingTicketQueryResponse')
  }
  
  /**
   * Query xray match histories.  
   */
  getHistoriesXray_ByMatchId_v2(matchId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<XRayMatchHistorQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchHistorQueryResponse, 'XRayMatchHistorQueryResponse')
  }
  
  /**
   * Query total active session.  
   */
  getXrayMetricsTotalActiveSession_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[], region?: string | null}): Promise<Response<XRayTotalActiveSessionQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayTotalActiveSessionQueryResponse, 'XRayTotalActiveSessionQueryResponse')
  }
  
  /**
   * Query total ticket created.  
   */
  getXrayMetricsTotalTicketCreated_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayCreatedMatchmakingTicketQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayCreatedMatchmakingTicketQueryResponse, 'XRayCreatedMatchmakingTicketQueryResponse')
  }
  
  /**
   * Query total ticket expired.  
   */
  getXrayMetricsTotalTicketExpired_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayExpiredMatchmakingTicketQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayExpiredMatchmakingTicketQueryResponse, 'XRayExpiredMatchmakingTicketQueryResponse')
  }
  
  /**
   * Query total ticket canceled.  
   */
  getXrayMetricsTotalTicketCanceled_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayCanceledMatchmakingTicketQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayCanceledMatchmakingTicketQueryResponse, 'XRayCanceledMatchmakingTicketQueryResponse')
  }
  
  /**
   * Query match length duration avg. time in seconds  
   */
  getXrayMetricsMatchLengthDurationAvg_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayMatchLengthDurationQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/match-length-duration-avg'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchLengthDurationQueryResponse, 'XRayMatchLengthDurationQueryResponse')
  }
  
  /**
   * Query match length duration p99. time in seconds  
   */
  getXrayMetricsMatchLengthDurationP99_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayMatchLengthDurationQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/match-length-duration-p99'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getTicketHistoriesXray_ByMatchId_v2(matchId:string): Promise<Response<XRayMatchTicketHistoryQueryResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchTicketHistoryQueryResponse, 'XRayMatchTicketHistoryQueryResponse')
  }
  
  /**
   * Query acquiring ds wait time average. time in seconds  
   */
  getXrayMetricsAcquiringDsWaitTimeAvg_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayAcquiringDsWaitTimeQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/acquiring-ds-wait-time-avg'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayAcquiringDsWaitTimeQueryResponse, 'XRayAcquiringDsWaitTimeQueryResponse')
  }
  
  /**
   * Query total player persession average.  
   */
  getXrayMetricsTotalPlayerPersessionAvg_v2( queryParams: {endDate: string | null, startDate: string | null, matchPool?: string[]}): Promise<Response<XRayTotalPlayerPersessionAvgQueryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v2/admin/namespaces/{namespace}/xray/metrics/total-player-persession-avg'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayTotalPlayerPersessionAvgQueryResponse, 'XRayTotalPlayerPersessionAvgQueryResponse')
  }
  
  /**
   * Query xray match pool ticks.  
   */
  getTicksXray_ByPoolName_ByPodName_v2(poolName:string, podName:string,  queryParams: {endDate: string | null, startDate: string | null, all?: boolean | null, limit?: number, offset?: number}): Promise<Response<XRayMatchPoolPodTickQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchPoolPodTickQueryResponse, 'XRayMatchPoolPodTickQueryResponse')
  }
  ...
  getMatchesXray_ByPoolName_ByPodName_ByTickId_v2(poolName:string, podName:string, tickId:string): Promise<Response<XRayMatchPoolPodTickMatchResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchPoolPodTickMatchResponse, 'XRayMatchPoolPodTickMatchResponse')
  }
  ...
  getTicketsXray_ByPoolName_ByPodName_ByTickId_v2(poolName:string, podName:string, tickId:string): Promise<Response<XRayMatchPoolPodTickTicketResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, XRayMatchPoolPodTickTicketResponse, 'XRayMatchPoolPodTickTicketResponse')
  }
