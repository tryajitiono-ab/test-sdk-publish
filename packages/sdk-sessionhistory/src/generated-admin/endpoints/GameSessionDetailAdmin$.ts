...
export class GameSessionDetailAdmin$ {
   ...
   * Get all parties. 
   */
  getParties( queryParams?: {limit?: number, offset?: number, order?: string | null, orderBy?: string | null, partyID?: string | null, userID?: string | null}): Promise<Response<PartyDetailQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v1/admin/namespaces/{namespace}/parties'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PartyDetailQueryResponse, 'PartyDetailQueryResponse')
  }
  
  /**
   * Get all matchmaking ticket. 
   */
  getTickets( queryParams?: {endDate?: string | null, gameMode?: string | null, limit?: number, offset?: number, order?: string | null, partyID?: string | null, region?: string | null, startDate?: string | null, userIDs?: string | null}): Promise<Response<TicketDetailQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v1/admin/namespaces/{namespace}/tickets'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TicketDetailQueryResponse, 'TicketDetailQueryResponse')
  }
  
  /**
   * Get all matchmaking. 
   */
  getMatchmaking( queryParams?: {gameSessionID?: string | null, limit?: number, offset?: number, order?: string | null, orderBy?: string | null, ticketID?: string | null, userID?: string | null}): Promise<Response<MatchmakingDetailQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v1/admin/namespaces/{namespace}/matchmaking'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, MatchmakingDetailQueryResponse, 'MatchmakingDetailQueryResponse')
  }
  
  /**
   * Get all game sessions. 
   */
  getGamesessions( queryParams?: {endDate?: string | null, gameSessionID?: string | null, limit?: number, offset?: number, order?: string | null, orderBy?: string | null, startDate?: string | null, userID?: string | null}): Promise<Response<GameSessionDetailQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/sessionhistory/v1/admin/namespaces/{namespace}/gamesessions'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GameSessionDetailQueryResponse, 'GameSessionDetailQueryResponse')
  }
  ...
  getTicket_ByTicketId(ticketId:string): Promise<Response<TicketObservabilityDetail>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TicketObservabilityDetail, 'TicketObservabilityDetail')
  }
