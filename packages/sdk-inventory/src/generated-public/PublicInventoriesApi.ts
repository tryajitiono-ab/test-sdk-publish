...
export function PublicInventoriesApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsersMeInventories( queryParams?: {inventoryConfigurationCode?: string | null, limit?: number, offset?: number, sortBy?: 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'updatedAt' | 'updatedAt:asc' | 'updatedAt:desc'}): Promise<AxiosResponse<ListInventoryResp>> {
