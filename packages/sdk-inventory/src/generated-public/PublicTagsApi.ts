...
export function PublicTagsApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getTags( queryParams?: {limit?: number, offset?: number, sortBy?: 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'name' | 'name:asc' | 'name:desc'}): Promise<AxiosResponse<ListTagsResp>> {
