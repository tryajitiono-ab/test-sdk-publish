...
export class InventoryConfigurationsAdmin$ {
   ...
   */
  getInventoryConfigurations( queryParams?: {code?: string | null, limit?: number, offset?: number, sortBy?: 'code' | 'code:asc' | 'code:desc' | 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'updatedAt' | 'updatedAt:asc' | 'updatedAt:desc'}): Promise<Response<ListInventoryConfigurationsResp>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListInventoryConfigurationsResp, 'ListInventoryConfigurationsResp')
  }
  ...
  createInventoryConfiguration(data: CreateInventoryConfigurationReq): Promise<Response<InventoryConfigurationResp>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, InventoryConfigurationResp, 'InventoryConfigurationResp')
  }
  ...
  deleteInventoryConfiguration_ByInventoryConfigurationId(inventoryConfigurationId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/inventory/v1/admin/namespaces/{namespace}/inventoryConfigurations/{inventoryConfigurationId}'.replace('{namespace}', this.namespace).replace('{inventoryConfigurationId}', inventoryConfigurationId)     
   ...
   */
  updateInventoryConfiguration_ByInventoryConfigurationId(inventoryConfigurationId:string, data: InventoryConfigurationReq): Promise<Response<InventoryConfigurationResp>> {
    const params = {} as AxiosRequestConfig
    const url = '/inventory/v1/admin/namespaces/{namespace}/inventoryConfigurations/{inventoryConfigurationId}'.replace('{namespace}', this.namespace).replace('{inventoryConfigurationId}', inventoryConfigurationId)     
