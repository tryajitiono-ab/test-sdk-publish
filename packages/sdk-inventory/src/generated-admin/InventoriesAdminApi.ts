...
export function InventoriesAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getInventories( queryParams?: {inventoryConfigurationCode?: string | null, limit?: number, offset?: number, sortBy?: 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'inventoryConfigurationCode' | 'inventoryConfigurationCode:asc' | 'inventoryConfigurationCode:desc' | 'updatedAt' | 'updatedAt:asc' | 'updatedAt:desc', userId?: string | null}): Promise<AxiosResponse<ListInventoryResp>> {
   ...
   */
  async function updateInventory_ByUserId_ByInventoryConfigurationCode(userId:string, inventoryConfigurationCode:string, data: UpdateInventoryReq): Promise<AxiosResponse<InventoryRespArray>> {
    const $ = new InventoriesAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getInventories,createInventory,deleteInventory_ByInventoryId,getInventory_ByInventoryId,updateInventory_ByInventoryId,createPurchaseable_ByUserId,updateInventory_ByUserId_ByInventoryConfigurationCode,
  }
}
