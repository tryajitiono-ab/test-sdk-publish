...
export function ItemTypesAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getItemtypes( queryParams?: {limit?: number, offset?: number, sortBy?: 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'name' | 'name:asc' | 'name:desc'}): Promise<AxiosResponse<ListItemTypesResp>> {
  ...
  return {
    getItemtypes,createItemtype,deleteItemtype_ByItemTypeName,
  }
}
