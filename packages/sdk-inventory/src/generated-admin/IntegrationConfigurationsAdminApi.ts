...
export function IntegrationConfigurationsAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getIntegrationConfigurations( queryParams?: {limit?: number, offset?: number, sortBy?: 'createdAt' | 'createdAt:asc' | 'createdAt:desc'}): Promise<AxiosResponse<ListIntegrationConfigurationsResp>> {
   ...
   */
  async function createIntegrationConfiguration(data: CreateIntegrationConfigurationReq): Promise<AxiosResponse<IntegrationConfigurationResp>> {
    const $ = new IntegrationConfigurationsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateIntegrationConfiguration_ByIntegrationConfigurationId(integrationConfigurationId:string, data: UpdateIntegrationConfigurationReq): Promise<AxiosResponse<IntegrationConfigurationResp>> {
    const $ = new IntegrationConfigurationsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateStatus_ByIntegrationConfigurationId(integrationConfigurationId:string, data: UpdateStatusIntegrationConfigurationReq): Promise<AxiosResponse<IntegrationConfigurationResp>> {
    const $ = new IntegrationConfigurationsAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getIntegrationConfigurations,createIntegrationConfiguration,updateIntegrationConfiguration_ByIntegrationConfigurationId,updateStatus_ByIntegrationConfigurationId,
  }
}
