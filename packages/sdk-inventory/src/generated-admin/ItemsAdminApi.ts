...
export function ItemsAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getItems_ByInventoryId(inventoryId:string,  queryParams?: {limit?: number, offset?: number, sortBy?: 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'updatedAt' | 'updatedAt:asc' | 'updatedAt:desc', sourceItemId?: string | null, tags?: string | null}): Promise<AxiosResponse<ListItemResp>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteItem_ByUserId_ByInventoryId(userId:string, inventoryId:string, data: RemoveInventoryItemReq[]): Promise<AxiosResponse<UpdateItemRespArray>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createItem_ByUserId_ByInventoryId(userId:string, inventoryId:string, data: SaveItemToInventoryReq): Promise<AxiosResponse<ItemResp>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateItem_ByUserId_ByInventoryId(userId:string, inventoryId:string, data: AdminUpdateItemReq[]): Promise<AxiosResponse<UpdateItemRespArray>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createConsume_ByUserId_ByInventoryId(userId:string, inventoryId:string, data: ConsumeItemReq): Promise<AxiosResponse<ItemResp>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createItemBulk_ByUserId_ByInventoryId(userId:string, inventoryId:string, data: SaveItemToInventoryReq[]): Promise<AxiosResponse<BulkSaveItemRespArray>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getSourceItem_ByInventoryId_BySlotId_BySourceItemId(inventoryId:string, slotId:string, sourceItemId:string): Promise<AxiosResponse<ItemResp>> {
    const $ = new ItemsAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createItem_ByUserId,createItemBulk_ByUserId,getItems_ByInventoryId,updateItemEntitlementSync_ByUserId,deleteItem_ByUserId_ByInventoryId,createItem_ByUserId_ByInventoryId,updateItem_ByUserId_ByInventoryId,createConsume_ByUserId_ByInventoryId,createItemBulk_ByUserId_ByInventoryId,getSourceItem_ByInventoryId_BySlotId_BySourceItemId,
  }
}
