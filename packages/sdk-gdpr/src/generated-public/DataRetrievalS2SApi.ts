...
export function DataRetrievalS2SApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getS2SRequestsFinished( queryParams: {end: string | null, start: string | null}): Promise<AxiosResponse<ListFinishedDataRequests>> {
  ...
  return {
    getS2SRequestsFinished,createRequestS2_ByUserId,fetchGenerateS2_ByUserId_ByRequestDate,
  }
}
