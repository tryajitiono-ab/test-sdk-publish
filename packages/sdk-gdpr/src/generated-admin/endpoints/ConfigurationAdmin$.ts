...
export class ConfigurationAdmin$ {
  ...
  getServicesConfigurations(): Promise<Response<ServicesConfigurationResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ServicesConfigurationResponse, 'ServicesConfigurationResponse')
  }
  ...
  updateServiceConfiguration(data: ServiceConfigurationUpdateRequest): Promise<Response<ServiceConfigurationUpdateRequest>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ServiceConfigurationUpdateRequest, 'ServiceConfigurationUpdateRequest')
  }
