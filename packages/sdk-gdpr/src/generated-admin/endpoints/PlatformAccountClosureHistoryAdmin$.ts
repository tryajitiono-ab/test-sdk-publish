...
export class PlatformAccountClosureHistoryAdmin$ {
   ...
   */
  getUsersPlatformsClosureHistories( queryParams?: {limit?: number, offset?: number, platform?: string | null, userId?: string | null}): Promise<Response<UserPlatformAccountClosureHistoriesResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserPlatformAccountClosureHistoriesResponse, 'UserPlatformAccountClosureHistoriesResponse')
  }
