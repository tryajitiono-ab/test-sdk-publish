...
export function ConfigurationAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function updateServiceConfiguration(data: ServiceConfigurationUpdateRequest): Promise<AxiosResponse<ServiceConfigurationUpdateRequest>> {
    const $ = new ConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateServicePlatformClosureConfig(data: ServiceConfigurationUpdateRequest): Promise<AxiosResponse<ServiceConfigurationUpdateRequest>> {
    const $ = new ConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    deleteEmailConfiguration,getEmailsConfigurations,createEmailConfiguration,updateEmailConfiguration,getServicesConfigurations,updateServiceConfiguration,deleteServiceConfigurationReset,deleteServicePlatformClosureConfig,getServicesPlatformsClosureConfig,updateServicePlatformClosureConfig,
  }
}
