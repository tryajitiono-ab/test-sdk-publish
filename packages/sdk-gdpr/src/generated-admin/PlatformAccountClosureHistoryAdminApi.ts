...
export function PlatformAccountClosureHistoryAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsersPlatformsClosureHistories( queryParams?: {limit?: number, offset?: number, platform?: string | null, userId?: string | null}): Promise<AxiosResponse<UserPlatformAccountClosureHistoriesResponse>> {
