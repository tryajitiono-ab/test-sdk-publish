...
export class Reward$ {
  ...
  createSeasonCurrentReward_ByUserId(userId:string, data: UserRewardClaim): Promise<Response<ClaimableRewards>> {
    ...
    const url = '/seasonpass/public/namespaces/{namespace}/users/{userId}/seasons/current/rewards'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
  ...
  createSeasonCurrentRewardBulk_ByUserId(userId:string): Promise<Response<ClaimableRewards>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/public/namespaces/{namespace}/users/{userId}/seasons/current/rewards/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
