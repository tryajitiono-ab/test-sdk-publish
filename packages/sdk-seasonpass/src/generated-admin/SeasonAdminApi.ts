...
export function SeasonAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getSeasons( queryParams?: {limit?: number, offset?: number, status?: string[]}): Promise<AxiosResponse<ListSeasonInfoPagingSlicedResult>> {
   ...
   */
  async function getSeasons_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<ListUserSeasonInfoPagingSlicedResult>> {
    const $ = new SeasonAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateUnpublish_BySeasonId(seasonId:string,  queryParams?: {force?: boolean | null}): Promise<AxiosResponse<SeasonInfo>> {
    const $ = new SeasonAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getSeasonsExpHistory_ByUserId(userId:string,  queryParams?: {from?: string | null, limit?: number, offset?: number, seasonId?: string | null, source?: 'PAID_FOR' | 'SWEAT', tags?: string[], to?: string | null}): Promise<AxiosResponse<ExpGrantHistoryPagingSlicedResult>> {
    const $ = new SeasonAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getSeasonsExpHistoryTags_ByUserId(userId:string,  queryParams?: {seasonId?: string | null}): Promise<AxiosResponse<ReasonTagsResult>> {
    const $ = new SeasonAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getSeasonsCurrentPassesOwnershipAny_ByUserId(userId:string,  queryParams?: {passCodes?: string[]}): Promise<AxiosResponse<Ownership>> {
    const $ = new SeasonAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getSeasons,createSeason,getSeasonsCurrent,deleteSeason_BySeasonId,getSeason_BySeasonId,patchSeason_BySeasonId,getSeasons_ByUserId,getFull_BySeasonId,createClone_BySeasonId,updateRetire_BySeasonId,updatePublish_BySeasonId,updateUnpublish_BySeasonId,getSeasonsExpHistory_ByUserId,deleteSeasonCurrentReset_ByUserId,createSeasonCurrentUserBulkProgression,getData_ByUserId_BySeasonId,getSeasonsExpHistoryTags_ByUserId,getSeasonsCurrentProgression_ByUserId,createSeasonCurrentPurchasable_ByUserId,getSeasonsCurrentPassesOwnershipAny_ByUserId,
  }
}
