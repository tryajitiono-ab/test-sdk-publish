...
export class SeasonAdmin$ {
  ...
  getSeasons( queryParams?: {limit?: number, offset?: number, status?: string[]}): Promise<Response<ListSeasonInfoPagingSlicedResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListSeasonInfoPagingSlicedResult, 'ListSeasonInfoPagingSlicedResult')
  }
  ...
  deleteSeason_BySeasonId(seasonId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
   ...
   */
  getSeasons_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<ListUserSeasonInfoPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListUserSeasonInfoPagingSlicedResult, 'ListUserSeasonInfoPagingSlicedResult')
  }
  ...
  getFull_BySeasonId(seasonId:string): Promise<Response<FullSeasonInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/full'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  createClone_BySeasonId(seasonId:string, data: SeasonCloneRequest): Promise<Response<SeasonInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/clone'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  updateRetire_BySeasonId(seasonId:string,  queryParams?: {force?: boolean | null}): Promise<Response<SeasonInfo>> {
    ...
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/retire'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
  ...
  updatePublish_BySeasonId(seasonId:string): Promise<Response<SeasonInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/publish'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
    const resultPromise = this.axiosInstance.put(url, null, {params})
  ...
  updateUnpublish_BySeasonId(seasonId:string,  queryParams?: {force?: boolean | null}): Promise<Response<SeasonInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/unpublish'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
    const resultPromise = this.axiosInstance.put(url, null, {params})
   ...
   */
  getSeasonsExpHistory_ByUserId(userId:string,  queryParams?: {from?: string | null, limit?: number, offset?: number, seasonId?: string | null, source?: 'PAID_FOR' | 'SWEAT', tags?: string[], to?: string | null}): Promise<Response<ExpGrantHistoryPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/exp/history'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ExpGrantHistoryPagingSlicedResult, 'ExpGrantHistoryPagingSlicedResult')
  }
  ...
  deleteSeasonCurrentReset_ByUserId(userId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/reset'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  createSeasonCurrentUserBulkProgression(data: BulkUserProgressionRequest): Promise<Response<UserSeasonSummaryArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserSeasonSummaryArray, 'UserSeasonSummaryArray')
  }
  ...
  getData_ByUserId_BySeasonId(userId:string, seasonId:string): Promise<Response<ClaimableUserSeasonInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/{seasonId}/data'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{seasonId}', seasonId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ClaimableUserSeasonInfo, 'ClaimableUserSeasonInfo')
  }
  ...
  getSeasonsExpHistoryTags_ByUserId(userId:string,  queryParams?: {seasonId?: string | null}): Promise<Response<ReasonTagsResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/exp/history/tags'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getSeasonsCurrentProgression_ByUserId(userId:string): Promise<Response<UserSeasonSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/progression'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  createSeasonCurrentPurchasable_ByUserId(userId:string, data: UserPurchasable): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/purchasable'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  getSeasonsCurrentPassesOwnershipAny_ByUserId(userId:string,  queryParams?: {passCodes?: string[]}): Promise<Response<Ownership>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/passes/ownership/any'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
