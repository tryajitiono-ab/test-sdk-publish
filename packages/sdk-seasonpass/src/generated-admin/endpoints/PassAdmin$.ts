...
export class PassAdmin$ {
  ...
  getPasses_BySeasonId(seasonId:string): Promise<Response<PassInfoArray>> {
    ...
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/passes'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
  ...
  deletePasse_BySeasonId_ByCode(seasonId:string, code:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/passes/{code}'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId).replace('{code}', code)     
  ...
  createSeasonCurrentPasse_ByUserId(userId:string, data: UserPassGrant): Promise<Response<UserSeasonSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/passes'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
