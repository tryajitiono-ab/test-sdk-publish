...
export class TierAdmin$ {
  ...
  getTiers_BySeasonId(seasonId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<TierPagingSlicedResult>> {
    ...
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/tiers'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TierPagingSlicedResult, 'TierPagingSlicedResult')
  }
  ...
  deleteTier_BySeasonId_ById(seasonId:string, id:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/tiers/{id}'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId).replace('{id}', id)     
  ...
  createSeasonCurrentExp_ByUserId(userId:string, data: UserExpGrant): Promise<Response<UserSeasonSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/exp'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createSeasonCurrentTier_ByUserId(userId:string, data: UserTierGrant): Promise<Response<UserSeasonSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/users/{userId}/seasons/current/tiers'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  updateReorder_BySeasonId_ById(seasonId:string, id:string, data: TierReorder): Promise<Response<Tier>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/tiers/{id}/reorder'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId).replace('{id}', id)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
