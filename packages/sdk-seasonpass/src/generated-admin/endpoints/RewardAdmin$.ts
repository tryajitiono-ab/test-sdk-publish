...
export class RewardAdmin$ {
  ...
  getRewards_BySeasonId(seasonId:string,  queryParams?: {q?: string | null}): Promise<Response<RewardInfoArray>> {
    ...
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/rewards'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId)     
  ...
  deleteReward_BySeasonId_ByCode(seasonId:string, code:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/seasonpass/admin/namespaces/{namespace}/seasons/{seasonId}/rewards/{code}'.replace('{namespace}', this.namespace).replace('{seasonId}', seasonId).replace('{code}', code)     
