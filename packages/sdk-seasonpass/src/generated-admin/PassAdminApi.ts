...
export function PassAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  return {
    getPasses_BySeasonId,createPasse_BySeasonId,deletePasse_BySeasonId_ByCode,getPasse_BySeasonId_ByCode,patchPasse_BySeasonId_ByCode,createSeasonCurrentPasse_ByUserId,
  }
}
