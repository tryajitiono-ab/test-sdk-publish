...
export function TierAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getTiers_BySeasonId(seasonId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<TierPagingSlicedResult>> {
  ...
  return {
    getTiers_BySeasonId,createTier_BySeasonId,deleteTier_BySeasonId_ById,updateTier_BySeasonId_ById,createSeasonCurrentExp_ByUserId,createSeasonCurrentTier_ByUserId,updateReorder_BySeasonId_ById,
  }
}
