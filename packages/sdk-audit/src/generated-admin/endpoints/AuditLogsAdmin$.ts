...
export class AuditLogsAdmin$ {
   ...
   */
  getLogs( queryParams?: {action?: string | null, actor?: string | null, actorType?: 'CLIENT' | 'USER', category?: string | null, endDate?: number, limit?: number, namespace?: string | null, objectId?: string | null, objectType?: string | null, offset?: number, order?: -1 | 1, startDate?: number}): Promise<Response<PaginatedAuditLogsResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/audit/v1/admin/logs'     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PaginatedAuditLogsResponse, 'PaginatedAuditLogsResponse')
  }
  
  /**
   * This API is used to query category and related action names. 
   */
  getConfigCategories( queryParams?: {endDate?: number, namespace?: string | null, startDate?: number}): Promise<Response<CategoryResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getConfigTimeRange(): Promise<Response<TimeRangeConfigResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TimeRangeConfigResponse, 'TimeRangeConfigResponse')
  }
