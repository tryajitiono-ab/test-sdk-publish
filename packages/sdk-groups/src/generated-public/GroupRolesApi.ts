...
export function GroupRolesApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function createMember_ByMemberRoleId(memberRoleId:string, data: AssignRoleToMemberRequestV1): Promise<AxiosResponse<GetUserGroupInformationResponseV1>> {
    const $ = new GroupRoles$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required Member Role Permission: &#34;GROUP:ROLE \[UPDATE\]&#34; This endpoint is used to remove role from group member Action Code: 73204 
   */
  async function deleteMember_ByMemberRoleId_ByGroupId_v2(memberRoleId:string, groupId:string, data: RemoveRoleFromMemberRequestV1): Promise<AxiosResponse<unknown>> {
    const $ = new GroupRoles$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required Member Role Permission: &#34;GROUP:ROLE [UPDATE] This endpoint is used to assign role to group member Action Code: 73204 
   */
  async function createMember_ByMemberRoleId_ByGroupId_v2(memberRoleId:string, groupId:string, data: AssignRoleToMemberRequestV1): Promise<AxiosResponse<GetUserGroupInformationResponseV1>> {
    const $ = new GroupRoles$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getRoles,getRoles_v2,deleteMember_ByMemberRoleId,createMember_ByMemberRoleId,deleteMember_ByMemberRoleId_ByGroupId_v2,createMember_ByMemberRoleId_ByGroupId_v2,
  }
}
