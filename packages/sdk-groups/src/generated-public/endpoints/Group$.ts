...
export class Group$ {
   ...
   */
  getGroups( queryParams?: {groupName?: string | null, groupRegion?: string | null, limit?: number, offset?: number}): Promise<Response<GetGroupsListResponseV1>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetGroupsListResponseV1, 'GetGroupsListResponseV1')
  }
  ...
  deleteGroup_ByGroupId(groupId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups/{groupId}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
  ...
  deleteGroup_ByGroupId_v2(groupId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  updateRuleCustom_ByGroupId(groupId:string, data: UpdateGroupCustomRuleRequestV1): Promise<Response<GroupResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups/{groupId}/rules/custom'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  updateRuleCustom_ByGroupId_v2(groupId:string, data: UpdateGroupCustomRuleRequestV1): Promise<Response<GroupResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}/rules/custom'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  updateAttributeCustom_ByGroupId(groupId:string, data: UpdateGroupCustomAttributesRequestV1): Promise<Response<GroupResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups/{groupId}/attributes/custom'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  updateAttributeCustom_ByGroupId_v2(groupId:string, data: UpdateGroupCustomAttributesRequestV1): Promise<Response<GroupResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}/attributes/custom'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  deleteRuleDefined_ByGroupId_ByAllowedAction(groupId:string, allowedAction:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups/{groupId}/rules/defined/{allowedAction}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId).replace('{allowedAction}', allowedAction)     
    const resultPromise = this.axiosInstance.delete(url, {params})
   ...
   */
  updateRuleDefined_ByGroupId_ByAllowedAction(groupId:string, allowedAction:string, data: UpdateGroupPredefinedRuleRequestV1): Promise<Response<GroupResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups/{groupId}/rules/defined/{allowedAction}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId).replace('{allowedAction}', allowedAction)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  deleteRuleDefined_ByGroupId_ByAllowedAction_v2(groupId:string, allowedAction:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}/rules/defined/{allowedAction}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId).replace('{allowedAction}', allowedAction)     
    const resultPromise = this.axiosInstance.delete(url, {params})
   ...
   * Required valid user authentication Required Member Role Permission: &#34;GROUP [UPDATE]&#34; Update predefined group rule. This endpoint will check the group ID of the user based on the access token and compare it with the group ID in path parameter. It will also check the member role of the user based on the access token If the rule action is not defined in the group, it will be added immediately to the predefined group rule Action Code: 73310  
   */
  updateRuleDefined_ByGroupId_ByAllowedAction_v2(groupId:string, allowedAction:string, data: UpdateGroupPredefinedRuleRequestV1): Promise<Response<GroupResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}/rules/defined/{allowedAction}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId).replace('{allowedAction}', allowedAction)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
