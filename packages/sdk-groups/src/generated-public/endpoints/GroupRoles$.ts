...
export class GroupRoles$ {
  ...
  getRoles( queryParams?: {limit?: number, offset?: number}): Promise<Response<GetMemberRolesListResponseV1>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetMemberRolesListResponseV1, 'GetMemberRolesListResponseV1')
  }
  ...
  deleteMember_ByMemberRoleId(memberRoleId:string, data: RemoveRoleFromMemberRequestV1): Promise<Response<unknown>> {
    ...
    const url = '/group/v1/public/namespaces/{namespace}/roles/{memberRoleId}/members'.replace('{namespace}', this.namespace).replace('{memberRoleId}', memberRoleId)     
   ...
   */
  createMember_ByMemberRoleId(memberRoleId:string, data: AssignRoleToMemberRequestV1): Promise<Response<GetUserGroupInformationResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/roles/{memberRoleId}/members'.replace('{namespace}', this.namespace).replace('{memberRoleId}', memberRoleId)     
   ...
   * Required Member Role Permission: &#34;GROUP:ROLE \[UPDATE\]&#34; This endpoint is used to remove role from group member Action Code: 73204 
   */
  deleteMember_ByMemberRoleId_ByGroupId_v2(memberRoleId:string, groupId:string, data: RemoveRoleFromMemberRequestV1): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/roles/{memberRoleId}/groups/{groupId}/members'.replace('{namespace}', this.namespace).replace('{memberRoleId}', memberRoleId).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.delete(url, {data, params})
   ...
   * Required Member Role Permission: &#34;GROUP:ROLE [UPDATE] This endpoint is used to assign role to group member Action Code: 73204 
   */
  createMember_ByMemberRoleId_ByGroupId_v2(memberRoleId:string, groupId:string, data: AssignRoleToMemberRequestV1): Promise<Response<GetUserGroupInformationResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/roles/{memberRoleId}/groups/{groupId}/members'.replace('{namespace}', this.namespace).replace('{memberRoleId}', memberRoleId).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
