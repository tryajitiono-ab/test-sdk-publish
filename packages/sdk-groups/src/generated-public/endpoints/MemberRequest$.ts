...
export class MemberRequest$ {
  ...
  getUsersMeJoinRequest_v2( queryParams?: {limit?: number, offset?: number}): Promise<Response<GetMemberRequestsListResponseV1>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetMemberRequestsListResponseV1, 'GetMemberRequestsListResponseV1')
  }
   ...
   */
  getJoinRequest_ByGroupId(groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<GetMemberRequestsListResponseV1>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/group/v1/public/namespaces/{namespace}/groups/{groupId}/join/request'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   * Required valid user authentication Required Member Role Permission: &#34;GROUP:JOIN [READ]&#34; This endpoint is used to Get Group Join Request List Get Group Join Request List for specific group. Group members needs to have permission and also belong to the group to access this endpoint Action Code: 73501  
   */
  getJoinRequest_ByGroupId_v2(groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<GetMemberRequestsListResponseV1>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}/join/request'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  getInviteRequest_ByGroupId_v2(groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<GetMemberRequestsListResponseV1>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/group/v2/public/namespaces/{namespace}/groups/{groupId}/invite/request'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.get(url, {params})
