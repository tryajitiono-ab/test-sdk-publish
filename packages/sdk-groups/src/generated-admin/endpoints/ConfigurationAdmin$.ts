...
export class ConfigurationAdmin$ {
  ...
  getConfiguration( queryParams?: {limit?: number, offset?: number}): Promise<Response<ListConfigurationResponseV1>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListConfigurationResponseV1, 'ListConfigurationResponseV1')
  }
  ...
  createConfiguration(data: CreateGroupConfigurationRequestV1): Promise<Response<CreateGroupConfigurationResponseV1>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CreateGroupConfigurationResponseV1, 'CreateGroupConfigurationResponseV1')
  }
  ...
  deleteConfiguration_ByConfigurationCode(configurationCode:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/admin/namespaces/{namespace}/configuration/{configurationCode}'.replace('{namespace}', this.namespace).replace('{configurationCode}', configurationCode)     
  ...
  getConfiguration_ByConfigurationCode(configurationCode:string): Promise<Response<GetGroupConfigurationResponseV1>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetGroupConfigurationResponseV1, 'GetGroupConfigurationResponseV1')
  }
   ...
   */
  patchConfiguration_ByConfigurationCode(configurationCode:string, data: UpdateGroupConfigurationRequestV1): Promise<Response<UpdateGroupConfigurationResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/admin/namespaces/{namespace}/configuration/{configurationCode}'.replace('{namespace}', this.namespace).replace('{configurationCode}', configurationCode)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UpdateGroupConfigurationResponseV1, 'UpdateGroupConfigurationResponseV1')
  }
   ...
   */
  deleteRule_ByConfigurationCode_ByAllowedAction(configurationCode:string, allowedAction:string): Promise<Response<UpdateGroupConfigurationResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/admin/namespaces/{namespace}/configuration/{configurationCode}/rules/{allowedAction}'.replace('{namespace}', this.namespace).replace('{configurationCode}', configurationCode).replace('{allowedAction}', allowedAction)     
    const resultPromise = this.axiosInstance.delete(url, {params})
   ...
   */
  updateRule_ByConfigurationCode_ByAllowedAction(configurationCode:string, allowedAction:string, data: UpdateGroupConfigurationGlobalRulesRequestV1): Promise<Response<UpdateGroupConfigurationResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/admin/namespaces/{namespace}/configuration/{configurationCode}/rules/{allowedAction}'.replace('{namespace}', this.namespace).replace('{configurationCode}', configurationCode).replace('{allowedAction}', allowedAction)     
