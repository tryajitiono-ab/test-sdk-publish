...
export class GroupRolesAdmin$ {
  ...
  deleteRole_ByMemberRoleId(memberRoleId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/admin/namespaces/{namespace}/roles/{memberRoleId}'.replace('{namespace}', this.namespace).replace('{memberRoleId}', memberRoleId)     
   ...
   */
  updatePermission_ByMemberRoleId(memberRoleId:string, data: UpdateMemberRolePermissionsRequestV1): Promise<Response<MemberRoleResponseV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/group/v1/admin/namespaces/{namespace}/roles/{memberRoleId}/permissions'.replace('{namespace}', this.namespace).replace('{memberRoleId}', memberRoleId)     
