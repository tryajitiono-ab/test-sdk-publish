...
export function GroupRolesAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function patchRole_ByMemberRoleId(memberRoleId:string, data: UpdateMemberRoleRequestV1): Promise<AxiosResponse<MemberRoleResponseV1>> {
    const $ = new GroupRolesAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePermission_ByMemberRoleId(memberRoleId:string, data: UpdateMemberRolePermissionsRequestV1): Promise<AxiosResponse<MemberRoleResponseV1>> {
    const $ = new GroupRolesAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getRoles,createRole,deleteRole_ByMemberRoleId,getRole_ByMemberRoleId,patchRole_ByMemberRoleId,updatePermission_ByMemberRoleId,
  }
}
