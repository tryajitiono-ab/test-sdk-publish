...
export function ConfigurationAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function patchConfiguration_ByConfigurationCode(configurationCode:string, data: UpdateGroupConfigurationRequestV1): Promise<AxiosResponse<UpdateGroupConfigurationResponseV1>> {
    const $ = new ConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteRule_ByConfigurationCode_ByAllowedAction(configurationCode:string, allowedAction:string): Promise<AxiosResponse<UpdateGroupConfigurationResponseV1>> {
    const $ = new ConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateRule_ByConfigurationCode_ByAllowedAction(configurationCode:string, allowedAction:string, data: UpdateGroupConfigurationGlobalRulesRequestV1): Promise<AxiosResponse<UpdateGroupConfigurationResponseV1>> {
    const $ = new ConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getConfiguration,createConfiguration,createConfigurationInitiate,deleteConfiguration_ByConfigurationCode,getConfiguration_ByConfigurationCode,patchConfiguration_ByConfigurationCode,deleteRule_ByConfigurationCode_ByAllowedAction,updateRule_ByConfigurationCode_ByAllowedAction,
  }
}
