...
export function GoalConfigurationAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getGoals_ByChallengeCode(challengeCode:string,  queryParams?: {limit?: number, offset?: number, sortBy?: string | null}): Promise<AxiosResponse<GetGoalsResponse>> {
   ...
   */
  async function updateGoal_ByChallengeCode_ByCode(challengeCode:string, code:string, data: UpdateGoalRequest): Promise<AxiosResponse<GoalResponse>> {
    const $ = new GoalConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getGoals_ByChallengeCode,createGoal_ByChallengeCode,deleteGoal_ByChallengeCode_ByCode,getGoal_ByChallengeCode_ByCode,updateGoal_ByChallengeCode_ByCode,
  }
}
