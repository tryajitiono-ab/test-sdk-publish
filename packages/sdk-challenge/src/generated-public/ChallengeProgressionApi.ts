...
export function ChallengeProgressionApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUserMeProgres_ByChallengeCode(challengeCode:string,  queryParams?: {dateTime?: string | null, goalCode?: string | null, limit?: number, offset?: number, tags?: string[]}): Promise<AxiosResponse<UserProgressionResponse>> {
    const $ = new ChallengeProgression$(axiosInstance, namespace, useSchemaValidation)
   ...
   * &lt;ul&gt;&lt;li&gt;Required permission: NAMESPACE:{namespace}:CHALLENGE:PROGRESSION [READ]&lt;/li&gt;&lt;/ul&gt; 
   */
  async function getIndexMeUser_ByChallengeCode_ByIndex(challengeCode:string, index:number,  queryParams?: {goalCode?: string | null, limit?: number, offset?: number, tags?: string[]}): Promise<AxiosResponse<UserProgressionResponse>> {
    const $ = new ChallengeProgression$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createUserMeProgresEvaluate,getUserMeProgres_ByChallengeCode,getIndexMeUser_ByChallengeCode_ByIndex,
  }
}
