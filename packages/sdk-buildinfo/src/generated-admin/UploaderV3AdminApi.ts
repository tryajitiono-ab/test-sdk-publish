...
export function UploaderV3AdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function createStartbuildupload_BySourceBuildId_v3(sourceBuildId:string, data: UploadBuildManifest): Promise<AxiosResponse<DifferentialBuildManifest>> {
    const $ = new UploaderV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchCommitzsyncfileupload_ByBuildId_ByHash_v3(buildId:string, hash:string, data: DiffPatchRequest): Promise<AxiosResponse<BlockManifest>> {
    const $ = new UploaderV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateVersion_ByAppId_ByVersion_ByPlatformId_v3(appId:string, version:string, platformId:string): Promise<AxiosResponse<unknown>> {
    const $ = new UploaderV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchHash_ByBuildId_ByHash_ByBlockSize_v3(buildId:string, hash:string, blockSize:number, data: DiffPatchRequest): Promise<AxiosResponse<BlockManifest>> {
    const $ = new UploaderV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getDestinationBuildIdDiff_BySourceBuildId_ByDestinationBuildId_ByDestinationFilePath_v3(sourceBuildId:string, destinationBuildId:string, destinationFilePath:string): Promise<AxiosResponse<FileDiffingStatus>> {
    const $ = new UploaderV3Admin$(axiosInstance, namespace, useSchemaValidation)
    const resp = await $.getDestinationBuildIdDiff_BySourceBuildId_ByDestinationBuildId_ByDestinationFilePath_v3(sourceBuildId, destinationBuildId, destinationFilePath, )
    if (resp.error) throw resp.error
    return resp.response
  }
  ...
  return {
    createDiffSend,createPatchSend,createListenDiffStatu,createListenPatchStatu,createPrezsyncupload_v3,createStartbuildupload_v3,getCurrent_ByAppId_ByPlatformId_v3,createStartfileupload_ByUploaderId_v3,createStartzsyncfileupload_ByFileHash_v3,getUploadmode_ByAppId_ByPlatformId_v3,createStartbuildupload_BySourceBuildId_v3,patchCommitfileupload_ByBuildId_ByHash_v3,createCommitbuildmanifest_BySourceBuildId_v3,patchCommitmissingbytesfileupload_ByHash_v3,patchCommitzsyncfileupload_ByBuildId_ByHash_v3,updateVersion_ByAppId_ByVersion_ByPlatformId_v3,patchHash_ByBuildId_ByHash_ByBlockSize_v3,getDestinationBuildIdDiff_BySourceBuildId_ByDestinationBuildId_ByDestinationFilePath_v3,
  }
}
