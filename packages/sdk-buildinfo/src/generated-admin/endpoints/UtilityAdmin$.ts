...
export class UtilityAdmin$ {
   ...
   */
  getPingDiffer(): Promise<Response<PingResultResponse>> {
   ...
   */
  getConfigurations(): Promise<Response<ConfigurationInfo>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  patchConfiguration(data: ConfigurationUpdate): Promise<Response<ConfigurationInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/configurations'.replace('{namespace}', this.namespace)     
   ...
   */
  getValidateSdkConfig( queryParams: {clientId: string | null, redirectUri: string | null}): Promise<Response<ClientPayload>> {
   ...
   */
  getCleanerConfigurations(): Promise<Response<CleanerConfigObject>> {
    const params = {} as AxiosRequestConfig
