...
export class UploaderV3Admin$ {
  ...
  createPrezsyncupload_v3(data: PreCheckUploadRequest): Promise<Response<DifferentialUploadSummary>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DifferentialUploadSummary, 'DifferentialUploadSummary')
  }
  ...
  createStartbuildupload_v3(data: UploadBuildManifest): Promise<Response<DifferentialBuildManifest>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DifferentialBuildManifest, 'DifferentialBuildManifest')
  }
  ...
  getCurrent_ByAppId_ByPlatformId_v3(appId:string, platformId:string): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/current/{appId}/{platformId}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{platformId}', platformId)     
  ...
  createStartfileupload_ByUploaderId_v3(uploaderId:string, data: BinaryUpload): Promise<Response<UploadSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/startfileupload/{uploaderId}'.replace('{namespace}', this.namespace).replace('{uploaderId}', uploaderId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createStartzsyncfileupload_ByFileHash_v3(fileHash:string, data: ZsyncDiffRequest): Promise<Response<UploadSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/startzsyncfileupload/{fileHash}'.replace('{namespace}', this.namespace).replace('{fileHash}', fileHash)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  getUploadmode_ByAppId_ByPlatformId_v3(appId:string, platformId:string): Promise<Response<UploadModeCheck>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/uploadmode/{appId}/{platformId}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{platformId}', platformId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  createStartbuildupload_BySourceBuildId_v3(sourceBuildId:string, data: UploadBuildManifest): Promise<Response<DifferentialBuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/startbuildupload/{sourceBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  patchCommitfileupload_ByBuildId_ByHash_v3(buildId:string, hash:string): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/commitfileupload/{buildId}/{hash}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId).replace('{hash}', hash)     
  ...
  createCommitbuildmanifest_BySourceBuildId_v3(sourceBuildId:string, data: BuildManifest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/commitbuildmanifest/{sourceBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  patchCommitmissingbytesfileupload_ByHash_v3(hash:string, data: DiffPatchRequest): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/commitmissingbytesfileupload/{hash}'.replace('{namespace}', this.namespace).replace('{hash}', hash)     
  ...
  patchCommitzsyncfileupload_ByBuildId_ByHash_v3(buildId:string, hash:string, data: DiffPatchRequest): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/commitzsyncfileupload/{buildId}/{hash}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId).replace('{hash}', hash)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
  ...
  updateVersion_ByAppId_ByVersion_ByPlatformId_v3(appId:string, version:string, platformId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/setcurrentbuild/{appId}/{version}/{platformId}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{version}', version).replace('{platformId}', platformId)     
   ...
   */
  patchHash_ByBuildId_ByHash_ByBlockSize_v3(buildId:string, hash:string, blockSize:number, data: DiffPatchRequest): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/commitzsyncfileupload/{buildId}/{hash}/{blockSize}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId).replace('{hash}', hash).replace('{blockSize}', String(blockSize))     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
   ...
   */
  getDestinationBuildIdDiff_BySourceBuildId_ByDestinationBuildId_ByDestinationFilePath_v3(sourceBuildId:string, destinationBuildId:string, destinationFilePath:string): Promise<Response<FileDiffingStatus>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v3/diff/status/{sourceBuildId}/{destinationBuildId}/{destinationFilePath}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId).replace('{destinationBuildId}', destinationBuildId).replace('{destinationFilePath}', destinationFilePath)     
    const resultPromise = this.axiosInstance.get(url, {params})
