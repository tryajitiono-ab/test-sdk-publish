...
export class UploaderV2Admin$ {
  ...
  deleteBuild_ByBuildId_v2(buildId:string): Promise<Response<unknown>> {
    ...
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/builds/{buildId}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
  ...
  patchDifftriggerStatu_ByValue_v2(value:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/difftrigger/status/{value}'.replace('{namespace}', this.namespace).replace('{value}', value)     
  ...
  createStartfileupload_ByUploaderId_v2(uploaderId:string, data: BinaryUpload): Promise<Response<UploadSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/startfileupload/{uploaderId}'.replace('{namespace}', this.namespace).replace('{uploaderId}', uploaderId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createStartzsyncfileupload_ByFileHash_v2(fileHash:string, data: BinaryUpload): Promise<Response<UploadSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/startzsyncfileupload/{fileHash}'.replace('{namespace}', this.namespace).replace('{fileHash}', fileHash)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  createStartbuildupload_BySourceBuildId_v2(sourceBuildId:string, data: UploadBuildManifest): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/startbuildupload/{sourceBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  patchCommitfileupload_ByBuildId_ByHash_v2(buildId:string, hash:string): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/commitfileupload/{buildId}/{hash}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId).replace('{hash}', hash)     
    const resultPromise = this.axiosInstance.patch(url, null, {params})
  ...
  createStartdlcbuildupload_BySourceBuildId_v2(sourceBuildId:string, data: UploadBuildManifest): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/startdlcbuildupload/{sourceBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  patchCommitzsyncfileupload_ByBuildId_ByHash_v2(buildId:string, hash:string): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/commitzsyncfileupload/{buildId}/{hash}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId).replace('{hash}', hash)     
    const resultPromise = this.axiosInstance.patch(url, null, {params})
  ...
  updateVersion_ByAppId_ByVersion_ByPlatformId_v2(appId:string, version:string, platformId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/setcurrentbuild/{appId}/{version}/{platformId}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{version}', version).replace('{platformId}', platformId)     
   ...
   */
  createDiffStart_BySourceBuildId_ByDestinationBuildId_v2(sourceBuildId:string, destinationBuildId:string): Promise<Response<UploadSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/diff/start/{sourceBuildId}/{destinationBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId).replace('{destinationBuildId}', destinationBuildId)     
  ...
  patchDiffCommit_BySourceBuildId_ByDestinationBuildId_v2(sourceBuildId:string, destinationBuildId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/diff/commit/{sourceBuildId}/{destinationBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId).replace('{destinationBuildId}', destinationBuildId)     
    const resultPromise = this.axiosInstance.patch(url, null, {params})
  ...
  patchHash_ByBuildId_ByHash_ByBlockSize_v2(buildId:string, hash:string, blockSize:number): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/commitzsyncfileupload/{buildId}/{hash}/{blockSize}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId).replace('{hash}', hash).replace('{blockSize}', String(blockSize))     
    const resultPromise = this.axiosInstance.patch(url, null, {params})
   ...
   */
  createDiffSignedurl_BySourceBuildId_ByDestinationBuildId_v2(sourceBuildId:string, destinationBuildId:string): Promise<Response<UploadSummary>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/v2/diff/signedurl/{sourceBuildId}/{destinationBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId).replace('{destinationBuildId}', destinationBuildId)     
    const resultPromise = this.axiosInstance.post(url, null, {params})
