...
export class UploaderV1Admin$ {
  ...
  deleteBuild_ByBuildId(buildId:string): Promise<Response<unknown>> {
    ...
    const url = '/buildinfo/admin/namespaces/{namespace}/builds/{buildId}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
  ...
  getBuildsByNamespace(): Promise<Response<BasicBuildManifestArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BasicBuildManifestArray, 'BasicBuildManifestArray')
  }
   ...
   */
  getBuildsdeletionByAppId( queryParams: {appId: string | null, deletionStatus?: number, platformId?: string | null}): Promise<Response<BuildDeletionDataArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/buildsdeletion/byAppId'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BuildDeletionDataArray, 'BuildDeletionDataArray')
  }
  ...
  updateSetcurrentbuild_ByBuildId(buildId:string,  queryParams?: {sendNotification?: boolean | null}): Promise<Response<unknown>> {
    ...
    const url = '/buildinfo/admin/namespaces/{namespace}/setcurrentbuild/{buildId}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
  ...
  getRetrievechunkbyhash_ByHash(hash:string): Promise<Response<BlockData>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/retrievechunkbyhash/{hash}'.replace('{namespace}', this.namespace).replace('{hash}', hash)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  updateRetry_ByBuildId(buildId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/builddeletion/{buildId}/retry'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
    const resultPromise = this.axiosInstance.put(url, null, {params})
  ...
  deleteCancel_ByBuildId(buildId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/builddeletion/{buildId}/cancel'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  updateSetcurrentbuild_ByAppId_ByVersion(appId:string, version:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/setcurrentbuild/{appId}/{version}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{version}', version)     
    const resultPromise = this.axiosInstance.put(url, null, {params})
  ...
  createStartbuildupload_ByAppId_ByVersion(appId:string, version:string): Promise<Response<BuildIdManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/startbuildupload/{appId}/{version}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{version}', version)     
  ...
  createUuid_ByHash_ByUuid_ByOffset(hash:string, uuid:string, offset:number): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/commitchunkupload/{hash}/{uuid}/{offset}'.replace('{namespace}', this.namespace).replace('{hash}', hash).replace('{uuid}', uuid).replace('{offset}', String(offset))     
    const resultPromise = this.axiosInstance.post(url, null, {params})
   ...
   * This API is used to commit chunk that has been uploaded. 
   */
  createOffset_ByHash_ByUuid_ByOffset_ByBlockSize(hash:string, uuid:string, offset:number, blockSize:number): Promise<Response<BlockManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/admin/namespaces/{namespace}/commitchunkupload/{hash}/{uuid}/{offset}/{blockSize}'.replace('{namespace}', this.namespace).replace('{hash}', hash).replace('{uuid}', uuid).replace('{offset}', String(offset)).replace('{blockSize}', String(blockSize))     
    const resultPromise = this.axiosInstance.post(url, null, {params})
