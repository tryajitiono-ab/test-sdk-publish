...
export function UtilityAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getValidateSdkConfig( queryParams: {clientId: string | null, redirectUri: string | null}): Promise<AxiosResponse<ClientPayload>> {
    const $ = new UtilityAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getPingDiffer,getConfigurations,patchConfiguration,getValidateSdkConfig,getCleanerConfigurations,
  }
}
