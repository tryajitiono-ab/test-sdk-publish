...
export function DownloaderApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getVersionHistory( queryParams: {appId: string | null, comparedBuildId: string | null}): Promise<AxiosResponse<VersionChain>> {
   ...
   */
  async function getDiff_BySourceBuildId_ByDestinationBuildId(sourceBuildId:string, destinationBuildId:string): Promise<AxiosResponse<DiffStatusReport>> {
    const $ = new Downloader$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getVersion_ByAppId_ByVersion_ByPlatformId_v2(appId:string, version:string, platformId:string): Promise<AxiosResponse<BuildManifest>> {
    const $ = new Downloader$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getVersionHistory,getBulkCheckLatest,getUpdategame_ByAppId,getAvailablebuild_ByAppId,getUpdategameBuild_ByBuildId,createBlockUrl_ByBuildId,getUpdategame_ByAppId_ByVersion,getUpdategameBuild_ByBuildId_v2,getUpdategame_ByAppId_ByPlatformId_v2,getDiff_BySourceBuildId_ByDestinationBuildId,getVersion_ByAppId_ByVersion_ByPlatformId_v2,
  }
}
