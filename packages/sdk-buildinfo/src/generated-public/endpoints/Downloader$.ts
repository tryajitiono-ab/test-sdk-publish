...
export class Downloader$ {
  ...
  getBulkCheckLatest( queryParams: {appIds: string[]}): Promise<Response<BuildAvailabilityArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BuildAvailabilityArray, 'BuildAvailabilityArray')
  }
  ...
  getUpdategame_ByAppId(appId:string): Promise<Response<BuildManifest>> {
    ...
    const url = '/buildinfo/public/namespaces/{namespace}/updategame/{appId}'.replace('{namespace}', this.namespace).replace('{appId}', appId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getAvailablebuild_ByAppId(appId:string): Promise<Response<BasicBuildManifestArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/availablebuilds/{appId}'.replace('{namespace}', this.namespace).replace('{appId}', appId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getUpdategameBuild_ByBuildId(buildId:string): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/updategame/builds/{buildId}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  createBlockUrl_ByBuildId(buildId:string, data: BlockDownloadUrlsRequest): Promise<Response<BlockDownloadUrls>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/builds/{buildId}/blocks/urls'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
  ...
  getUpdategame_ByAppId_ByVersion(appId:string, version:string): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/updategame/{appId}/{version}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{version}', version)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getUpdategameBuild_ByBuildId_v2(buildId:string): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/v2/updategame/builds/{buildId}'.replace('{namespace}', this.namespace).replace('{buildId}', buildId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getUpdategame_ByAppId_ByPlatformId_v2(appId:string, platformId:string): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/v2/updategame/{appId}/{platformId}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{platformId}', platformId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getDiff_BySourceBuildId_ByDestinationBuildId(sourceBuildId:string, destinationBuildId:string): Promise<Response<DiffStatusReport>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/diff/{sourceBuildId}/{destinationBuildId}'.replace('{namespace}', this.namespace).replace('{sourceBuildId}', sourceBuildId).replace('{destinationBuildId}', destinationBuildId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getVersion_ByAppId_ByVersion_ByPlatformId_v2(appId:string, version:string, platformId:string): Promise<Response<BuildManifest>> {
    const params = {} as AxiosRequestConfig
    const url = '/buildinfo/public/namespaces/{namespace}/v2/updategame/{appId}/{version}/{platformId}'.replace('{namespace}', this.namespace).replace('{appId}', appId).replace('{version}', version).replace('{platformId}', platformId)     
    const resultPromise = this.axiosInstance.get(url, {params})
