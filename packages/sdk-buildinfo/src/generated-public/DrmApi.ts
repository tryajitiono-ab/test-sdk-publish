...
export function DrmApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getDrmlicenseEncrypt( queryParams: {appId: string | null, machineId: string | null}): Promise<AxiosResponse<EncryptedIdentity>> {
  ...
  return {
    getDrmlicenseEncrypt,getDrmlicenseRetrievePublicKey,
  }
}
