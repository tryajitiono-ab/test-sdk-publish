...
export function ConcurrentRecordAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function updateConcurrentRecord_ByUserId_ByKey(userId:string, key:string, data: AdminConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<AxiosResponse<PlayerRecordConcurrentUpdateResponse>> {
    const $ = new ConcurrentRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateConcurrentAdminrecord_ByUserId_ByKey(userId:string, key:string, data: AdminPlayerConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<AxiosResponse<PlayerRecordConcurrentUpdateResponse>> {
    const $ = new ConcurrentRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePublicConcurrent_ByUserId_ByKey(userId:string, key:string, data: AdminConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<AxiosResponse<PlayerRecordConcurrentUpdateResponse>> {
    const $ = new ConcurrentRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    updateConcurrentRecord_ByKey,updateConcurrentAdminrecord_ByKey,updateConcurrentRecord_ByUserId_ByKey,updateConcurrentAdminrecord_ByUserId_ByKey,updatePublicConcurrent_ByUserId_ByKey,
  }
}
