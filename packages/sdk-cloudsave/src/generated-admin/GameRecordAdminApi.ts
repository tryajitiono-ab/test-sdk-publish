...
export function GameRecordAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getRecords( queryParams: {limit: number, offset: number, query?: string | null, tags?: string[]}): Promise<AxiosResponse<ListGameRecordKeysResponse>> {
  ...
  return {
    getRecords,deleteRecord_ByKey,getRecord_ByKey,createRecord_ByKey,updateRecord_ByKey,
  }
}
