...
export function RecordAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getAdminrecords( queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<AxiosResponse<ListAdminGameRecordKeysResponse>> {
   ...
   */
  async function getAdminrecords_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<AxiosResponse<ListAdminPlayerRecordKeysResponse>> {
    const $ = new RecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function fetchAdminrecordBulk_ByUserId(userId:string, data: BulkGetAdminPlayerRecordRequest): Promise<AxiosResponse<BulkGetAdminPlayerRecordResponse>> {
    const $ = new RecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createAdminrecord_ByUserId_ByKey(userId:string, key:string, data: AdminPlayerRecordRequest): Promise<AxiosResponse<AdminPlayerRecordResponse>> {
    const $ = new RecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateAdminrecord_ByUserId_ByKey(userId:string, key:string, data: AdminPlayerRecordRequest): Promise<AxiosResponse<AdminPlayerRecordResponse>> {
    const $ = new RecordAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getAdminrecords,fetchAdminrecordBulk,deleteAdminrecord_ByKey,getAdminrecord_ByKey,createAdminrecord_ByKey,updateAdminrecord_ByKey,getAdminrecords_ByUserId,fetchBulkUser_ByKey,fetchAdminrecordBulk_ByUserId,deleteAdminrecord_ByUserId_ByKey,getAdminrecord_ByUserId_ByKey,createAdminrecord_ByUserId_ByKey,updateAdminrecord_ByUserId_ByKey,
  }
}
