...
export function PlayerRecordAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsersRecords( queryParams?: {limit?: number, offset?: number, query?: string | null}): Promise<AxiosResponse<ListPlayerRecordKeysResponse>> {
   ...
   * Retrieve list of player records key and userID under given namespace. 
   */
  async function getRecords_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<AxiosResponse<ListPlayerRecordKeysResponse>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateBulkUser_ByKey(key:string, data: BulkUpdatePlayerRecordsByKeyRequest): Promise<AxiosResponse<BulkUpdatePlayerRecordByKeyResponseArray>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function fetchRecordBulk_ByUserId(userId:string, data: BulkGetPlayerRecordsRequest): Promise<AxiosResponse<BulkGetAdminPlayerRecordResponse>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateRecordBulk_ByUserId(userId:string, data: BulkUpdatePlayerRecordsRequest): Promise<AxiosResponse<BulkUpdatePlayerRecordResponseArray>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createRecord_ByUserId_ByKey(userId:string, key:string, data: PlayerRecordRequest): Promise<AxiosResponse<PlayerRecordResponse>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateRecord_ByUserId_ByKey(userId:string, key:string, data: PlayerRecordRequest): Promise<AxiosResponse<PlayerRecordResponse>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createPublic_ByUserId_ByKey(userId:string, key:string, data: PlayerRecordRequest): Promise<AxiosResponse<PlayerRecordResponse>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePublic_ByUserId_ByKey(userId:string, key:string, data: PlayerRecordRequest): Promise<AxiosResponse<PlayerRecordResponse>> {
    const $ = new PlayerRecordAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getUsersRecords,getRecords_ByUserId,fetchUserBulkRecordSize,fetchBulkUser_ByKey,updateBulkUser_ByKey,fetchRecordBulk_ByUserId,updateRecordBulk_ByUserId,deleteRecord_ByUserId_ByKey,getRecord_ByUserId_ByKey,createRecord_ByUserId_ByKey,updateRecord_ByUserId_ByKey,getSize_ByUserId_ByKey,deletePublic_ByUserId_ByKey,getPublic_ByUserId_ByKey,createPublic_ByUserId_ByKey,updatePublic_ByUserId_ByKey,
  }
}
