...
export class GameBinaryRecordAdmin$ {
   ...
   */
  getBinaries( queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListGameBinaryRecordsAdminResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListGameBinaryRecordsAdminResponse, 'ListGameBinaryRecordsAdminResponse')
  }
  ...
  getBinary_ByKey(key:string): Promise<Response<GameBinaryRecordAdminResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GameBinaryRecordAdminResponse, 'GameBinaryRecordAdminResponse')
  }
