...
export class ConcurrentRecordAdmin$ {
  // @ts-ignore
  // prettier-ignore
   ...
   */
  updateConcurrentRecord_ByUserId_ByKey(userId:string, key:string, data: AdminConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<Response<PlayerRecordConcurrentUpdateResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PlayerRecordConcurrentUpdateResponse, 'PlayerRecordConcurrentUpdateResponse')
  }
   ...
   */
  updateConcurrentAdminrecord_ByUserId_ByKey(userId:string, key:string, data: AdminPlayerConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<Response<PlayerRecordConcurrentUpdateResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  updatePublicConcurrent_ByUserId_ByKey(userId:string, key:string, data: AdminConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<Response<PlayerRecordConcurrentUpdateResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
