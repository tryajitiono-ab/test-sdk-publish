...
export class PlayerBinaryRecordAdmin$ {
   ...
   */
  getBinaries_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListPlayerBinaryRecordsResponse>> {
