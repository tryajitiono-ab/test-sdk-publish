...
export class PlayerRecordAdmin$ {
   ...
   */
  getUsersRecords( queryParams?: {limit?: number, offset?: number, query?: string | null}): Promise<Response<ListPlayerRecordKeysResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListPlayerRecordKeysResponse, 'ListPlayerRecordKeysResponse')
  }
  
  /**
   * Retrieve list of player records key and userID under given namespace. 
   */
  getRecords_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListPlayerRecordKeysResponse>> {
    const params = {limit: 25, ...queryParams} as AxiosRequestConfig
  ...
  fetchUserBulkRecordSize(data: BulkUserKeyRequest): Promise<Response<BulkGetPlayerRecordSizeResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkGetPlayerRecordSizeResponse, 'BulkGetPlayerRecordSizeResponse')
  }
  ...
  fetchBulkUser_ByKey(key:string, data: BulkUserIDsRequest): Promise<Response<BulkGetPlayerRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkGetPlayerRecordResponse, 'BulkGetPlayerRecordResponse')
  }
  ...
  updateBulkUser_ByKey(key:string, data: BulkUpdatePlayerRecordsByKeyRequest): Promise<Response<BulkUpdatePlayerRecordByKeyResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkUpdatePlayerRecordByKeyResponseArray, 'BulkUpdatePlayerRecordByKeyResponseArray')
  }
  ...
  fetchRecordBulk_ByUserId(userId:string, data: BulkGetPlayerRecordsRequest): Promise<Response<BulkGetAdminPlayerRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkGetAdminPlayerRecordResponse, 'BulkGetAdminPlayerRecordResponse')
  }
  ...
  updateRecordBulk_ByUserId(userId:string, data: BulkUpdatePlayerRecordsRequest): Promise<Response<BulkUpdatePlayerRecordResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkUpdatePlayerRecordResponseArray, 'BulkUpdatePlayerRecordResponseArray')
  }
  ...
  getSize_ByUserId_ByKey(userId:string, key:string): Promise<Response<PlayerRecordSizeResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PlayerRecordSizeResponse, 'PlayerRecordSizeResponse')
  }
