...
export class RecordAdmin$ {
   ...
   */
  getAdminrecords( queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListAdminGameRecordKeysResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListAdminGameRecordKeysResponse, 'ListAdminGameRecordKeysResponse')
  }
  ...
  fetchAdminrecordBulk(data: BulkGetAdminGameRecordRequest): Promise<Response<BulkGetAdminGameRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkGetAdminGameRecordResponse, 'BulkGetAdminGameRecordResponse')
  }
  ...
  getAdminrecord_ByKey(key:string): Promise<Response<AdminGameRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AdminGameRecordResponse, 'AdminGameRecordResponse')
  }
   ...
   */
  getAdminrecords_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListAdminPlayerRecordKeysResponse>> {
    const params = {limit: 25, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListAdminPlayerRecordKeysResponse, 'ListAdminPlayerRecordKeysResponse')
  }
  ...
  getAdminrecord_ByUserId_ByKey(userId:string, key:string): Promise<Response<AdminPlayerRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AdminPlayerRecordResponse, 'AdminPlayerRecordResponse')
  }
