...
export function PublicPlayerRecordApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsersMeRecords( queryParams?: {limit?: number, offset?: number, tags?: string[]}): Promise<AxiosResponse<ListPlayerRecordKeysResponse>> {
   ...
   */
  async function getRecordsPublic_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, tags?: string[]}): Promise<AxiosResponse<ListPlayerRecordKeysResponse>> {
    const $ = new PublicPlayerRecord$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function fetchRecordBulk_ByUserId(userId:string, data: BulkGetPlayerRecordsRequest): Promise<AxiosResponse<BulkGetPlayerRecordResponse>> {
    const $ = new PublicPlayerRecord$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getUsersMeRecords,createUserMeRecordBulk,deleteRecord_ByUserId_ByKey,getRecord_ByUserId_ByKey,createRecord_ByUserId_ByKey,updateRecord_ByUserId_ByKey,getRecordsPublic_ByUserId,deletePublicMeUser_ByKey,fetchPublicBulkUser_ByKey,fetchRecordBulk_ByUserId,getPublic_ByUserId_ByKey,createPublic_ByUserId_ByKey,updatePublic_ByUserId_ByKey,
  }
}
