...
export class PublicPlayerBinaryRecord$ {
   ...
   */
  getUsersMeBinaries( queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListPlayerBinaryRecordsResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListPlayerBinaryRecordsResponse, 'ListPlayerBinaryRecordsResponse')
  }
  ...
  createUserMeBinaryBulk(data: BulkGetPlayerRecordsRequest): Promise<Response<BulkGetPlayerBinaryRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkGetPlayerBinaryRecordResponse, 'BulkGetPlayerBinaryRecordResponse')
  }
  ...
  createBinary_ByUserId(userId:string, data: PublicPlayerBinaryRecordCreate): Promise<Response<UploadBinaryRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UploadBinaryRecordResponse, 'UploadBinaryRecordResponse')
  }
  ...
  getBinary_ByUserId_ByKey(userId:string, key:string): Promise<Response<PlayerBinaryRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PlayerBinaryRecordResponse, 'PlayerBinaryRecordResponse')
  }
   ...
   */
  getBinariesPublic_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, tags?: string[]}): Promise<Response<ListPlayerBinaryRecordsResponse>> {
    const params = {limit: 25, ...queryParams} as AxiosRequestConfig
