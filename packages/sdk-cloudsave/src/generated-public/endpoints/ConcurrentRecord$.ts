...
export class ConcurrentRecord$ {
   ...
   */
  updateConcurrentRecord_ByUserId_ByKey(userId:string, key:string, data: ConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<Response<PlayerRecordConcurrentUpdateResponse>> {
   ...
   */
  updatePublicConcurrent_ByUserId_ByKey(userId:string, key:string, data: ConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<Response<PlayerRecordConcurrentUpdateResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
