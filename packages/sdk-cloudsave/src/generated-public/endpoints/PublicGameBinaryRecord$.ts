...
export class PublicGameBinaryRecord$ {
   ...
   */
  getBinaries( queryParams?: {limit?: number, offset?: number, query?: string | null, tags?: string[]}): Promise<Response<ListGameBinaryRecordsResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListGameBinaryRecordsResponse, 'ListGameBinaryRecordsResponse')
  }
  ...
  createBinaryBulk(data: BulkGetGameRecordRequest): Promise<Response<BulkGetGameBinaryRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkGetGameBinaryRecordResponse, 'BulkGetGameBinaryRecordResponse')
  }
  ...
  getBinary_ByKey(key:string): Promise<Response<GameBinaryRecordResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GameBinaryRecordResponse, 'GameBinaryRecordResponse')
  }
