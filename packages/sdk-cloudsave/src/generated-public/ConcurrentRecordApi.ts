...
export function ConcurrentRecordApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function updateConcurrentRecord_ByUserId_ByKey(userId:string, key:string, data: ConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<AxiosResponse<PlayerRecordConcurrentUpdateResponse>> {
    const $ = new ConcurrentRecord$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePublicConcurrent_ByUserId_ByKey(userId:string, key:string, data: ConcurrentRecordRequest, queryParams?: {responseBody?: boolean | null}): Promise<AxiosResponse<PlayerRecordConcurrentUpdateResponse>> {
    const $ = new ConcurrentRecord$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    updateConcurrentRecord_ByKey,updateConcurrentRecord_ByUserId_ByKey,updatePublicConcurrent_ByUserId_ByKey,
  }
}
