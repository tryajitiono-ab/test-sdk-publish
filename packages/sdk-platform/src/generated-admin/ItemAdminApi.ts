...
export function ItemAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * &lt;b&gt;[Not supported yet in AGS Shared Cloud]&lt;/b&gt;This API is used to get an item type config.&lt;p&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: item type config data&lt;/li&gt;&lt;/ul&gt; 
   */
  async function getItemsConfigsSearch( queryParams: {itemType: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', clazz?: string | null}): Promise<AxiosResponse<ItemTypeConfigInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsByIds( queryParams: {itemIds: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<FullItemInfoArray>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsBySku( queryParams: {sku: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsSearch( queryParams: {keyword: string | null, language: string | null, activeOnly?: boolean | null, itemType?: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', limit?: number, offset?: number, sortBy?: string | null, storeId?: string | null}): Promise<AxiosResponse<FullItemPagingSlicedResult>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsByAppId( queryParams: {appId: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteItem_ByItemId(itemId:string,  queryParams?: {force?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItem_ByItemId(itemId:string,  queryParams?: {activeOnly?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateItem_ByItemId(itemId:string, data: ItemUpdate, queryParams: {storeId: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateItemRegiondata(data: BulkRegionDataChangeRequest, queryParams: {storeId: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getApp_ByItemId(itemId:string,  queryParams?: {activeOnly?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<FullAppInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateApp_ByItemId(itemId:string, data: AppUpdate, queryParams: {storeId: string | null}): Promise<AxiosResponse<FullAppInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsBySkuLocale( queryParams: {sku: string | null, activeOnly?: boolean | null, language?: string | null, populateBundle?: boolean | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<PopulatedItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsItemIdBySku( queryParams: {sku: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<AxiosResponse<ItemId>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsLocaleByIds( queryParams: {itemIds: string | null, activeOnly?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<ItemInfoArray>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsUncategorized( queryParams?: {activeOnly?: boolean | null, limit?: number, offset?: number, sortBy?: string[], storeId?: string | null}): Promise<AxiosResponse<FullItemPagingSlicedResult>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsByCriteria_v2( queryParams?: {appType?: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', availableDate?: string | null, baseAppId?: string | null, categoryPath?: string | null, features?: string | null, includeSubCategoryItem?: boolean | null, itemName?: string | null, itemStatus?: 'ACTIVE' | 'INACTIVE', itemType?: string[], limit?: number, offset?: number, region?: string | null, sectionExclusive?: boolean | null, sortBy?: string[], storeId?: string | null, tags?: string | null, targetNamespace?: string | null, withTotal?: boolean | null}): Promise<AxiosResponse<FullItemPagingResult>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsEstimatedPrice( queryParams: {itemIds: string | null, userId: string | null, platform?: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<EstimatedPriceInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getLocale_ByItemId(itemId:string,  queryParams?: {activeOnly?: boolean | null, language?: string | null, populateBundle?: boolean | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<PopulatedItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsByFeaturesBasic( queryParams?: {activeOnly?: boolean | null, features?: string[]}): Promise<AxiosResponse<BasicItemArray>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteFeature_ByItemId_ByFeature(itemId:string, feature:string,  queryParams: {storeId: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateFeature_ByItemId_ByFeature(itemId:string, feature:string,  queryParams: {storeId: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePurchaseCondition_ByItemId(itemId:string, data: PurchaseConditionUpdate, queryParams: {storeId: string | null}): Promise<AxiosResponse<FullItemInfo>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createItemPurchaseConditionValidate(data: ItemPurchaseConditionValidateRequest, queryParams: {userId: string | null, platform?: string | null}): Promise<AxiosResponse<ItemPurchaseConditionValidateResultArray>> {
    const $ = new ItemAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getItemsConfigs,createItemConfig,deleteItemConfig_ById,getItemConfig_ById,updateItemConfig_ById,getItemsConfigsSearch,createItem,updateItem,getItemsByIds,getItemsBySku,getItemsSearch,getItemsByAppId,deleteItem_ByItemId,getItem_ByItemId,updateItem_ByItemId,getItemsByCriteria,updateItemRegiondata,getApp_ByItemId,updateApp_ByItemId,getItemsBySkuLocale,getItemsItemIdBySku,getItemsLocaleByIds,getItemsItemIdBySkus,getItemsUncategorized,getItemsByCriteria_v2,getItemsEstimatedPrice,updateEnable_ByItemId,getLocale_ByItemId,updateReturn_ByItemId,getItemsPredicateTypes,updateAcquire_ByItemId,updateDisable_ByItemId,getDynamic_ByItemId,getItemsByFeaturesBasic,deleteFeature_ByItemId_ByFeature,updateFeature_ByItemId_ByFeature,updatePurchaseCondition_ByItemId,createItemPurchaseConditionValidate,
  }
}
