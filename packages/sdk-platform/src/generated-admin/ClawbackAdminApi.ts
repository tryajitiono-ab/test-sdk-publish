...
export function ClawbackAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getIapClawbackHistories( queryParams?: {endTime?: string | null, eventType?: 'CHARGEBACK' | 'CHARGEBACK_REVERSED' | 'OTHER' | 'REFUND', externalOrderId?: string | null, limit?: number, offset?: number, startTime?: string | null, status?: 'FAIL' | 'IGNORED' | 'INIT' | 'SUCCESS', userId?: string | null}): Promise<AxiosResponse<IapClawbackPagingSlicedResult>> {
  ...
  return {
    getIapClawbackHistories,createIapClawbackPlaystationMock,
  }
}
