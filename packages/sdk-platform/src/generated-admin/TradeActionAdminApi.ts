...
export function TradeActionAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getTradeHistoryByCriteria( queryParams?: {limit?: number, offset?: number, status?: 'FAILED' | 'INIT' | 'SUCCESS', type?: string | null, userId?: string | null}): Promise<AxiosResponse<TradeActionPagingSlicedResult>> {
    const $ = new TradeActionAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createTradeCommit,getTrade_ByTransactionId,getTradeHistoryByCriteria,
  }
}
