...
export function AchievementPlatformAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getAchievementXbl_ByUserId(userId:string,  queryParams: {xboxUserId: string | null}): Promise<AxiosResponse<XblUserAchievements>> {
  ...
  return {
    getAchievementXbl_ByUserId,updateAchievementXbl_ByUserId,updateAchievementSteam_ByUserId,
  }
}
