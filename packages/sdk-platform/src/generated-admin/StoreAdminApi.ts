...
export function StoreAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function updateStoreImport_v2(data: {file?: File}, queryParams?: {storeId?: string | null, strictMode?: boolean | null}): Promise<AxiosResponse<ImportStoreResult>> {
    const $ = new StoreAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateClone_ByStoreId(storeId:string,  queryParams?: {targetStoreId?: string | null}): Promise<AxiosResponse<StoreInfo>> {
    const $ = new StoreAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getStoresCatalogDefinition( queryParams: {catalogType: 'APP' | 'CATEGORY' | 'ITEM' | 'SECTION' | 'VIEW'}): Promise<AxiosResponse<CatalogDefinitionInfoArray>> {
    const $ = new StoreAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createImportByCsv_ByStoreId(storeId:string, data: {category: File,display: File,item: File,notes: string | null,section: File}): Promise<AxiosResponse<ImportStoreResult>> {
    const $ = new StoreAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getImportHistory_ByStoreId(storeId:string,  queryParams?: {end?: string | null, limit?: number, offset?: number, sortBy?: string | null, start?: string | null, success?: boolean | null}): Promise<AxiosResponse<ImportStoreHistoryPagingResult>> {
    const $ = new StoreAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getStores,createStore,updateStoreImport,getCatalogConfigs,updateCatalogConfig,deleteStore_ByStoreId,getStore_ByStoreId,updateStore_ByStoreId,deleteStorePublished,getStoresPublished,updateStoreImport_v2,createStoreExportByCsv,updateClone_ByStoreId,getExport_ByStoreId,getStoresPublishedBackup,getStoresCatalogDefinition,updateStorePublishedRollback,createExport_ByStoreId_v2,getStoresDownloadCsvTemplates,createImportByCsv_ByStoreId,getImportHistory_ByStoreId,
  }
}
