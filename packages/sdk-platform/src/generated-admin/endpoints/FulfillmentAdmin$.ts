...
export class FulfillmentAdmin$ {
   ...
   */
  getFulfillments_v2( queryParams?: {endTime?: string | null, limit?: number, offset?: number, startTime?: string | null, state?: 'FULFILLED' | 'FULFILL_FAILED' | 'REVOKED' | 'REVOKE_FAILED', transactionId?: string | null, userId?: string | null}): Promise<Response<FulfillmentHistoryPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/platform/v2/admin/namespaces/{namespace}/fulfillments'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, FulfillmentHistoryPagingSlicedResult, 'FulfillmentHistoryPagingSlicedResult')
  }
  
  /**
   * Query fulfillment histories in a namespace.&lt;br&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: query fulfillment history&lt;/li&gt;&lt;/ul&gt; 
   */
  getFulfillmentHistory( queryParams?: {limit?: number, offset?: number, status?: 'FAIL' | 'SUCCESS', userId?: string | null}): Promise<Response<FulfillmentHistoryPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
  ...
  updateRevoke_ByUserId_ByTransactionId_v2(userId:string, transactionId:string): Promise<Response<RevokeFulfillmentV2Result>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RevokeFulfillmentV2Result, 'RevokeFulfillmentV2Result')
  }
