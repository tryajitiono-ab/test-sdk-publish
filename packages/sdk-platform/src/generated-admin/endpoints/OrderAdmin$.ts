...
export class OrderAdmin$ {
   ...
   */
  getOrders( queryParams?: {endTime?: string | null, limit?: number, offset?: number, orderNos?: string[], sortBy?: string | null, startTime?: string | null, status?: 'CHARGEBACK' | 'CHARGEBACK_REVERSED' | 'CHARGED' | 'CLOSED' | 'DELETED' | 'FULFILLED' | 'FULFILL_FAILED' | 'INIT' | 'REFUNDED' | 'REFUNDING' | 'REFUND_FAILED', withTotal?: boolean | null}): Promise<Response<OrderPagingResult>> {
   ...
   */
  getOrders_ByUserId(userId:string,  queryParams?: {discounted?: boolean | null, itemId?: string | null, limit?: number, offset?: number, status?: 'CHARGEBACK' | 'CHARGEBACK_REVERSED' | 'CHARGED' | 'CLOSED' | 'DELETED' | 'FULFILLED' | 'FULFILL_FAILED' | 'INIT' | 'REFUNDED' | 'REFUNDING' | 'REFUND_FAILED'}): Promise<Response<OrderPagingSlicedResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, OrderPagingSlicedResult, 'OrderPagingSlicedResult')
  }
   ...
   */
  getOrdersCountOfItem_ByUserId(userId:string,  queryParams: {itemId: string | null}): Promise<Response<PurchasedItemCount>> {
