...
export class EntitlementAdmin$ {
  ...
  getEntitlements( queryParams?: {activeOnly?: boolean | null, appType?: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', entitlementName?: string | null, itemId?: string[], limit?: number, offset?: number, origin?: 'Epic' | 'GooglePlay' | 'IOS' | 'Nintendo' | 'Oculus' | 'Other' | 'Playstation' | 'Steam' | 'System' | 'Twitch' | 'Xbox', userId?: string | null}): Promise<Response<EntitlementPagingSlicedResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementPagingSlicedResult, 'EntitlementPagingSlicedResult')
  }
  ...
  createEntitlementGrant(data: BulkEntitlementGrantRequest): Promise<Response<BulkEntitlementGrantResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkEntitlementGrantResult, 'BulkEntitlementGrantResult')
  }
  ...
  createEntitlementRevoke(data: string[]): Promise<Response<BulkEntitlementRevokeResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkEntitlementRevokeResult, 'BulkEntitlementRevokeResult')
  }
  
  /**
   * Query entitlements by Item Ids.&lt;p&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: entitlement list&lt;/li&gt;&lt;/ul&gt; 
   */
  getEntitlementsByItemIds( queryParams?: {activeOnly?: boolean | null, itemIds?: string[], limit?: number, offset?: number}): Promise<Response<EntitlementPagingSlicedResult>> {
    const params = {activeOnly: true,limit: 20, ...queryParams} as AxiosRequestConfig
  ...
  createEntitlement_ByUserId(userId:string, data: EntitlementGrant[]): Promise<Response<StackableEntitlementInfoArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, StackableEntitlementInfoArray, 'StackableEntitlementInfoArray')
  }
   ...
   */
  getEntitlementsBySku_ByUserId(userId:string,  queryParams: {sku: string | null, activeOnly?: boolean | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', platform?: string | null}): Promise<Response<EntitlementInfo>> {
   ...
   */
  getEntitlementsByAppId_ByUserId(userId:string,  queryParams: {appId: string | null, activeOnly?: boolean | null}): Promise<Response<AppEntitlementInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsByItemId_ByUserId(userId:string,  queryParams: {itemId: string | null, activeOnly?: boolean | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', platform?: string | null}): Promise<Response<EntitlementInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsByAppType_ByUserId(userId:string,  queryParams: {appType: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', activeOnly?: boolean | null, limit?: number, offset?: number}): Promise<Response<AppEntitlementPagingSlicedResult>> {
    const params = {activeOnly: true,limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AppEntitlementPagingSlicedResult, 'AppEntitlementPagingSlicedResult')
  }
  
  /**
   * Get user entitlements by itemIds. 
   */
  getEntitlementsByItemIds_ByUserId(userId:string,  queryParams?: {ids?: string[], platform?: string | null}): Promise<Response<EntitlementInfoArray>> {
  ...
  getEntitlementConfig_ByPlatform(platform:string): Promise<Response<EntitlementPlatformConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementPlatformConfigInfo, 'EntitlementPlatformConfigInfo')
  }
   ...
   */
  updateEntitlementRevokeById_ByUserId(userId:string,  queryParams: {entitlementIds: string | null}): Promise<Response<BulkOperationResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipAny_ByUserId(userId:string,  queryParams?: {appIds?: string[], itemIds?: string[], platform?: string | null, skus?: string[]}): Promise<Response<Ownership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipAnyOf_ByUserId(userId:string,  queryParams: {itemIds: string[], platform?: string | null}): Promise<Response<Ownership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipBySku_ByUserId(userId:string,  queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', platform?: string | null}): Promise<Response<TimedOwnership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipByItemId_ByUserId(userId:string,  queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', platform?: string | null}): Promise<Response<TimedOwnership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipByItemIds_ByUserId(userId:string,  queryParams?: {ids?: string[], platform?: string | null}): Promise<Response<EntitlementOwnershipArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementOwnershipArray, 'EntitlementOwnershipArray')
  }
  ...
  getHistory_ByUserId_ByEntitlementId(userId:string, entitlementId:string): Promise<Response<EntitlementHistoryInfoArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementHistoryInfoArray, 'EntitlementHistoryInfoArray')
  }
  ...
  updateDecrement_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: AdminEntitlementDecrement): Promise<Response<EntitlementDecrementResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementDecrementResult, 'EntitlementDecrementResult')
  }
   ...
   */
  getRevokeByUseCountPreCheck_ByUserId_ByEntitlementId(userId:string, entitlementId:string,  queryParams: {quantity: number}): Promise<Response<EntitlementPrechekResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementPrechekResult, 'EntitlementPrechekResult')
  }
