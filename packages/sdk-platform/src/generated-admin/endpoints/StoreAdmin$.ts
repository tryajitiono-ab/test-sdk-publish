...
// TODO file upload not implemented
   ...
   */
  updateStoreImport_v2(data: {file?: File}, queryParams?: {storeId?: string | null, strictMode?: boolean | null}): Promise<Response<ImportStoreResult>> {
...
// TODO file upload not implemented
   ...
   */
  getStoresCatalogDefinition( queryParams: {catalogType: 'APP' | 'CATEGORY' | 'ITEM' | 'SECTION' | 'VIEW'}): Promise<Response<CatalogDefinitionInfoArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/stores/catalogDefinition'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CatalogDefinitionInfoArray, 'CatalogDefinitionInfoArray')
  }
   ...
   */
  createImportByCsv_ByStoreId(storeId:string, data: {category: File,display: File,item: File,notes: string | null,section: File}): Promise<Response<ImportStoreResult>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  getImportHistory_ByStoreId(storeId:string,  queryParams?: {end?: string | null, limit?: number, offset?: number, sortBy?: string | null, start?: string | null, success?: boolean | null}): Promise<Response<ImportStoreHistoryPagingResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ImportStoreHistoryPagingResult, 'ImportStoreHistoryPagingResult')
  }
