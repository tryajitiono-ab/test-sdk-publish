...
export class SubscriptionAdmin$ {
   ...
   */
  getSubscriptions( queryParams?: {chargeStatus?: 'CHARGED' | 'CHARGE_FAILED' | 'NEVER' | 'RECURRING_CHARGING' | 'SETUP', itemId?: string | null, limit?: number, offset?: number, sku?: string | null, status?: 'ACTIVE' | 'CANCELLED' | 'EXPIRED' | 'INIT', subscribedBy?: 'PLATFORM' | 'USER', userId?: string | null}): Promise<Response<SubscriptionPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/subscriptions'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, SubscriptionPagingSlicedResult, 'SubscriptionPagingSlicedResult')
  }
  
  /**
   * Query user subscriptions.&lt;br&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: paginated subscription&lt;/li&gt;&lt;/ul&gt; 
   */
  getSubscriptions_ByUserId(userId:string,  queryParams?: {chargeStatus?: 'CHARGED' | 'CHARGE_FAILED' | 'NEVER' | 'RECURRING_CHARGING' | 'SETUP', itemId?: string | null, limit?: number, offset?: number, sku?: string | null, status?: 'ACTIVE' | 'CANCELLED' | 'EXPIRED' | 'INIT', subscribedBy?: 'PLATFORM' | 'USER'}): Promise<Response<SubscriptionPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
   ...
   */
  getSubscriptionsActivities_ByUserId(userId:string,  queryParams?: {excludeSystem?: boolean | null, limit?: number, offset?: number, subscriptionId?: string | null}): Promise<Response<SubscriptionActivityPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, SubscriptionActivityPagingSlicedResult, 'SubscriptionActivityPagingSlicedResult')
  }
   ...
   */
  updateCancel_ByUserId_BySubscriptionId(userId:string, subscriptionId:string, data: CancelRequest, queryParams?: {force?: boolean | null}): Promise<Response<SubscriptionInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getHistory_ByUserId_BySubscriptionId(userId:string, subscriptionId:string,  queryParams?: {excludeFree?: boolean | null, limit?: number, offset?: number}): Promise<Response<BillingHistoryPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BillingHistoryPagingSlicedResult, 'BillingHistoryPagingSlicedResult')
  }
