...
export class ItemAdmin$ {
  ...
  getItemsConfigs(): Promise<Response<ItemTypeConfigInfoArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ItemTypeConfigInfoArray, 'ItemTypeConfigInfoArray')
  }
  ...
  getItemConfig_ById(id:string): Promise<Response<ItemTypeConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ItemTypeConfigInfo, 'ItemTypeConfigInfo')
  }
   ...
   * &lt;b&gt;[Not supported yet in AGS Shared Cloud]&lt;/b&gt;This API is used to get an item type config.&lt;p&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: item type config data&lt;/li&gt;&lt;/ul&gt; 
   */
  getItemsConfigsSearch( queryParams: {itemType: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', clazz?: string | null}): Promise<Response<ItemTypeConfigInfo>> {
   ...
   */
  createItem(data: ItemCreate, queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  updateItem(data: InGameItemSync, queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
   ...
   */
  getItemsByIds( queryParams: {itemIds: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<Response<FullItemInfoArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, FullItemInfoArray, 'FullItemInfoArray')
  }
  
  /**
   * This API is used to get the item by sku.&lt;p&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: the item with sku&lt;/li&gt;&lt;/ul&gt; 
   */
  getItemsBySku( queryParams: {sku: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<Response<FullItemInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  getItemsSearch( queryParams: {keyword: string | null, language: string | null, activeOnly?: boolean | null, itemType?: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', limit?: number, offset?: number, sortBy?: string | null, storeId?: string | null}): Promise<Response<FullItemPagingSlicedResult>> {
    const params = {activeOnly: true,limit: 20,sortBy: 'name:asc,createdAt:asc', ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/search'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, FullItemPagingSlicedResult, 'FullItemPagingSlicedResult')
  }
  
  /**
   * This API is used to get the item by appId.&lt;p&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: the item with that appId&lt;/li&gt;&lt;/ul&gt; 
   */
  getItemsByAppId( queryParams: {appId: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<Response<FullItemInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  getItem_ByItemId(itemId:string,  queryParams?: {activeOnly?: boolean | null, storeId?: string | null}): Promise<Response<FullItemInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/{itemId}'.replace('{namespace}', this.namespace).replace('{itemId}', itemId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  updateItem_ByItemId(itemId:string, data: ItemUpdate, queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/{itemId}'.replace('{namespace}', this.namespace).replace('{itemId}', itemId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
   ...
   */
  updateItemRegiondata(data: BulkRegionDataChangeRequest, queryParams: {storeId: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getApp_ByItemId(itemId:string,  queryParams?: {activeOnly?: boolean | null, storeId?: string | null}): Promise<Response<FullAppInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/{itemId}/app'.replace('{namespace}', this.namespace).replace('{itemId}', itemId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, FullAppInfo, 'FullAppInfo')
  }
   ...
   */
  updateApp_ByItemId(itemId:string, data: AppUpdate, queryParams: {storeId: string | null}): Promise<Response<FullAppInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/{itemId}/app'.replace('{namespace}', this.namespace).replace('{itemId}', itemId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
   ...
   */
  getItemsBySkuLocale( queryParams: {sku: string | null, activeOnly?: boolean | null, language?: string | null, populateBundle?: boolean | null, region?: string | null, storeId?: string | null}): Promise<Response<PopulatedItemInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  getItemsItemIdBySku( queryParams: {sku: string | null, activeOnly?: boolean | null, storeId?: string | null}): Promise<Response<ItemId>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/itemId/bySku'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ItemId, 'ItemId')
  }
   ...
   */
  getItemsLocaleByIds( queryParams: {itemIds: string | null, activeOnly?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<Response<ItemInfoArray>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  getItemsItemIdBySkus( queryParams?: {sku?: string[], storeId?: string | null}): Promise<Response<ItemIdArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/itemId/bySkus'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ItemIdArray, 'ItemIdArray')
  }
   ...
   */
  getItemsUncategorized( queryParams?: {activeOnly?: boolean | null, limit?: number, offset?: number, sortBy?: string[], storeId?: string | null}): Promise<Response<FullItemPagingSlicedResult>> {
    const params = {activeOnly: true,limit: 20,sortBy: ['name:asc'], ...queryParams} as AxiosRequestConfig
   ...
   */
  getItemsByCriteria_v2( queryParams?: {appType?: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', availableDate?: string | null, baseAppId?: string | null, categoryPath?: string | null, features?: string | null, includeSubCategoryItem?: boolean | null, itemName?: string | null, itemStatus?: 'ACTIVE' | 'INACTIVE', itemType?: string[], limit?: number, offset?: number, region?: string | null, sectionExclusive?: boolean | null, sortBy?: string[], storeId?: string | null, tags?: string | null, targetNamespace?: string | null, withTotal?: boolean | null}): Promise<Response<FullItemPagingResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, FullItemPagingResult, 'FullItemPagingResult')
  }
  
  /**
   * This API is used to get estimated prices of a flexible pricing bundle 
   */
  getItemsEstimatedPrice( queryParams: {itemIds: string | null, userId: string | null, platform?: string | null, region?: string | null, storeId?: string | null}): Promise<Response<EstimatedPriceInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/estimatedPrice'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EstimatedPriceInfo, 'EstimatedPriceInfo')
  }
  
  /**
   * Enable an item.&lt;br&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: updated item&lt;/li&gt;&lt;/ul&gt; 
   */
  updateEnable_ByItemId(itemId:string,  queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getLocale_ByItemId(itemId:string,  queryParams?: {activeOnly?: boolean | null, language?: string | null, populateBundle?: boolean | null, region?: string | null, storeId?: string | null}): Promise<Response<PopulatedItemInfo>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
  ...
  getItemsPredicateTypes(): Promise<Response<AvailablePredicateArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AvailablePredicateArray, 'AvailablePredicateArray')
  }
  ...
  updateAcquire_ByItemId(itemId:string, data: ItemAcquireRequest): Promise<Response<ItemAcquireResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ItemAcquireResult, 'ItemAcquireResult')
  }
   ...
   */
  getItemsByFeaturesBasic( queryParams?: {activeOnly?: boolean | null, features?: string[]}): Promise<Response<BasicItemArray>> {
    const params = {activeOnly: true, ...queryParams} as AxiosRequestConfig
   ...
   */
  deleteFeature_ByItemId_ByFeature(itemId:string, feature:string,  queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  updateFeature_ByItemId_ByFeature(itemId:string, feature:string,  queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/{itemId}/features/{feature}'.replace('{namespace}', this.namespace).replace('{itemId}', itemId).replace('{feature}', feature)     
    const resultPromise = this.axiosInstance.put(url, null, {params})
   ...
   */
  updatePurchaseCondition_ByItemId(itemId:string, data: PurchaseConditionUpdate, queryParams: {storeId: string | null}): Promise<Response<FullItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  createItemPurchaseConditionValidate(data: ItemPurchaseConditionValidateRequest, queryParams: {userId: string | null, platform?: string | null}): Promise<Response<ItemPurchaseConditionValidateResultArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/items/purchase/conditions/validate'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.post(url, data, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ItemPurchaseConditionValidateResultArray, 'ItemPurchaseConditionValidateResultArray')
  }
