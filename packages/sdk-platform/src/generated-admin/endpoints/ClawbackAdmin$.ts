...
export class ClawbackAdmin$ {
   ...
   */
  getIapClawbackHistories( queryParams?: {endTime?: string | null, eventType?: 'CHARGEBACK' | 'CHARGEBACK_REVERSED' | 'OTHER' | 'REFUND', externalOrderId?: string | null, limit?: number, offset?: number, startTime?: string | null, status?: 'FAIL' | 'IGNORED' | 'INIT' | 'SUCCESS', userId?: string | null}): Promise<Response<IapClawbackPagingSlicedResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, IapClawbackPagingSlicedResult, 'IapClawbackPagingSlicedResult')
  }
