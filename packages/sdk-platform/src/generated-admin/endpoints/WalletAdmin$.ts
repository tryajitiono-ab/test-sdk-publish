...
export class WalletAdmin$ {
   ...
   */
  getWallets( queryParams?: {currencyCode?: string | null, limit?: number, offset?: number, origin?: 'Epic' | 'GooglePlay' | 'IOS' | 'Nintendo' | 'Oculus' | 'Other' | 'Playstation' | 'Steam' | 'System' | 'Twitch' | 'Xbox', userId?: string | null}): Promise<Response<WalletPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/wallets'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, WalletPagingSlicedResult, 'WalletPagingSlicedResult')
  }
  ...
  getWalletConfig_ByPlatform(platform:string): Promise<Response<PlatformWalletConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PlatformWalletConfigInfo, 'PlatformWalletConfigInfo')
  }
   ...
   */
  getCheck_ByUserId_ByCurrencyCode(userId:string, currencyCode:string,  queryParams: {origin: 'Epic' | 'GooglePlay' | 'IOS' | 'Nintendo' | 'Oculus' | 'Other' | 'Playstation' | 'Steam' | 'System' | 'Twitch' | 'Xbox'}): Promise<Response<unknown>> {
   ...
   */
  getTransactions_ByUserId_ByWalletId(userId:string, walletId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<DetailedWalletTransactionPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DetailedWalletTransactionPagingSlicedResult, 'DetailedWalletTransactionPagingSlicedResult')
  }
   ...
   */
  getTransactionsWallets_ByUserId_ByCurrencyCode(userId:string, currencyCode:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<WalletTransactionPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, WalletTransactionPagingSlicedResult, 'WalletTransactionPagingSlicedResult')
  }
