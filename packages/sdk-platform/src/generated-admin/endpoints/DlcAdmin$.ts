...
export class DlcAdmin$ {
   ...
   */
  getDlcRecords_ByUserId(userId:string,  queryParams?: {includeAllNamespaces?: boolean | null, status?: 'FULFILLED' | 'REVOKED' | 'REVOKE_FAILED', type?: 'EPICGAMES' | 'OCULUS' | 'PSN' | 'STEAM' | 'XBOX'}): Promise<Response<UserDlcRecordArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
