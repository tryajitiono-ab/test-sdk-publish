...
export class CatalogChangesAdmin$ {
  ...
  getCatalogChangesByCriteria_ByStoreId(storeId:string,  queryParams?: {action?: 'CREATE' | 'DELETE' | 'UPDATE', itemSku?: string | null, itemType?: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', limit?: number, offset?: number, selected?: boolean | null, sortBy?: string[], status?: 'PUBLISHED' | 'UNPUBLISHED', type?: 'CATEGORY' | 'ITEM' | 'SECTION' | 'STORE' | 'VIEW', updatedAtEnd?: string | null, updatedAtStart?: string | null, withTotal?: boolean | null}): Promise<Response<CatalogChangePagingResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CatalogChangePagingResult, 'CatalogChangePagingResult')
  }
   ...
   */
  getCatalogChangesStatistics_ByStoreId(storeId:string,  queryParams?: {action?: 'CREATE' | 'DELETE' | 'UPDATE', itemSku?: string | null, itemType?: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', type?: 'CATEGORY' | 'ITEM' | 'SECTION' | 'STORE' | 'VIEW', updatedAtEnd?: string | null, updatedAtStart?: string | null}): Promise<Response<CatalogChangeStatistics>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CatalogChangeStatistics, 'CatalogChangeStatistics')
  }
   ...
   */
  updateCatalogChangeSelectAllByCriteria_ByStoreId(storeId:string,  queryParams?: {action?: 'CREATE' | 'DELETE' | 'UPDATE', itemSku?: string | null, itemType?: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', selected?: boolean | null, type?: 'CATEGORY' | 'ITEM' | 'SECTION' | 'STORE' | 'VIEW', updatedAtEnd?: string | null, updatedAtStart?: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
