...
export class ServicePluginConfigAdmin$ {
  ...
  getConfigsServicePlugin(): Promise<Response<ServicePluginConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ServicePluginConfigInfo, 'ServicePluginConfigInfo')
  }
  ...
  getCatalogPluginsLootbox(): Promise<Response<LootBoxPluginConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, LootBoxPluginConfigInfo, 'LootBoxPluginConfigInfo')
  }
  ...
  getCatalogPluginsSection(): Promise<Response<SectionPluginConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, SectionPluginConfigInfo, 'SectionPluginConfigInfo')
  }
  ...
  getRevocationPluginsRevocation(): Promise<Response<RevocationPluginConfigInfo>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RevocationPluginConfigInfo, 'RevocationPluginConfigInfo')
  }
...
// TODO file upload not implemented
  ...
  updateRevocationPluginRevocationRevocationCustomConfigCert(data: {file?: File}): Promise<Response<RevocationPluginConfigInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/revocation/plugins/revocation/revocation/customConfig/cert'.replace('{namespace}', this.namespace)     
// TODO file upload not implemented
    const resultPromise = this.axiosInstance.put(url, data, {params})
