...
export class CampaignAdmin$ {
   ...
   */
  getCampaigns( queryParams?: {limit?: number, name?: string | null, offset?: number, tag?: string | null}): Promise<Response<CampaignPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/campaigns'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CampaignPagingSlicedResult, 'CampaignPagingSlicedResult')
  }
   ...
   */
  getCodeCampaign_ByCampaignId(campaignId:string,  queryParams?: {activeOnly?: boolean | null, batchName?: string | null, batchNo?: number[], code?: string | null, limit?: number, offset?: number, withBatchName?: boolean | null}): Promise<Response<CodeInfoPagingSlicedResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CodeInfoPagingSlicedResult, 'CodeInfoPagingSlicedResult')
  }
   ...
   */
  getBatchNames_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, limit?: number}): Promise<Response<CampaignBatchNameInfoArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CampaignBatchNameInfoArray, 'CampaignBatchNameInfoArray')
  }
  
  /**
   * Query redeem history.&lt;br&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: slice of redeem history&lt;/li&gt;&lt;/ul&gt; 
   */
  getHistoryCodes_ByCampaignId(campaignId:string,  queryParams?: {code?: string | null, limit?: number, offset?: number, userId?: string | null}): Promise<Response<RedeemHistoryPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RedeemHistoryPagingSlicedResult, 'RedeemHistoryPagingSlicedResult')
  }
   ...
   */
  getCodesCsv_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, batchNo?: number[], withBatchName?: boolean | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  updateEnableBulkCode_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, batchNo?: number[]}): Promise<Response<BulkOperationResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  updateDisableBulkCode_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, batchNo?: number[]}): Promise<Response<BulkOperationResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
