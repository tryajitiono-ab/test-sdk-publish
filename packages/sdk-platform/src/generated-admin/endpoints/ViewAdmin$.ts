...
export class ViewAdmin$ {
   ...
   */
  getViews( queryParams?: {storeId?: string | null}): Promise<Response<ListViewInfoArray>> {
   ...
   */
  createView(data: ViewCreate, queryParams: {storeId: string | null}): Promise<Response<FullViewInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/views'.replace('{namespace}', this.namespace)     
   ...
   */
  deleteView_ByViewId(viewId:string,  queryParams: {storeId: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getView_ByViewId(viewId:string,  queryParams?: {storeId?: string | null}): Promise<Response<FullViewInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/views/{viewId}'.replace('{namespace}', this.namespace).replace('{viewId}', viewId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  updateView_ByViewId(viewId:string, data: ViewUpdate, queryParams: {storeId: string | null}): Promise<Response<FullViewInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/admin/namespaces/{namespace}/views/{viewId}'.replace('{namespace}', this.namespace).replace('{viewId}', viewId)     
