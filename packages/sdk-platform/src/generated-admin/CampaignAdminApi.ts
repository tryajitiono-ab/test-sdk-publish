...
export function CampaignAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getCampaigns( queryParams?: {limit?: number, name?: string | null, offset?: number, tag?: string | null}): Promise<AxiosResponse<CampaignPagingSlicedResult>> {
   ...
   */
  async function getCode_ByCode(code:string,  queryParams?: {redeemable?: boolean | null, withBatchName?: boolean | null}): Promise<AxiosResponse<CodeInfo>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getCodeCampaign_ByCampaignId(campaignId:string,  queryParams?: {activeOnly?: boolean | null, batchName?: string | null, batchNo?: number[], code?: string | null, limit?: number, offset?: number, withBatchName?: boolean | null}): Promise<AxiosResponse<CodeInfoPagingSlicedResult>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getBatchNames_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, limit?: number}): Promise<AxiosResponse<CampaignBatchNameInfoArray>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getHistoryCodes_ByCampaignId(campaignId:string,  queryParams?: {code?: string | null, limit?: number, offset?: number, userId?: string | null}): Promise<AxiosResponse<RedeemHistoryPagingSlicedResult>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getCodesCsv_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, batchNo?: number[], withBatchName?: boolean | null}): Promise<AxiosResponse<unknown>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateEnableBulkCode_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, batchNo?: number[]}): Promise<AxiosResponse<BulkOperationResult>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateDisableBulkCode_ByCampaignId(campaignId:string,  queryParams?: {batchName?: string | null, batchNo?: number[]}): Promise<AxiosResponse<BulkOperationResult>> {
    const $ = new CampaignAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getCampaigns,createCampaign,getCode_ByCode,updateEnable_ByCode,updateDisable_ByCode,getCampaign_ByCampaignId,updateCampaign_ByCampaignId,createRedemption_ByUserId,getCodeCampaign_ByCampaignId,createCodeCampaign_ByCampaignId,getDynamic_ByCampaignId,updateBatchName_ByCampaignId,getBatchNames_ByCampaignId,getHistoryCodes_ByCampaignId,getCodesCsv_ByCampaignId,updateEnableBulkCode_ByCampaignId,updateDisableBulkCode_ByCampaignId,
  }
}
