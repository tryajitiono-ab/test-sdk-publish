...
export function CategoryAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function deleteCategory_ByCategoryPath(categoryPath:string,  queryParams: {storeId: string | null}): Promise<AxiosResponse<FullCategoryInfo>> {
    const $ = new CategoryAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getCategory_ByCategoryPath(categoryPath:string,  queryParams?: {storeId?: string | null}): Promise<AxiosResponse<FullCategoryInfo>> {
    const $ = new CategoryAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateCategory_ByCategoryPath(categoryPath:string, data: CategoryUpdate, queryParams: {storeId: string | null}): Promise<AxiosResponse<FullCategoryInfo>> {
    const $ = new CategoryAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getChildren_ByCategoryPath(categoryPath:string,  queryParams?: {storeId?: string | null}): Promise<AxiosResponse<FullCategoryInfoArray>> {
    const $ = new CategoryAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getDescendants_ByCategoryPath(categoryPath:string,  queryParams?: {storeId?: string | null}): Promise<AxiosResponse<FullCategoryInfoArray>> {
    const $ = new CategoryAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getCategories,createCategory,getCategoriesBasic,deleteCategory_ByCategoryPath,getCategory_ByCategoryPath,updateCategory_ByCategoryPath,getChildren_ByCategoryPath,getDescendants_ByCategoryPath,
  }
}
