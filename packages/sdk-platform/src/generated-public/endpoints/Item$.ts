...
export class Item$ {
   ...
   */
  getItemsBySku( queryParams: {sku: string | null, autoCalcEstimatedPrice?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<Response<ItemInfo>> {
   ...
   */
  getItemsByAppId( queryParams: {appId: string | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<Response<ItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getItemsLocaleByIds( queryParams: {itemIds: string | null, autoCalcEstimatedPrice?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<Response<ItemInfoArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getItemsEstimatedPrice( queryParams: {itemIds: string | null, region?: string | null, storeId?: string | null}): Promise<Response<EstimatedPriceInfoArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/platform/public/namespaces/{namespace}/items/estimatedPrice'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EstimatedPriceInfoArray, 'EstimatedPriceInfoArray')
  }
  
  /**
   * This API is used to get an item in locale. If item not exist in specific region, default region item will return.&lt;p&gt;Other detail info: &lt;ul&gt;&lt;li&gt;&lt;i&gt;Optional permission&lt;/i&gt;: resource=&#34;PREVIEW&#34;, action=1(CREATE) (user with this permission can view draft store item)&lt;/li&gt;&lt;li&gt;&lt;i&gt;Optional permission&lt;/i&gt;: resource=&#34;SANDBOX&#34;, action=1(CREATE) (user with this permission can view draft store item)&lt;/li&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: item data&lt;/li&gt;&lt;/ul&gt; 
   */
  getLocale_ByItemId(itemId:string,  queryParams?: {autoCalcEstimatedPrice?: boolean | null, language?: string | null, populateBundle?: boolean | null, region?: string | null, storeId?: string | null}): Promise<Response<PopulatedItemInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getAppLocale_ByItemId(itemId:string,  queryParams?: {language?: string | null, region?: string | null, storeId?: string | null}): Promise<Response<AppInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
