...
export class Reward$ {
   ...
   */
  getRewardsByCriteria( queryParams?: {eventTopic?: string | null, limit?: number, offset?: number, sortBy?: string[]}): Promise<Response<RewardPagingSlicedResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RewardPagingSlicedResult, 'RewardPagingSlicedResult')
  }
