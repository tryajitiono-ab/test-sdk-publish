...
export class PaymentStation$ {
   ...
   */
  getPaymentTax( queryParams: {paymentOrderNo: string | null, paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', zipCode?: string | null}): Promise<Response<TaxResult>> {
   ...
   */
  getPaymentReturnurl( queryParams: {orderNo: string | null, paymentOrderNo: string | null, paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', returnUrl: string | null, PayerID?: string | null, foreinginvoice?: string | null, invoice_id?: string | null, payload?: string | null, redirectResult?: string | null, resultCode?: string | null, sessionId?: string | null, status?: string | null, token?: string | null, type?: string | null, user_id?: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getPaymentPublicconfig( queryParams: {paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', region: string | null, sandbox?: boolean | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getPaymentCustomization( queryParams: {paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', region: string | null, sandbox?: boolean | null}): Promise<Response<Customization>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  createPayPayment_ByPaymentOrderNo(paymentOrderNo:string, data: PaymentToken, queryParams?: {paymentProvider?: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', zipCode?: string | null}): Promise<Response<PaymentProcessResult>> {
  ...
  getStatusPayment_ByPaymentOrderNo(paymentOrderNo:string): Promise<Response<PaymentOrderPaidResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PaymentOrderPaidResult, 'PaymentOrderPaidResult')
  }
