...
export class Section$ {
   ...
   */
  getSections_ByUserId(userId:string,  queryParams?: {autoCalcEstimatedPrice?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null, viewId?: string | null}): Promise<Response<SectionInfoArray>> {
