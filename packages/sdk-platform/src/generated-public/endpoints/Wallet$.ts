...
export class Wallet$ {
   ...
   */
  getTransactions_ByUserId_ByCurrencyCode(userId:string, currencyCode:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<WalletTransactionPagingSlicedResult>> {
