...
export class Entitlement$ {
   ...
   */
  getEntitlements_ByUserId(userId:string,  queryParams?: {appType?: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', entitlementName?: string | null, features?: string[], itemId?: string[], limit?: number, offset?: number}): Promise<Response<EntitlementPagingSlicedResult>> {
   ...
   */
  getEntitlementsByIds_ByUserId(userId:string,  queryParams?: {availablePlatformOnly?: boolean | null, ids?: string[]}): Promise<Response<EntitlementInfoArray>> {
   ...
   */
  getEntitlementsBySku_ByUserId(userId:string,  queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<Response<EntitlementInfo>> {
   ...
   */
  getEntitlementsHistory_ByUserId(userId:string,  queryParams?: {endDate?: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', limit?: number, offset?: number, startDate?: string | null}): Promise<Response<UserEntitlementHistoryPagingSlicedResultArray>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserEntitlementHistoryPagingSlicedResultArray, 'UserEntitlementHistoryPagingSlicedResultArray')
  }
  
  /**
   * Exists any my active entitlement of specified itemIds, skus and appIds 
   */
  getUsersMeEntitlementsOwnershipAny( queryParams?: {appIds?: string[], itemIds?: string[], skus?: string[]}): Promise<Response<Ownership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsByItemId_ByUserId(userId:string,  queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<Response<EntitlementInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getUsersMeEntitlementsOwnershipToken( queryParams?: {appIds?: string[], itemIds?: string[], skus?: string[]}): Promise<Response<OwnershipToken>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsByAppType_ByUserId(userId:string,  queryParams: {appType: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', limit?: number, offset?: number}): Promise<Response<AppEntitlementPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
   ...
   */
  getUsersMeEntitlementsOwnershipBySku( queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<Response<TimedOwnership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getUsersMeEntitlementsOwnershipByItemId( queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<Response<TimedOwnership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipAny_ByUserId(userId:string,  queryParams?: {appIds?: string[], itemIds?: string[], skus?: string[]}): Promise<Response<Ownership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipBySku_ByUserId(userId:string,  queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<Response<TimedOwnership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipByItemId_ByUserId(userId:string,  queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<Response<TimedOwnership>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getEntitlementsOwnershipByItemIds_ByUserId(userId:string,  queryParams?: {ids?: string[]}): Promise<Response<EntitlementOwnershipArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  updateSplit_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: EntitlementSplitRequest): Promise<Response<EntitlementSplitResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementSplitResult, 'EntitlementSplitResult')
  }
  ...
  updateTransfer_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: EntitlementTransferRequest): Promise<Response<EntitlementTransferResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EntitlementTransferResult, 'EntitlementTransferResult')
  }
