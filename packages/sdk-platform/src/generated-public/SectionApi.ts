...
export function SectionApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getSections_ByUserId(userId:string,  queryParams?: {autoCalcEstimatedPrice?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null, viewId?: string | null}): Promise<AxiosResponse<SectionInfoArray>> {
