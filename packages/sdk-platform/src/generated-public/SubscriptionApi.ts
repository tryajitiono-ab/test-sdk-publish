...
export function SubscriptionApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function updateCancel_ByUserId_BySubscriptionId(userId:string, subscriptionId:string, data: CancelRequest): Promise<AxiosResponse<SubscriptionInfo>> {
    const $ = new Subscription$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateBillingAccount_ByUserId_BySubscriptionId(userId:string, subscriptionId:string): Promise<AxiosResponse<SubscriptionInfo>> {
    const $ = new Subscription$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getSubscriptions_ByUserId,createSubscription_ByUserId,getSubscription_ByUserId_BySubscriptionId,getSubscriptionsSubscribableByItemId_ByUserId,updateCancel_ByUserId_BySubscriptionId,getHistory_ByUserId_BySubscriptionId,updateBillingAccount_ByUserId_BySubscriptionId,
  }
}
