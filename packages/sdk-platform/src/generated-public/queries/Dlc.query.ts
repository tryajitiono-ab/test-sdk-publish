  ...
  input: Parameters<typeof useDlcApi_GetUsersMeDlcContent>[1]
      ...
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                getUsersMeDlcContent(input.queryParams))
...
export const useDlcApi_GetDlcRewardsDurableMap = (
  ...
  input: Parameters<typeof useDlcApi_GetDlcRewardsDurableMap>[1]
      ...
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                getDlcRewardsDurableMap(input.queryParams))
      callback && callback(response)
      return response.data
  }
...
export const useDlcApi_UpdateDlcPsnSync_ByUserId = (
  ...
  const mutationFn = async (input: SdkSetConfigParam & { userId:string, data: PlayStationDlcSyncRequest }) => {
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                updateDlcPsnSync_ByUserId(input.userId, input.data))
...
export const useDlcApi_UpdateDlcXblSync_ByUserId = (
  ...
  const mutationFn = async (input: SdkSetConfigParam & { userId:string, data: XblDlcSyncRequest }) => {
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                updateDlcXblSync_ByUserId(input.userId, input.data))
      callback && callback(response.data)
      return response.data
  }
...
export const useDlcApi_UpdateDlcSteamSync_ByUserId = (
  ...
  const mutationFn = async (input: SdkSetConfigParam & { userId:string, data: SteamDlcSyncRequest }) => {
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                updateDlcSteamSync_ByUserId(input.userId, input.data))
      callback && callback(response.data)
      return response.data
  }
...
export const useDlcApi_UpdateDlcOculuSync_ByUserId = (
  ...
  const mutationFn = async (input: SdkSetConfigParam & { userId:string }) => {
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                updateDlcOculuSync_ByUserId(input.userId))
      callback && callback(response.data)
      return response.data
  }
...
export const useDlcApi_UpdateDlcEpicgameSync_ByUserId = (
  ...
  const mutationFn = async (input: SdkSetConfigParam & { userId:string, data: EpicGamesDlcSyncRequest }) => {
      const response = 
            (await DlcApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                updateDlcEpicgameSync_ByUserId(input.userId, input.data))
      callback && callback(response.data)
      return response.data
  }
