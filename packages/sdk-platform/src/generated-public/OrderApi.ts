...
export function OrderApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function createOrderDiscountPreview_ByUserId(userId:string, data: OrderDiscountPreviewRequest): Promise<AxiosResponse<OrderDiscountPreviewResponse>> {
    const $ = new Order$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getOrders_ByUserId,createOrder_ByUserId,getOrder_ByUserId_ByOrderNo,updateCancel_ByUserId_ByOrderNo,createOrderDiscountPreview_ByUserId,getHistory_ByUserId_ByOrderNo,getReceiptPdf_ByUserId_ByOrderNo,
  }
}
