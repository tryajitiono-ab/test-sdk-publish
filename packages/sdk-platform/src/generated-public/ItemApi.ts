...
export function ItemApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getItemsBySku( queryParams: {sku: string | null, autoCalcEstimatedPrice?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<ItemInfo>> {
   ...
   */
  async function getItemsSearch( queryParams: {keyword: string | null, language: string | null, autoCalcEstimatedPrice?: boolean | null, itemType?: 'APP' | 'BUNDLE' | 'CODE' | 'COINS' | 'EXTENSION' | 'INGAMEITEM' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SEASON' | 'SUBSCRIPTION', limit?: number, offset?: number, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<ItemPagingSlicedResult>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsByAppId( queryParams: {appId: string | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<ItemInfo>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsLocaleByIds( queryParams: {itemIds: string | null, autoCalcEstimatedPrice?: boolean | null, language?: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<ItemInfoArray>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getItemsEstimatedPrice( queryParams: {itemIds: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<EstimatedPriceInfoArray>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getLocale_ByItemId(itemId:string,  queryParams?: {autoCalcEstimatedPrice?: boolean | null, language?: string | null, populateBundle?: boolean | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<PopulatedItemInfo>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getAppLocale_ByItemId(itemId:string,  queryParams?: {language?: string | null, region?: string | null, storeId?: string | null}): Promise<AxiosResponse<AppInfo>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createItemPurchaseConditionValidate(data: ItemPurchaseConditionValidateRequest): Promise<AxiosResponse<ItemPurchaseConditionValidateResultArray>> {
    const $ = new Item$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getItemsBySku,getItemsSearch,getItemsByAppId,getItemsByCriteria,getItemsLocaleByIds,getItemsEstimatedPrice,getLocale_ByItemId,getDynamic_ByItemId,getAppLocale_ByItemId,createItemPurchaseConditionValidate,
  }
}
