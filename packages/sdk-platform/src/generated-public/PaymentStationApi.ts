...
export function PaymentStationApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getPaymentTax( queryParams: {paymentOrderNo: string | null, paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', zipCode?: string | null}): Promise<AxiosResponse<TaxResult>> {
   ...
   */
  async function getPaymentQrcode( queryParams: {code: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new PaymentStation$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPaymentReturnurl( queryParams: {orderNo: string | null, paymentOrderNo: string | null, paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', returnUrl: string | null, PayerID?: string | null, foreinginvoice?: string | null, invoice_id?: string | null, payload?: string | null, redirectResult?: string | null, resultCode?: string | null, sessionId?: string | null, status?: string | null, token?: string | null, type?: string | null, user_id?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new PaymentStation$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPaymentPublicconfig( queryParams: {paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', region: string | null, sandbox?: boolean | null}): Promise<AxiosResponse<unknown>> {
    const $ = new PaymentStation$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPaymentCustomization( queryParams: {paymentProvider: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', region: string | null, sandbox?: boolean | null}): Promise<AxiosResponse<Customization>> {
    const $ = new PaymentStation$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createPayPayment_ByPaymentOrderNo(paymentOrderNo:string, data: PaymentToken, queryParams?: {paymentProvider?: 'ADYEN' | 'ALIPAY' | 'CHECKOUT' | 'NEONPAY' | 'PAYPAL' | 'STRIPE' | 'WALLET' | 'WXPAY' | 'XSOLLA', zipCode?: string | null}): Promise<AxiosResponse<PaymentProcessResult>> {
    const $ = new PaymentStation$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getPaymentTax,createPaymentLink,getPaymentQrcode,getPaymentMethods,getPaymentReturnurl,getPaymentPublicconfig,getPaymentCustomization,createPayPayment_ByPaymentOrderNo,getInfoPayment_ByPaymentOrderNo,getStatusPayment_ByPaymentOrderNo,
  }
}
