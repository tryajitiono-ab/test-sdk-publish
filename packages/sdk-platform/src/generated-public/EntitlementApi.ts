...
export function EntitlementApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getEntitlements_ByUserId(userId:string,  queryParams?: {appType?: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', entitlementName?: string | null, features?: string[], itemId?: string[], limit?: number, offset?: number}): Promise<AxiosResponse<EntitlementPagingSlicedResult>> {
   ...
   */
  async function getEntitlementsByIds_ByUserId(userId:string,  queryParams?: {availablePlatformOnly?: boolean | null, ids?: string[]}): Promise<AxiosResponse<EntitlementInfoArray>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsBySku_ByUserId(userId:string,  queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<AxiosResponse<EntitlementInfo>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsByAppId_ByUserId(userId:string,  queryParams: {appId: string | null}): Promise<AxiosResponse<AppEntitlementInfo>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsHistory_ByUserId(userId:string,  queryParams?: {endDate?: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION', limit?: number, offset?: number, startDate?: string | null}): Promise<AxiosResponse<UserEntitlementHistoryPagingSlicedResultArray>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsersMeEntitlementsOwnershipAny( queryParams?: {appIds?: string[], itemIds?: string[], skus?: string[]}): Promise<AxiosResponse<Ownership>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsByItemId_ByUserId(userId:string,  queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<AxiosResponse<EntitlementInfo>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsersMeEntitlementsOwnershipToken( queryParams?: {appIds?: string[], itemIds?: string[], skus?: string[]}): Promise<AxiosResponse<OwnershipToken>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsByAppType_ByUserId(userId:string,  queryParams: {appType: 'DEMO' | 'DLC' | 'GAME' | 'SOFTWARE', limit?: number, offset?: number}): Promise<AxiosResponse<AppEntitlementPagingSlicedResult>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsersMeEntitlementsOwnershipBySku( queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<AxiosResponse<TimedOwnership>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsersMeEntitlementsOwnershipByItemId( queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<AxiosResponse<TimedOwnership>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsOwnershipAny_ByUserId(userId:string,  queryParams?: {appIds?: string[], itemIds?: string[], skus?: string[]}): Promise<AxiosResponse<Ownership>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsOwnershipBySku_ByUserId(userId:string,  queryParams: {sku: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<AxiosResponse<TimedOwnership>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsOwnershipByItemId_ByUserId(userId:string,  queryParams: {itemId: string | null, entitlementClazz?: 'APP' | 'CODE' | 'ENTITLEMENT' | 'LOOTBOX' | 'MEDIA' | 'OPTIONBOX' | 'SUBSCRIPTION'}): Promise<AxiosResponse<TimedOwnership>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getEntitlementsOwnershipByItemIds_ByUserId(userId:string,  queryParams?: {ids?: string[]}): Promise<AxiosResponse<EntitlementOwnershipArray>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateSell_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: EntitlementSoldRequest): Promise<AxiosResponse<EntitlementSoldResult>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateSplit_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: EntitlementSplitRequest): Promise<AxiosResponse<EntitlementSplitResult>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateTransfer_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: EntitlementTransferRequest): Promise<AxiosResponse<EntitlementTransferResult>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateDecrement_ByUserId_ByEntitlementId(userId:string, entitlementId:string, data: PublicEntitlementDecrement): Promise<AxiosResponse<EntitlementDecrementResult>> {
    const $ = new Entitlement$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getEntitlements_ByUserId,getEntitlementsByIds_ByUserId,getEntitlementsBySku_ByUserId,getEntitlementsByAppId_ByUserId,getEntitlementsHistory_ByUserId,getUsersMeEntitlementsOwnershipAny,getEntitlementsByItemId_ByUserId,getUsersMeEntitlementsOwnershipToken,getEntitlementsByAppType_ByUserId,getUsersMeEntitlementsOwnershipBySku,getUsersMeEntitlementsOwnershipByAppId,getUsersMeEntitlementsOwnershipByItemId,getEntitlementsOwnershipAny_ByUserId,getEntitlement_ByUserId_ByEntitlementId,getEntitlementsOwnershipBySku_ByUserId,getEntitlementsOwnershipByAppId_ByUserId,getEntitlementsOwnershipByItemId_ByUserId,getEntitlementsOwnershipByItemIds_ByUserId,updateSell_ByUserId_ByEntitlementId,updateSplit_ByUserId_ByEntitlementId,updateTransfer_ByUserId_ByEntitlementId,updateDecrement_ByUserId_ByEntitlementId,
  }
}
