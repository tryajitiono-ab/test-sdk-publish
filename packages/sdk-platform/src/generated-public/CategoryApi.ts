...
export function CategoryApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getCategories( queryParams?: {language?: string | null, storeId?: string | null}): Promise<AxiosResponse<CategoryInfoArray>> {
   ...
   */
  async function getCategoriesDownload( queryParams?: {language?: string | null, storeId?: string | null}): Promise<AxiosResponse<HierarchicalCategoryInfoArray>> {
    const $ = new Category$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getCategory_ByCategoryPath(categoryPath:string,  queryParams?: {language?: string | null, storeId?: string | null}): Promise<AxiosResponse<CategoryInfo>> {
    const $ = new Category$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getChildren_ByCategoryPath(categoryPath:string,  queryParams?: {language?: string | null, storeId?: string | null}): Promise<AxiosResponse<CategoryInfoArray>> {
    const $ = new Category$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getDescendants_ByCategoryPath(categoryPath:string,  queryParams?: {language?: string | null, storeId?: string | null}): Promise<AxiosResponse<CategoryInfoArray>> {
    const $ = new Category$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getCategories,getCategoriesDownload,getCategory_ByCategoryPath,getChildren_ByCategoryPath,getDescendants_ByCategoryPath,
  }
}
