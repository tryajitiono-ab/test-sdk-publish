...
export function ViewApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getViews_ByUserId(userId:string,  queryParams?: {language?: string | null, storeId?: string | null}): Promise<AxiosResponse<ViewInfoArray>> {
