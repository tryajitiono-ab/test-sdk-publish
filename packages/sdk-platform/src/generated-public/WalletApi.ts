...
export function WalletApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getTransactions_ByUserId_ByCurrencyCode(userId:string, currencyCode:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<WalletTransactionPagingSlicedResult>> {
    const $ = new Wallet$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getUserMeWallet_ByCurrencyCode,getWallet_ByUserId_ByCurrencyCode,getTransactions_ByUserId_ByCurrencyCode,
  }
}
