...
export function ClientsApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function deleteClientpermission_ByClientId_ByResource_ByAction(clientId:string, resource:string, action:number): Promise<AxiosResponse<unknown>> {
    const $ = new Clients$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateClientpermission_ByClientId_ByResource_ByAction(clientId:string, resource:string, action:number): Promise<AxiosResponse<unknown>> {
    const $ = new Clients$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getClients,createClient,deleteClient_ByClientId,getClient_ByClientId,updateClient_ByClientId,updateSecret_ByClientId,getClients_ByNS,createClient_ByNS,updateClientpermission_ByClientId,deleteClient_ByClientId_ByNS,deleteClientpermission_ByClientId_ByResource_ByAction,updateClientpermission_ByClientId_ByResource_ByAction,
  }
}
