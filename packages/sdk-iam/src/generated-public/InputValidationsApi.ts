...
export function InputValidationsApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getInputValidations_v3( queryParams?: {defaultOnEmpty?: boolean | null, languageCode?: string | null}): Promise<AxiosResponse<InputValidationsPublicResponse>> {
  ...
  return {
    getInputValidations_v3,getInputValidation_ByField_v3,
  }
}
