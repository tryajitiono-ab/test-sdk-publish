...
export const useOAuthApi_GetOauthJwks = (
  ...
  const queryFn = (sdk: AccelByteSDK, input: Parameters<typeof useOAuthApi_GetOauthJwks>[1]) => async () => {
    const response = await OAuthApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).getOauthJwks()
...
export const useOAuthApi_GetOauthRevocationlist = (
  ...
  const queryFn = (sdk: AccelByteSDK, input: Parameters<typeof useOAuthApi_GetOauthRevocationlist>[1]) => async () => {
    const response = await OAuthApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).getOauthRevocationlist()
    callback && callback(response)
    return response.data
  }
