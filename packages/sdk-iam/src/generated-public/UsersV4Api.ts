...
export function UsersV4Api(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function createUserInvite_ByInvitationId_v4(invitationId:string, data: CreateUserRequestV4): Promise<AxiosResponse<CreateUserResponseV4>> {
    const $ = new UsersV4$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUser_ByPlatformId_v4(platformId:string, data: PlatformUserIdRequestV4, queryParams?: {rawPUID?: boolean | null}): Promise<AxiosResponse<UserPlatforms>> {
    const $ = new UsersV4$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUserMeHeadlesCodeVerify_v4(data: UpgradeHeadlessAccountWithVerificationCodeRequestV4): Promise<AxiosResponse<UserResponseV4>> {
    const $ = new UsersV4$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createUserInvite_v4,createUser_v4,patchUserMe_v4,createTestUser_v4,getUser_ByUserId_v4,updateUserMeEmail_v4,deleteUserMeMfaDevice_v4,getUsersMeMfaFactor_v4,postUserMeMfaFactor_v4,getUsersMeMfaStatus_v4,createUserMeMfaStatus_v4,getUsersMeMfaBackupCode_v4,createUserMeMfaBackupCode_v4,postUserMeMfaEmailCode_v4,createUserMeHeadlesVerify_v4,getUsersMeMfaBackupCodes_v4,createUserMeMfaBackupCode_ByNS_v4,postUserMeMfaEmailEnable_v4,createUserMeMfaEmailDisable_v4,createUserInvite_ByInvitationId_v4,createUser_ByPlatformId_v4,createUserMeHeadlesCodeVerify_v4,postUserMeMfaChallengeVerify_v4,createUserMeMfaAuthenticatorKey_v4,createUserMeMfaBackupCodeEnable_v4,deleteUserMeMfaBackupCodeDisable_v4,createUserMeMfaBackupCodeEnable_ByNS_v4,getUsersMeMfaBackupCodeDownload_v4,postUserMeMfaAuthenticatorEnable_v4,deleteUserMeMfaAuthenticatorDisable_v4,
  }
}
