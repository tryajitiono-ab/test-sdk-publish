...
export function UsersApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsersAdmin( queryParams?: {after?: number, before?: number, limit?: number, roleId?: string | null}): Promise<AxiosResponse<GetAdminUsersResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsers_v3( queryParams?: {by?: string | null, limit?: number, offset?: number, platformBy?: string | null, platformId?: string | null, query?: string | null}): Promise<AxiosResponse<PublicUserInformationResponseV3>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsersMeHeadlessLinkConflict_v3( queryParams: {oneTimeLinkCode: string | null}): Promise<AxiosResponse<GetLinkHeadlessAccountConflictResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsersByPlatformUserId( queryParams: {platformID: string | null, platformUserID: string | null}): Promise<AxiosResponse<PublicUserResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postCrosslink_ByUserId(userId:string, data: {linkingToken: string | null,platformId?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getBans_ByUserId_v2(userId:string,  queryParams?: {activeOnly?: boolean | null}): Promise<AxiosResponse<UserBanResponseArray>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getBans_ByUserId_v3(userId:string,  queryParams?: {activeOnly?: boolean | null, after?: string | null, before?: string | null, limit?: number}): Promise<AxiosResponse<GetUserBanV3Response>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getLoginsHistories_ByUserId(userId:string,  queryParams?: {after?: number, before?: number, limit?: number}): Promise<AxiosResponse<LoginHistoriesResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPlatforms_ByUserId_v3(userId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number, platformId?: string | null}): Promise<AxiosResponse<UserLinkedPlatformsResponseV3>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUserMeHeadlesVerify_v3(data: UpgradeHeadlessAccountV3Request, queryParams?: {needVerificationCode?: boolean | null}): Promise<AxiosResponse<UserResponseV3>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateUpgradeHeadlessAccount_ByUserId(userId:string, data: UpgradeHeadlessAccountRequest): Promise<AxiosResponse<UserResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUserInvite_ByInvitationId_v3(invitationId:string, data: UserCreateRequestV3): Promise<AxiosResponse<UserCreateResponseV3>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUser_ByPlatformId_v3(platformId:string, data: PlatformUserIdRequest, queryParams?: {rawPID?: boolean | null, rawPUID?: boolean | null}): Promise<AxiosResponse<UserPlatforms>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUserMeHeadlesCodeVerify_v3(data: UpgradeHeadlessAccountWithVerificationCodeRequestV3): Promise<AxiosResponse<UserResponseV3>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getLoginsHistories_ByUserId_v3(userId:string,  queryParams?: {after?: number, before?: number, limit?: number}): Promise<AxiosResponse<LoginHistoriesResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteUserMePlatform_ByPlatformId_v3(platformId:string, data: UnlinkUserPlatformRequest): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postUserMePlatform_ByPlatformId_v3(platformId:string, data: {ticket: string | null,redirectUri?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postLink_ByUserId_ByPlatformId(userId:string, platformId:string, data: {ticket: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postUnlink_ByUserId_ByPlatformId(userId:string, platformId:string, data: {platform_namespace?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deletePermission_ByUserId_ByResource_ByAction(userId:string, resource:string, action:number): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePermission_ByUserId_ByResource_ByAction(userId:string, resource:string, action:number, data: UpdatePermissionScheduleRequest): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPlatformJustice_ByUserId_ByTargetNamespace(userId:string, targetNamespace:string): Promise<AxiosResponse<GetUserMapping>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePlatformJustice_ByUserId_ByTargetNamespace(userId:string, targetNamespace:string): Promise<AxiosResponse<GetUserJusticePlatformAccountResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getWebLinkMeUsers_ByPlatformId_v3(platformId:string,  queryParams?: {clientId?: string | null, redirectUri?: string | null}): Promise<AxiosResponse<WebLinkingResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteLink_ByUserId_ByPlatformId_v2(userId:string, platformId:string, data: {platform_namespace?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postLink_ByUserId_ByPlatformId_v2(userId:string, platformId:string, data: {ticket: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createPlatformLinkWithProgression_ByUserId_v3(userId:string, data: LinkPlatformAccountWithProgressionRequest): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUserMePlatformJustice_ByTargetNamespace_v3(targetNamespace:string): Promise<AxiosResponse<CreateJusticeUserResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUser_ByPlatformId_ByPlatformUserId_v3(platformId:string, platformUserId:string): Promise<AxiosResponse<UserResponseV3>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateUpgradeHeadlessAccountWithVerificationCode_ByUserId(userId:string, data: UpgradeHeadlessAccountWithVerificationCodeRequest): Promise<AxiosResponse<UserResponse>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postWebLinkProcesMeUser_ByPlatformId_v3(platformId:string, data: {state: string | null,code?: string | null}): Promise<AxiosResponse<LinkRequest>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getWebLinkEstablishMeUsers_ByPlatformId_v3(platformId:string,  queryParams: {state: string | null, code?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new Users$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getUsersMe_v3,createUser,getUsersAdmin,getUsersVerifyLinkVerify_v3,getUsersSearch,deleteUser_ByUserId,getUser_ByUserId,updateUser_ByUserId,getUsersByLoginId,createUser_v2,getUsers_v3,createUser_v3,createUserMeVerifyLinkRequest_v3,createBan_ByUserId,patchUserMe_v3,updateUserMe_v3,getUsersMeHeadlessLinkConflict_v3,getBans_ByUserId,createUserResetPassword,updateRole_ByUserId,createUserForgotPassword,getUsersListByLoginIds,updateEnable_ByUserId,createUserReset_v3,updateDisable_ByUserId,getUsersByPlatformUserId,createUserForgot_v3,updatePassword_ByUserId,postCrosslink_ByUserId,getPlatforms_ByUserId,getPublisher_ByUserId,getUser_ByUserId_v2,patchUser_ByUserId_v2,getUser_ByUserId_v3,createUserMeHeadlesLinkWithProgression_v3,createUserPlatform_v3,deleteInformation_ByUserId,getInformation_ByUserId,updatePermission_ByUserId,createUserBulkBasic_v3,updateVerification_ByUserId,createUserCodeVerify_v3,updateUserMePassword_v3,getUsersAvailability_v3,createUserCodeRequest_v3,deleteRole_ByUserId_ByRoleId,updateRole_ByUserId_ByRoleId,getBans_ByUserId_v2,createUserResetPassword_v2,getBans_ByUserId_v3,createUserForgotPassword_v2,createUserMeCodeVerify_v3,getLoginsHistories_ByUserId,updateVerificationcode_ByUserId,createUserMeCodeRequest_v3,createUserInputValidation_v3,updatePassword_ByUserId_v2,postValidate_ByUserId_v3,updateEnable_ByUserId_ByBanId,getPlatforms_ByUserId_v3,getPublisher_ByUserId_v3,createUserMeHeadlesVerify_v3,updateDisable_ByUserId_ByBanId,getInformation_ByUserId_v3,updateUpgradeHeadlessAccount_ByUserId,getUserInvite_ByInvitationId_v3,createUserInvite_ByInvitationId_v3,createUser_ByPlatformId_v3,createPlatformLink_ByUserId_v3,createUserMeHeadlesCodeVerify_v3,getLoginsHistories_ByUserId_v3,deleteUserMePlatform_ByPlatformId_v3,postUserMePlatform_ByPlatformId_v3,postLink_ByUserId_ByPlatformId,getPlatformsJustice_ByUserId_v2,getDistinctPlatforms_ByUserId_v3,getPlatformsJustice_ByUserId_v3,getAsyncStatus_ByRequestId_v3,postUnlink_ByUserId_ByPlatformId,deleteAllMeUser_ByPlatformId_v3,deletePermission_ByUserId_ByResource_ByAction,updatePermission_ByUserId_ByResource_ByAction,postForceMeUser_ByPlatformId_v3,getAgerestrictions_ByCountryCode_v2,getAgerestrictionCountry_ByCountryCode_v3,getPlatformJustice_ByUserId_ByTargetNamespace,updatePlatformJustice_ByUserId_ByTargetNamespace,getWebLinkMeUsers_ByPlatformId_v3,deleteLink_ByUserId_ByPlatformId_v2,postLink_ByUserId_ByPlatformId_v2,createPlatformLinkWithProgression_ByUserId_v3,createUserMePlatformJustice_ByTargetNamespace_v3,getUser_ByPlatformId_ByPlatformUserId_v3,updateUpgradeHeadlessAccountWithVerificationCode_ByUserId,postWebLinkProcesMeUser_ByPlatformId_v3,getWebLinkEstablishMeUsers_ByPlatformId_v3,
  }
}
