...
export function RolesApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getRoles_v3( queryParams?: {after?: string | null, before?: string | null, isWildcard?: boolean | null, limit?: number}): Promise<AxiosResponse<RoleNamesResponseV3>> {
    const $ = new Roles$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deletePermission_ByRoleId_ByResource_ByAction(roleId:string, resource:string, action:number): Promise<AxiosResponse<unknown>> {
    const $ = new Roles$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updatePermission_ByRoleId_ByResource_ByAction(roleId:string, resource:string, action:number, data: UpdatePermissionScheduleRequest): Promise<AxiosResponse<unknown>> {
    const $ = new Roles$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getRoles,createRole,deleteRole_ByRoleId,getRole_ByRoleId,updateRole_ByRoleId,getRoles_v3,deleteAdmin_ByRoleId,getAdmin_ByRoleId,updateAdmin_ByRoleId,deleteMember_ByRoleId,getMembers_ByRoleId,updateMember_ByRoleId,deleteManager_ByRoleId,getManagers_ByRoleId,updateManager_ByRoleId,getRole_ByRoleId_v3,updatePermission_ByRoleId,deletePermission_ByRoleId_ByResource_ByAction,updatePermission_ByRoleId_ByResource_ByAction,
  }
}
