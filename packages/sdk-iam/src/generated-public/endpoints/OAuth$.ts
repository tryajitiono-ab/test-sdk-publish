...
export class OAuth$ {
   ...
   */
  postOauthToken(data: {grant_type: 'authorization_code' | 'client_credentials' | 'password' | 'refresh_token',code?: string | null,extend_exp?: boolean | null,namespace?: string | null,password?: string | null,redirect_uri?: string | null,refresh_token?: string | null,username?: string | null}): Promise<Response<TokenResponse>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postOauthVerify(data: {token: string | null}): Promise<Response<TokenResponse>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postOauthAuthorize(data: {client_id: string | null,redirect_uri: string | null,response_type: 'code' | 'token',login?: string | null,password?: string | null,scope?: string | null,state?: string | null}): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postOauthRevokeUser(data: {userID: string | null}): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postOauthRevokeToken(data: {token: string | null}): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postTokenOauth_ByPlatformId(platformId:string, data: {device_id?: string | null,macAddress?: string | null,platform_token?: string | null}): Promise<Response<TokenResponse>> {
    const params = {} as AxiosRequestConfig
