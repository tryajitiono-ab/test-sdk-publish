...
export class Users$ {
   ...
   */
  getUsersAdmin( queryParams?: {after?: number, before?: number, limit?: number, roleId?: string | null}): Promise<Response<GetAdminUsersResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getUsers_v3( queryParams?: {by?: string | null, limit?: number, offset?: number, platformBy?: string | null, platformId?: string | null, query?: string | null}): Promise<Response<PublicUserInformationResponseV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v3/public/namespaces/{namespace}/users'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PublicUserInformationResponseV3, 'PublicUserInformationResponseV3')
  }
   ...
   */
  getUsersMeHeadlessLinkConflict_v3( queryParams: {oneTimeLinkCode: string | null}): Promise<Response<GetLinkHeadlessAccountConflictResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v3/public/users/me/headless/link/conflict'     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetLinkHeadlessAccountConflictResponse, 'GetLinkHeadlessAccountConflictResponse')
  }
   ...
   */
  getUsersByPlatformUserId( queryParams: {platformID: string | null, platformUserID: string | null}): Promise<Response<PublicUserResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getPlatforms_ByUserId(userId:string): Promise<Response<UserLinkedPlatformArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserLinkedPlatformArray, 'UserLinkedPlatformArray')
  }
  ...
  getPublisher_ByUserId(userId:string): Promise<Response<GetPublisherUserResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetPublisherUserResponse, 'GetPublisherUserResponse')
  }
  ...
  createUserPlatform_v3(data: UsersPlatformInfosRequestV3): Promise<Response<UsersPlatformInfosResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UsersPlatformInfosResponse, 'UsersPlatformInfosResponse')
  }
   ...
   */
  getLoginsHistories_ByUserId(userId:string,  queryParams?: {after?: number, before?: number, limit?: number}): Promise<Response<LoginHistoriesResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  createUserInputValidation_v3(data: UserInputValidationRequest): Promise<Response<UserInputValidationResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserInputValidationResponse, 'UserInputValidationResponse')
  }
   ...
   */
  getPlatforms_ByUserId_v3(userId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number, platformId?: string | null}): Promise<Response<UserLinkedPlatformsResponseV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  createUserMeHeadlesVerify_v3(data: UpgradeHeadlessAccountV3Request, queryParams?: {needVerificationCode?: boolean | null}): Promise<Response<UserResponseV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  createUser_ByPlatformId_v3(platformId:string, data: PlatformUserIdRequest, queryParams?: {rawPID?: boolean | null, rawPUID?: boolean | null}): Promise<Response<UserPlatforms>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  postUserMePlatform_ByPlatformId_v3(platformId:string, data: {ticket: string | null,redirectUri?: string | null}): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/v3/public/namespaces/{namespace}/users/me/platforms/{platformId}'.replace('{namespace}', this.namespace).replace('{platformId}', platformId)     
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), { ...params, headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' } })
   ...
   */
  postUnlink_ByUserId_ByPlatformId(userId:string, platformId:string, data: {platform_namespace?: string | null}): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
  ...
  updatePlatformJustice_ByUserId_ByTargetNamespace(userId:string, targetNamespace:string): Promise<Response<GetUserJusticePlatformAccountResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetUserJusticePlatformAccountResponse, 'GetUserJusticePlatformAccountResponse')
  }
   ...
   */
  getWebLinkMeUsers_ByPlatformId_v3(platformId:string,  queryParams?: {clientId?: string | null, redirectUri?: string | null}): Promise<Response<WebLinkingResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  postWebLinkProcesMeUser_ByPlatformId_v3(platformId:string, data: {state: string | null,code?: string | null}): Promise<Response<LinkRequest>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  getWebLinkEstablishMeUsers_ByPlatformId_v3(platformId:string,  queryParams: {state: string | null, code?: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
