...
export class OAuth20Extension$ {
   ...
   */
  postAuthenticate_v3(data: {password: string | null,request_id: string | null,user_name: string | null,client_id?: string | null,extend_exp?: boolean | null,redirect_uri?: string | null}): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postHeadlesToken_v3(data: {linkingToken: string | null,additionalData?: string | null,extend_exp?: boolean | null}): Promise<Response<TokenResponseV3>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postTokenExchange_v3(data: {code: string | null,additionalData?: string | null}): Promise<Response<TokenResponseV3>> {
    const params = {} as AxiosRequestConfig
  ...
  getLocationCountry_v3(): Promise<Response<CountryLocationResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CountryLocationResponse, 'CountryLocationResponse')
  }
  ...
  postLinkCodeRequest_v3(data: {platformId: string | null}): Promise<Response<OneTimeLinkingCodeResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, OneTimeLinkingCodeResponse, 'OneTimeLinkingCodeResponse')
  }
  
  /**
   * This endpoint is being used to validate one time link code. 
   */
  postLinkCodeValidate_v3(data: {oneTimeLinkCode: string | null}): Promise<Response<OneTimeLinkingCodeValidationResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/v3/link/code/validate'     
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), { ...params, headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' } })

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, OneTimeLinkingCodeValidationResponse, 'OneTimeLinkingCodeValidationResponse')
  }
   ...
   */
  postLinkTokenExchange_v3(data: {client_id: string | null,oneTimeLinkCode: string | null,additionalData?: string | null,isTransient?: boolean | null}): Promise<Response<TokenResponseV3>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postAuthenticateWithLink_v3(data: {client_id: string | null,linkingToken: string | null,password: string | null,username: string | null,extend_exp?: boolean | null}): Promise<Response<TokenResponseV3>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  postTokenRequest_v3(data: {client_id: string | null}, queryParams?: {code_challenge?: string | null, code_challenge_method?: 'S256' | 'plain'}): Promise<Response<TargetTokenCodeResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TargetTokenCodeResponse, 'TargetTokenCodeResponse')
  }
   ...
   */
  getAuthenticate_ByPlatformId_v3(platformId:string,  queryParams: {state: string | null, code?: string | null, error?: string | null, assoc_handle?: string | null, claimed_id?: string | null, identity?: string | null, mode?: string | null, ns?: string | null, op_endpoint?: string | null, response_nonce?: string | null, return_to?: string | null, sig?: string | null, signed?: string | null}): Promise<Response<unknown>> {
   ...
   */
  postTokenVerify_ByPlatformId_v3(platformId:string, data: {platform_token: string | null}): Promise<Response<PlatformTokenRefreshResponseV3>> {
    const params = {} as AxiosRequestConfig
    const url = '/iam/v3/platforms/{platformId}/token/verify'.replace('{platformId}', platformId)     
    const resultPromise = this.axiosInstance.post(url, CodeGenUtil.getFormUrlEncodedData(data), { ...params, headers: { ...params.headers, 'content-type': 'application/x-www-form-urlencoded' } })

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PlatformTokenRefreshResponseV3, 'PlatformTokenRefreshResponseV3')
  }
