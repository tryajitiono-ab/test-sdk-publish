...
export class Roles$ {
  ...
  getRoles( queryParams?: {isWildcard?: string | null}): Promise<Response<RoleResponseWithManagersArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RoleResponseWithManagersArray, 'RoleResponseWithManagersArray')
  }
   ...
   */
  getRoles_v3( queryParams?: {after?: string | null, before?: string | null, isWildcard?: boolean | null, limit?: number}): Promise<Response<RoleNamesResponseV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getAdmin_ByRoleId(roleId:string): Promise<Response<RoleAdminStatusResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RoleAdminStatusResponse, 'RoleAdminStatusResponse')
  }
