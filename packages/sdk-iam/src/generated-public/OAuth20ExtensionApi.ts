...
export function OAuth20ExtensionApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function postAuthenticate_v3(data: {password: string | null,request_id: string | null,user_name: string | null,client_id?: string | null,extend_exp?: boolean | null,redirect_uri?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postHeadlesToken_v3(data: {linkingToken: string | null,additionalData?: string | null,extend_exp?: boolean | null}): Promise<AxiosResponse<TokenResponseV3>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postTokenExchange_v3(data: {code: string | null,additionalData?: string | null}): Promise<AxiosResponse<TokenResponseV3>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postLinkCodeValidate_v3(data: {oneTimeLinkCode: string | null}): Promise<AxiosResponse<OneTimeLinkingCodeValidationResponse>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postLinkTokenExchange_v3(data: {client_id: string | null,oneTimeLinkCode: string | null,additionalData?: string | null,isTransient?: boolean | null}): Promise<AxiosResponse<TokenResponseV3>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postAuthenticateWithLink_v3(data: {client_id: string | null,linkingToken: string | null,password: string | null,username: string | null,extend_exp?: boolean | null}): Promise<AxiosResponse<TokenResponseV3>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postTokenRequest_v3(data: {client_id: string | null}, queryParams?: {code_challenge?: string | null, code_challenge_method?: 'S256' | 'plain'}): Promise<AxiosResponse<TargetTokenCodeResponse>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getAuthenticate_ByPlatformId_v3(platformId:string,  queryParams: {state: string | null, code?: string | null, error?: string | null, assoc_handle?: string | null, claimed_id?: string | null, identity?: string | null, mode?: string | null, ns?: string | null, op_endpoint?: string | null, response_nonce?: string | null, return_to?: string | null, sig?: string | null, signed?: string | null}): Promise<AxiosResponse<unknown>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postTokenVerify_ByPlatformId_v3(platformId:string, data: {platform_token: string | null}): Promise<AxiosResponse<PlatformTokenRefreshResponseV3>> {
    const $ = new OAuth20Extension$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createLogout_v3,postAuthenticate_v3,postHeadlesToken_v3,postTokenExchange_v3,getLocationCountry_v3,postLinkCodeRequest_v3,postLinkCodeValidate_v3,postLinkTokenExchange_v3,postAuthenticateWithLink_v3,postTokenRequest_v3,getAuthenticate_ByPlatformId_v3,postTokenVerify_ByPlatformId_v3,
  }
}
