...
export function OAuth20V4Api(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function postOauthToken_v4(data: {grant_type: 'authorization_code' | 'client_credentials' | 'password' | 'refresh_token' | 'urn:ietf:params:oauth:grant-type:extend_client_credentials' | 'urn:ietf:params:oauth:grant-type:login_queue_ticket',additionalData?: string | null,client_id?: string | null,client_secret?: string | null,code?: string | null,code_verifier?: string | null,extendNamespace?: string | null,extend_exp?: boolean | null,login_queue_ticket?: string | null,password?: string | null,redirect_uri?: string | null,refresh_token?: string | null,username?: string | null}, queryParams?: {code_challenge?: string | null, code_challenge_method?: 'S256' | 'plain'}): Promise<AxiosResponse<LoginQueueTicketResponse>> {
   ...
   */
  async function postOauthMfaVerify_v4(data: {code: string | null,factor: string | null,mfaToken: string | null,rememberDevice: boolean | null}): Promise<AxiosResponse<LoginQueueTicketResponse>> {
    const $ = new OAuth20V4$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postOauthHeadlesToken_v4(data: {linkingToken: string | null,additionalData?: string | null,extend_exp?: boolean | null}): Promise<AxiosResponse<LoginQueueTicketResponse>> {
    const $ = new OAuth20V4$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postOauthTokenExchange_v4(data: {code: string | null,additionalData?: string | null}): Promise<AxiosResponse<LoginQueueTicketResponse>> {
    const $ = new OAuth20V4$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postOauthSimultaneousLogin_v4(data: {nativePlatform: 'epicgames' | 'steam',nativePlatformTicket: string | null,simultaneousPlatform?: string | null,simultaneousTicket?: string | null}, queryParams?: {code_challenge?: string | null, code_challenge_method?: 'S256' | 'plain'}): Promise<AxiosResponse<LoginQueueTicketResponse>> {
    const $ = new OAuth20V4$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function postOauthAuthenticateWithLink_v4(data: {client_id: string | null,linkingToken: string | null,password: string | null,username: string | null,extend_exp?: boolean | null}): Promise<AxiosResponse<LoginQueueTicketResponse>> {
    const $ = new OAuth20V4$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    postOauthToken_v4,postOauthMfaVerify_v4,postOauthHeadlesToken_v4,postOauthTokenExchange_v4,postOauthSimultaneousLogin_v4,postOauthAuthenticateWithLink_v4,postTokenOauth_ByPlatformId_v4,
  }
}
