...
export function ThirdPartyCredentialAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function patchClient_ByPlatformId_v3(platformId:string, data: ThirdPartyLoginPlatformCredentialRequest): Promise<AxiosResponse<ThirdPartyLoginPlatformCredentialResponse>> {
    const $ = new ThirdPartyCredentialAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createClient_ByPlatformId_v3(platformId:string, data: ThirdPartyLoginPlatformCredentialRequest): Promise<AxiosResponse<ThirdPartyLoginPlatformCredentialResponse>> {
    const $ = new ThirdPartyCredentialAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteClientDomain_ByPlatformId_v3(platformId:string, data: PlatformDomainDeleteRequest): Promise<AxiosResponse<unknown>> {
    const $ = new ThirdPartyCredentialAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateClientDomain_ByPlatformId_v3(platformId:string, data: PlatformDomainUpdateRequest): Promise<AxiosResponse<PlatformDomainResponse>> {
    const $ = new ThirdPartyCredentialAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getAvailability_ByPlatformId_v3,getPlatformsAllClients_v3,getPlatformsAllClientsActive_v3,deleteClient_ByPlatformId_v3,getClients_ByPlatformId_v3,patchClient_ByPlatformId_v3,createClient_ByPlatformId_v3,deleteClientDomain_ByPlatformId_v3,updateClientDomain_ByPlatformId_v3,
  }
}
