...
export class OverrideRoleConfigV3Admin$ {
   ...
   */
  patchRoleoverride_v3(data: RoleOverrideUpdateRequest, queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<Response<RoleOverrideResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v3/admin/namespaces/{namespace}/roleoverride'.replace('{namespace}', this.namespace)     
  ...
  getRoleoverrideSource_v3( queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<Response<RoleOverrideSourceResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RoleOverrideSourceResponse, 'RoleOverrideSourceResponse')
  }
   ...
   */
  patchRoleoverrideStatus_v3(data: RoleOverrideStatsUpdateRequest, queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<Response<RoleOverrideResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getPermissions_ByRoleId_v3(roleId:string): Promise<Response<RolePermissionResponseV3>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RolePermissionResponseV3, 'RolePermissionResponseV3')
  }
