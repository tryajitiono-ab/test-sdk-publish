...
export class OAuth20Admin$ {
   ...
   */
  getPlatformTokenOauth_ByUserId_ByPlatformId_v3(userId:string, platformId:string,  queryParams?: {platformUserId?: string | null}): Promise<Response<TokenThirdPartyResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TokenThirdPartyResponse, 'TokenThirdPartyResponse')
  }
