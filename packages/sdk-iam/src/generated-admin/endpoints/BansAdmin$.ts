...
export class BansAdmin$ {
   ...
   * Ban type is the code available for ban assignment. It is applicable globally for any namespace. action code : 10201 
   */
  getBansUsers_v3( queryParams?: {activeOnly?: boolean | null, banType?: string | null, limit?: number, offset?: number}): Promise<Response<GetUserBanV3Response>> {
  ...
  createBanUser_v3(data: BulkBanCreateRequestV3): Promise<Response<ListBulkUserBanResponseV3>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListBulkUserBanResponseV3, 'ListBulkUserBanResponseV3')
  }
