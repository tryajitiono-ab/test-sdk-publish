...
export class RolesAdmin$ {
   ...
   * action code: 10414 
   */
  getRoles_v3( queryParams?: {after?: string | null, before?: string | null, isWildcard?: boolean | null, limit?: number}): Promise<Response<RoleResponseWithManagersAndPaginationV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v3/admin/roles'     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RoleResponseWithManagersAndPaginationV3, 'RoleResponseWithManagersAndPaginationV3')
  }
   ...
   * action code: 10414 
   */
  getRoles_v4( queryParams?: {adminRole?: boolean | null, isWildcard?: boolean | null, limit?: number, offset?: number}): Promise<Response<ListRoleV4Response>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getAdmin_ByRoleId_v3(roleId:string): Promise<Response<RoleAdminStatusResponseV3>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RoleAdminStatusResponseV3, 'RoleAdminStatusResponseV3')
  }
   ...
   */
  getUsers_ByRoleId_v4(roleId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<Response<ListAssignedUsersV4Response>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v4/admin/roles/{roleId}/users'.replace('{roleId}', roleId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListAssignedUsersV4Response, 'ListAssignedUsersV4Response')
  }
  ...
  updateUser_ByRoleId_v4(roleId:string, data: AssignUserV4Request): Promise<Response<AssignedUserV4Response>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AssignedUserV4Response, 'AssignedUserV4Response')
  }
   ...
   */
  getMembers_ByRoleId_v3(roleId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<Response<RoleMembersResponseV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v3/admin/roles/{roleId}/members'.replace('{roleId}', roleId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  getManagers_ByRoleId_v3(roleId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<Response<RoleManagersResponsesV3>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v3/admin/roles/{roleId}/managers'.replace('{roleId}', roleId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RoleManagersResponsesV3, 'RoleManagersResponsesV3')
  }
