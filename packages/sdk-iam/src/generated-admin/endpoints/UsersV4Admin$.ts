...
export class UsersV4Admin$ {
   ...
   */
  getInvitationHistories_v4( queryParams?: {limit?: number, namespace?: string | null, offset?: number}): Promise<Response<ListInvitationHistoriesV4Response>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v4/admin/invitationHistories'     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListInvitationHistoriesV4Response, 'ListInvitationHistoriesV4Response')
  }
  ...
  createTestUser_v4(data: CreateTestUsersRequestV4): Promise<Response<CreateTestUsersResponseV4>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CreateTestUsersResponseV4, 'CreateTestUsersResponseV4')
  }
  ...
  getInvitationHistories_ByNS_v4(): Promise<Response<InvitationHistoryResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, InvitationHistoryResponse, 'InvitationHistoryResponse')
  }
  ...
  fetchUserBulkValidate_v4(data: CheckValidUserIdRequestV4): Promise<Response<ListValidUserIdResponseV4>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListValidUserIdResponseV4, 'ListValidUserIdResponseV4')
  }
  ...
  getRoles_ByUserId_v4(userId:string): Promise<Response<ListUserRolesV4Response>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListUserRolesV4Response, 'ListUserRolesV4Response')
  }
   ...
   */
  getInvitationHistoriesUsers_v4( queryParams?: {limit?: number, offset?: number}): Promise<Response<NamespaceInvitationHistoryUserV4Response>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v4/admin/namespaces/{namespace}/invitationHistories/users'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, NamespaceInvitationHistoryUserV4Response, 'NamespaceInvitationHistoryUserV4Response')
  }
  
  /**
   * **This endpoint is used to disable user 2FA.** 
   */
  deleteMfaDisable_ByUserId_v4(userId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
