...
export class DevicesV4Admin$ {
   ...
   */
  getDevicesBanned_v4( queryParams?: {deviceType?: string | null, endDate?: string | null, limit?: number, offset?: number, startDate?: string | null}): Promise<Response<DeviceBannedResponseV4>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/iam/v4/admin/namespaces/{namespace}/devices/banned'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DeviceBannedResponseV4, 'DeviceBannedResponseV4')
  }
  
  /**
   * This is the endpoint for an admin to generate device report 
   */
  getDevicesReport_v4( queryParams: {deviceType: string | null, endDate?: string | null, startDate?: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getDecrypt_ByDeviceId_v4(deviceId:string): Promise<Response<DeviceIdDecryptResponseV4>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DeviceIdDecryptResponseV4, 'DeviceIdDecryptResponseV4')
  }
