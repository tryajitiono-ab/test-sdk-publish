...
export class ThirdPartyCredentialAdmin$ {
  ...
  getAvailability_ByPlatformId_v3(platformId:string): Promise<Response<CheckAvailabilityResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, CheckAvailabilityResponse, 'CheckAvailabilityResponse')
  }
  ...
  getPlatformsAllClients_v3(): Promise<Response<ThirdPartyLoginPlatformCredentialResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ThirdPartyLoginPlatformCredentialResponseArray, 'ThirdPartyLoginPlatformCredentialResponseArray')
  }
  ...
  getClients_ByPlatformId_v3(platformId:string): Promise<Response<ThirdPartyLoginPlatformCredentialResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ThirdPartyLoginPlatformCredentialResponse, 'ThirdPartyLoginPlatformCredentialResponse')
  }
  ...
  updateClientDomain_ByPlatformId_v3(platformId:string, data: PlatformDomainUpdateRequest): Promise<Response<PlatformDomainResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PlatformDomainResponse, 'PlatformDomainResponse')
  }
