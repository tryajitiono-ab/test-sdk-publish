...
export class SsoCredentialAdmin$ {
  ...
  getPlatformsSso_v3( queryParams?: {limit?: number, offset?: number}): Promise<Response<SsoPlatformCredentialResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, SsoPlatformCredentialResponseArray, 'SsoPlatformCredentialResponseArray')
  }
  ...
  getSso_ByPlatformId_v3(platformId:string): Promise<Response<SsoPlatformCredentialResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, SsoPlatformCredentialResponse, 'SsoPlatformCredentialResponse')
  }
