...
export function RolesAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * action code: 10414 
   */
  async function getRoles_v3( queryParams?: {after?: string | null, before?: string | null, isWildcard?: boolean | null, limit?: number}): Promise<AxiosResponse<RoleResponseWithManagersAndPaginationV3>> {
   ...
   * action code: 10414 
   */
  async function getRoles_v4( queryParams?: {adminRole?: boolean | null, isWildcard?: boolean | null, limit?: number, offset?: number}): Promise<AxiosResponse<ListRoleV4Response>> {
    const $ = new RolesAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUsers_ByRoleId_v4(roleId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<AxiosResponse<ListAssignedUsersV4Response>> {
    const $ = new RolesAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getMembers_ByRoleId_v3(roleId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<AxiosResponse<RoleMembersResponseV3>> {
    const $ = new RolesAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getManagers_ByRoleId_v3(roleId:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<AxiosResponse<RoleManagersResponsesV3>> {
    const $ = new RolesAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * action code: 10406 
   */
  async function deletePermission_ByRoleId_ByResource_ByAction_v3(roleId:string, resource:string, action:number): Promise<AxiosResponse<unknown>> {
    const $ = new RolesAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getRoles_v3,createRole_v3,getRoles_v4,createRole_v4,deleteRole_ByRoleId_v3,getRole_ByRoleId_v3,patchRole_ByRoleId_v3,deleteRole_ByRoleId_v4,getRole_ByRoleId_v4,patchRole_ByRoleId_v4,deleteAdmin_ByRoleId_v3,getAdmin_ByRoleId_v3,updateAdmin_ByRoleId_v3,deleteUser_ByRoleId_v4,getUsers_ByRoleId_v4,updateUser_ByRoleId_v4,deleteMember_ByRoleId_v3,getMembers_ByRoleId_v3,updateMember_ByRoleId_v3,deleteManager_ByRoleId_v3,getManagers_ByRoleId_v3,updateManager_ByRoleId_v3,deletePermission_ByRoleId_v3,updatePermission_ByRoleId_v3,updatePermission_ByRoleId_admin_v3,deletePermission_ByRoleId_v4,updatePermission_ByRoleId_v4,updatePermission_ByRoleId_admin_v4,deletePermission_ByRoleId_ByResource_ByAction_v3,
  }
}
