...
export function OverrideRoleConfigV3AdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getRoleoverride_v3( queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<AxiosResponse<RoleOverrideResponse>> {
   ...
   */
  async function patchRoleoverride_v3(data: RoleOverrideUpdateRequest, queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<AxiosResponse<RoleOverrideResponse>> {
    const $ = new OverrideRoleConfigV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getRoleoverrideSource_v3( queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<AxiosResponse<RoleOverrideSourceResponse>> {
    const $ = new OverrideRoleConfigV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchRoleoverrideStatus_v3(data: RoleOverrideStatsUpdateRequest, queryParams: {identity: 'GAME_ADMIN' | 'USER' | 'VIEW_ONLY'}): Promise<AxiosResponse<RoleOverrideResponse>> {
    const $ = new OverrideRoleConfigV3Admin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getRoleoverride_v3,patchRoleoverride_v3,getRoleoverrideSource_v3,patchRoleoverrideStatus_v3,getPermissions_ByRoleId_v3,
  }
}
