...
export function OAuth20AdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function updateRevokeOauth_ByUserId_v3(userId:string,  queryParams?: {includeGameNamespace?: boolean | null}): Promise<AxiosResponse<unknown>> {
   ...
   */
  async function getPlatformTokenOauth_ByUserId_ByPlatformId_v3(userId:string, platformId:string,  queryParams?: {platformUserId?: string | null}): Promise<AxiosResponse<TokenThirdPartyResponse>> {
    const $ = new OAuth20Admin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    updateRevokeOauth_ByUserId_v3,getPlatformTokenOauth_ByUserId_ByPlatformId_v3,
  }
}
