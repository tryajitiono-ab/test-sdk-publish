...
export function ClientsConfigV3AdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function deleteClientConfigPermission_v3(data: PermissionSetDeleteGroupRequest, queryParams?: {forceDelete?: boolean | null}): Promise<AxiosResponse<unknown>> {
    const $ = new ClientsConfigV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getClientConfigPermissions_v3( queryParams?: {excludePermissions?: boolean | null}): Promise<AxiosResponse<ListClientPermissionSet>> {
    const $ = new ClientsConfigV3Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateClientConfigPermission_v3(data: ListUpsertModulesRequest, queryParams?: {forceDelete?: boolean | null}): Promise<AxiosResponse<unknown>> {
    const $ = new ClientsConfigV3Admin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getClientConfigTemplates_v3,deleteClientConfigPermission_v3,getClientConfigPermissions_v3,updateClientConfigPermission_v3,
  }
}
