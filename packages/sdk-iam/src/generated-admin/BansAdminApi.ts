...
export function BansAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * Ban type is the code available for ban assignment. It is applicable globally for any namespace. action code : 10201 
   */
  async function getBansUsers_v3( queryParams?: {activeOnly?: boolean | null, banType?: string | null, limit?: number, offset?: number}): Promise<AxiosResponse<GetUserBanV3Response>> {
    const $ = new BansAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getBans_v3,getBansReasons_v3,getBantypes_v3,getBansUsers_v3,createBanUser_v3,patchBanUserDisabled_v3,
  }
}
