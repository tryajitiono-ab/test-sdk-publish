...
export function ClientsAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * action code: 10308 
   */
  async function getClients_v3( queryParams?: {clientId?: string | null, clientName?: string | null, clientType?: string | null, limit?: number, offset?: number, skipLoginQueue?: boolean | null}): Promise<AxiosResponse<ClientsV3Response>> {
   ...
   */
  async function deletePermission_ByClientId_ByResource_ByAction_v3(clientId:string, resource:string, action:number): Promise<AxiosResponse<unknown>> {
    const $ = new ClientsAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getClients_v3,createClient_v3,updateClient_v3,updateSecret_ByClientId_v3,deleteClient_ByClientId_v3,getClient_ByClientId_v3,patchClient_ByClientId_v3,updatePermission_ByClientId_v3,updatePermission_ByClientId_ByNS_v3,deletePermission_ByClientId_ByResource_ByAction_v3,
  }
}
