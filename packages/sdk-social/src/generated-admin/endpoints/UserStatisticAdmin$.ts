...
export class UserStatisticAdmin$ {
  ...
  patchStatitemValueBulk(data: BulkUserStatItemInc[]): Promise<Response<BulkStatOperationResultArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, BulkStatOperationResultArray, 'BulkStatOperationResultArray')
  }
   ...
   */
  getStatitems_ByUserId(userId:string,  queryParams?: {isPublic?: boolean | null, limit?: number, offset?: number, sortBy?: string | null, statCodes?: string | null, tags?: string | null}): Promise<Response<UserStatItemPagingSlicedResult>> {
    const params = {limit: 20,sortBy: 'updatedAt:asc', ...queryParams} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/statitems'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserStatItemPagingSlicedResult, 'UserStatItemPagingSlicedResult')
  }
   ...
   */
  getStatitems_ByStatCode(statCode:string,  queryParams?: {limit?: number, offset?: number, sortBy?: string | null}): Promise<Response<StatItemValuePagingSlicedResult>> {
    const params = {limit: 20,sortBy: 'value:desc', ...queryParams} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/stats/{statCode}/statitems'.replace('{namespace}', this.namespace).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, StatItemValuePagingSlicedResult, 'StatItemValuePagingSlicedResult')
  }
  ...
  createStatitemBulk_ByUserId(userId:string, data: BulkStatItemCreate[]): Promise<Response<BulkStatOperationResultArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/statitems/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
   ...
   */
  getStatitemsValueBulkGetOrDefault( queryParams: {statCode: string | null, userIds: string[]}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/statitems/value/bulk/getOrDefault'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ADtoObjectForUserStatItemValueArray, 'ADtoObjectForUserStatItemValueArray')
  }
  
  /**
   * Bulk fetch multiple user&#39;s stat item values for a given namespace and statCode. NOTE: If stat item does not exist, will return default value. Other detail info: + *Returns*: list of user&#39;s stat item values 
   */
  getStatitemsValueBulkGetOrDefault_v2( queryParams: {statCode: string | null, userIds: string[], additionalKey?: string | null}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  patchStatitemValueBulk_ByUserId(userId:string, data: BulkStatItemInc[]): Promise<Response<BulkStatOperationResultArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/statitems/value/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
   ...
   */
  getStatitemsValueBulk_ByUserId_v2(userId:string,  queryParams?: {additionalKey?: string | null, statCodes?: string[], tags?: string[]}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/admin/namespaces/{namespace}/users/{userId}/statitems/value/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  updateStatitemValueBulk_ByUserId_v2(userId:string, data: BulkStatItemUpdate[], queryParams?: {additionalKey?: string | null}): Promise<Response<BulkStatOperationResultArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/admin/namespaces/{namespace}/users/{userId}/statitems/value/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  updateStatitemValueResetBulk_ByUserId(userId:string, data: BulkStatItemReset[]): Promise<Response<BulkStatOperationResultArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/statitems/value/reset/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  deleteStatitem_ByUserId_ByStatCode(userId:string, statCode:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
   ...
   */
  updateStatitemValueResetBulk_ByUserId_v2(userId:string, data: ADtoObjectForResettingUserStatItems[], queryParams?: {additionalKey?: string | null}): Promise<Response<BulkStatOperationResultArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/admin/namespaces/{namespace}/users/{userId}/statitems/value/reset/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
   ...
   */
  deleteStatitem_ByUserId_ByStatCode_v2(userId:string, statCode:string,  queryParams?: {additionalKey?: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/admin/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  patchStatitemValue_ByUserId_ByStatCode(userId:string, statCode:string, data: StatItemInc): Promise<Response<StatItemIncResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems/value'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
   ...
   */
  updateStatitemValue_ByUserId_ByStatCode_v2(userId:string, statCode:string, data: StatItemUpdate, queryParams?: {additionalKey?: string | null}): Promise<Response<StatItemIncResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/admin/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems/value'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
   ...
   */
  createStatitemValueBulkGetOrDefault_ByUserId_v2(userId:string, data: BulkUserStatItemByStatCodes, queryParams?: {additionalKey?: string | null}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/admin/namespaces/{namespace}/users/{userId}/statitems/value/bulk/getOrDefault'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
   ...
   */
  updateStatitemValueReset_ByUserId_ByStatCode(userId:string, statCode:string, data: StatResetInfo, queryParams?: {additionalKey?: string | null}): Promise<Response<StatItemIncResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v1/admin/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems/value/reset'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
