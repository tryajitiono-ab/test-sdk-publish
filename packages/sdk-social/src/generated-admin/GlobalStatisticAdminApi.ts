...
export function GlobalStatisticAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getGlobalstatitems( queryParams?: {limit?: number, offset?: number, statCodes?: string | null}): Promise<AxiosResponse<GlobalStatItemPagingSlicedResult>> {
    const $ = new GlobalStatisticAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getGlobalstatitems,getGlobalstatitem_ByStatCode,
  }
}
