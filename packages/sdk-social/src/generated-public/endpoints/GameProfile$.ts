...
export class GameProfile$ {
  ...
  getProfiles_ByUserId(userId:string): Promise<Response<GameProfileHeaderArray>> {
    ...
    const url = '/social/public/namespaces/{namespace}/users/{userId}/profiles'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GameProfileHeaderArray, 'GameProfileHeaderArray')
  }
  ...
  deleteProfile_ByUserId_ByProfileId(userId:string, profileId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/public/namespaces/{namespace}/users/{userId}/profiles/{profileId}'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{profileId}', profileId)     
   ...
   */
  getAttribute_ByUserId_ByProfileId_ByAttributeName(userId:string, profileId:string, attributeName:string): Promise<Response<Attribute>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/public/namespaces/{namespace}/users/{userId}/profiles/{profileId}/attributes/{attributeName}'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{profileId}', profileId).replace('{attributeName}', attributeName)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  updateAttribute_ByUserId_ByProfileId_ByAttributeName(userId:string, profileId:string, attributeName:string, data: Attribute): Promise<Response<GameProfileInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/public/namespaces/{namespace}/users/{userId}/profiles/{profileId}/attributes/{attributeName}'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{profileId}', profileId).replace('{attributeName}', attributeName)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
