...
export class Slot$ {
  ...
  getSlots_ByUserId(userId:string): Promise<Response<SlotInfoArray>> {
    ...
    const url = '/social/public/namespaces/{namespace}/users/{userId}/slots'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
   ...
   */
  createSlot_ByUserId(userId:string, data: {checksum?: string | null,customAttribute?: string | null,file?: File}, queryParams?: {label?: string | null, tags?: string[]}): Promise<Response<unknown>> {
  ...
  deleteSlot_ByUserId_BySlotId(userId:string, slotId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/public/namespaces/{namespace}/users/{userId}/slots/{slotId}'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{slotId}', slotId)     
   ...
   */
  updateSlot_ByUserId_BySlotId(userId:string, slotId:string, data: {checksum?: string | null,customAttribute?: string | null,file?: File}, queryParams?: {label?: string | null, tags?: string[]}): Promise<Response<SlotInfo>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/public/namespaces/{namespace}/users/{userId}/slots/{slotId}'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{slotId}', slotId)     
  ...
  updateMetadata_ByUserId_BySlotId(userId:string, slotId:string, data: SlotMetadataUpdate): Promise<Response<SlotInfo>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/public/namespaces/{namespace}/users/{userId}/slots/{slotId}/metadata'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{slotId}', slotId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
