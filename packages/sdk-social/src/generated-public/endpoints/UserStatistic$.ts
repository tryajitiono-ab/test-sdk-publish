...
export class UserStatistic$ {
   ...
   */
  getUsersMeStatitems( queryParams?: {limit?: number, offset?: number, sortBy?: string | null, statCodes?: string[], tags?: string[]}): Promise<Response<UserStatItemPagingSlicedResult>> {
   ...
   * Public list all statItems by pagination.&lt;br&gt;Other detail info:&lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: stat items&lt;/li&gt;&lt;/ul&gt; 
   */
  getStatitems_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, sortBy?: string | null, statCodes?: string | null, tags?: string | null}): Promise<Response<UserStatItemPagingSlicedResult>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/statitems'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  createStatitemBulk_ByUserId(userId:string, data: BulkStatItemCreate[]): Promise<Response<BulkStatOperationResultArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/statitems/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
   ...
   */
  getUsersMeStatitemsValueBulk( queryParams?: {additionalKey?: string | null, statCodes?: string[], tags?: string[]}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   * Public list all statItems of user.&lt;br&gt;NOTE: &lt;li&gt;If stat code does not exist, will ignore this stat code.&lt;/li&gt;&lt;li&gt;If stat item does not exist, will return default value&lt;/li&gt;&lt;/ul&gt;Other detail info:&lt;ul&gt;&lt;li&gt;&lt;i&gt;Returns&lt;/i&gt;: stat items&lt;/li&gt;&lt;/ul&gt; 
   */
  getStatitemsValueBulk_ByUserId(userId:string,  queryParams?: {additionalKey?: string | null, statCodes?: string[], tags?: string[]}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/statitems/value/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getStatitemsValueBulk_ByUserId_v2(userId:string,  queryParams?: {additionalKey?: string | null, statCodes?: string[], tags?: string[]}): Promise<Response<ADtoObjectForUserStatItemValueArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/public/namespaces/{namespace}/users/{userId}/statitems/value/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  updateStatitemValueResetBulk_ByUserId(userId:string, data: BulkStatItemReset[]): Promise<Response<BulkStatOperationResultArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/statitems/value/reset/bulk'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  deleteStatitem_ByUserId_ByStatCode(userId:string, statCode:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
  ...
  patchStatitemValue_ByUserId_ByStatCode(userId:string, statCode:string, data: StatItemInc): Promise<Response<StatItemIncResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems/value'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
  ...
  updateStatitemValue_ByUserId_ByStatCode_v2(userId:string, statCode:string, data: StatItemUpdate, queryParams?: {additionalKey?: string | null}): Promise<Response<StatItemIncResult>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/social/v2/public/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems/value'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
  ...
  updateStatitemValueReset_ByUserId_ByStatCode(userId:string, statCode:string): Promise<Response<StatItemIncResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/social/v1/public/namespaces/{namespace}/users/{userId}/stats/{statCode}/statitems/value/reset'.replace('{namespace}', this.namespace).replace('{userId}', userId).replace('{statCode}', statCode)     
