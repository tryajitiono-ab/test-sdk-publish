...
export class EmailSenderApiKeyAdmin$ {
  ...
  getEmailsenderApikeysAccounts(): Promise<Response<EmailSenderApiKeyResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EmailSenderApiKeyResponseArray, 'EmailSenderApiKeyResponseArray')
  }
  ...
  createEmailsenderApikeyAccount(data: CreateEmailSenderApiKeyRequest): Promise<Response<EmailSenderApiKeyResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EmailSenderApiKeyResponse, 'EmailSenderApiKeyResponse')
  }
  ...
  deleteEmailsenderApikeyAccount_ByAccount(account:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/config/v1/admin/namespaces/{namespace}/emailsender/apikeys/accounts/{account}'.replace('{namespace}', this.namespace).replace('{account}', account)     
   ...
   */
  getLinkedsendersApikeysEmailsender_ByAccount(account:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<LinkedEmailSendersResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/config/v1/admin/namespaces/{namespace}/emailsender/apikeys/accounts/{account}/linkedsenders'.replace('{namespace}', this.namespace).replace('{account}', account)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, LinkedEmailSendersResponse, 'LinkedEmailSendersResponse')
  }
