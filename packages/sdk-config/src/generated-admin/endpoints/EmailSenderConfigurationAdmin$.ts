...
export class EmailSenderConfigurationAdmin$ {
  ...
  createEmailsender(data: CreateEmailSenderRequest): Promise<Response<EmailSenderDomainResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EmailSenderDomainResponse, 'EmailSenderDomainResponse')
  }
  ...
  createEmailsenderAuthenticationVerify(): Promise<Response<EmailSenderVerifyResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, EmailSenderVerifyResponse, 'EmailSenderVerifyResponse')
  }
