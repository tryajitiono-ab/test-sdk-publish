...
export function RuleSetsApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * List rule sets.  
   */
  async function getRulesets( queryParams?: {limit?: number, name?: string | null, offset?: number}): Promise<AxiosResponse<ListRuleSetsResponse>> {
  ...
  return {
    getRulesets,createRuleset,deleteRuleset_ByRuleset,getRuleset_ByRuleset,updateRuleset_ByRuleset,
  }
}
