...
export function EnvironmentVariablesApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getEnvironmentVariables(): Promise<AxiosResponse<ListEnvironmentVariablesResponse>> {
