...
export function BackfillApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  return {
    createBackfill,getBackfillProposal,deleteBackfill_ByBackfillId,getBackfill_ByBackfillId,updateProposalAccept_ByBackfillId,updateProposalReject_ByBackfillId,
  }
}
