...
export function MatchTicketsApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getMatchTicketsMe( queryParams?: {limit?: number, matchPool?: string | null, offset?: number}): Promise<AxiosResponse<MatchTicketStatuses>> {
    const $ = new MatchTickets$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createMatchTicket,getMatchTicketsMe,deleteMatchTicket_ByTicketid,getMatchTicket_ByTicketid,
  }
}
