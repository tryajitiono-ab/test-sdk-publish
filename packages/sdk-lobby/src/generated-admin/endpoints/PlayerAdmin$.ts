...
export class PlayerAdmin$ {
  ...
  fetchPlayerUserBulkBlocked(data: GetBulkAllPlayerBlockedUsersRequest): Promise<Response<GetBulkAllPlayerBlockedUsersResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetBulkAllPlayerBlockedUsersResponse, 'GetBulkAllPlayerBlockedUsersResponse')
  }
  ...
  getBlockedPlayer_ByUserId(userId:string): Promise<Response<GetAllPlayerBlockedUsersResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetAllPlayerBlockedUsersResponse, 'GetAllPlayerBlockedUsersResponse')
  }
  ...
  getAttributesPlayer_ByUserId(userId:string): Promise<Response<GetAllPlayerSessionAttributeResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetAllPlayerSessionAttributeResponse, 'GetAllPlayerSessionAttributeResponse')
  }
  ...
  getBlockedByPlayer_ByUserId(userId:string): Promise<Response<GetAllPlayerBlockedByUsersResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetAllPlayerBlockedByUsersResponse, 'GetAllPlayerBlockedByUsersResponse')
  }
  ...
  getAttributePlayer_ByUserId_ByAttribute(userId:string, attribute:string): Promise<Response<GetPlayerSessionAttributeResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetPlayerSessionAttributeResponse, 'GetPlayerSessionAttributeResponse')
  }
