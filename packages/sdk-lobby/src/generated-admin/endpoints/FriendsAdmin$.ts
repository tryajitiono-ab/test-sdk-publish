...
export class FriendsAdmin$ {
   ...
   */
  getFriendUser_ByUserId(userId:string,  queryParams?: {friendId?: string | null, friendIds?: string[], limit?: number, offset?: number}): Promise<Response<GetFriendsResponse>> {
   ...
   */
  getIncomingFriend_ByUserId(userId:string,  queryParams?: {friendId?: string | null, limit?: number, offset?: number}): Promise<Response<LoadIncomingFriendsWithTimeResponse>> {
    const params = {limit: 25, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, LoadIncomingFriendsWithTimeResponse, 'LoadIncomingFriendsWithTimeResponse')
  }
  
  /**
   * Get list of outgoing friend requests in a namespace. 
   */
  getOutgoingFriend_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number}): Promise<Response<LoadOutgoingFriendsWithTimeResponse>> {
    const params = {limit: 25, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, LoadOutgoingFriendsWithTimeResponse, 'LoadOutgoingFriendsWithTimeResponse')
  }
   ...
   */
  getOfFriends_ByUserId(userId:string,  queryParams?: {friendId?: string | null, limit?: number, nopaging?: boolean | null, offset?: number}): Promise<Response<FriendshipConnectionResponse>> {
    const params = {limit: 25, ...queryParams} as AxiosRequestConfig
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, FriendshipConnectionResponse, 'FriendshipConnectionResponse')
  }
