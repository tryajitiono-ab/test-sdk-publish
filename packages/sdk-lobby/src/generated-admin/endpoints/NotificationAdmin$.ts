...
export class NotificationAdmin$ {
   ...
   */
  getNotificationTopics( queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<Response<GetAllNotificationTopicsResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/lobby/v1/admin/notification/namespaces/{namespace}/topics'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetAllNotificationTopicsResponse, 'GetAllNotificationTopicsResponse')
  }
  ...
  getNotificationTemplates(): Promise<Response<NotificationTemplateResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, NotificationTemplateResponseArray, 'NotificationTemplateResponseArray')
  }
  ...
  getNotificationTopic_ByTopicName(topicName:string): Promise<Response<NotificationTopicResponseV1>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, NotificationTopicResponseV1, 'NotificationTopicResponseV1')
  }
   ...
   */
  getNotificationTemplate_ByTemplateSlug(templateSlug:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<Response<GetAllNotificationTemplateSlugResp>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/lobby/v1/admin/notification/namespaces/{namespace}/templates/{templateSlug}'.replace('{namespace}', this.namespace).replace('{templateSlug}', templateSlug)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetAllNotificationTemplateSlugResp, 'GetAllNotificationTemplateSlugResp')
  }
