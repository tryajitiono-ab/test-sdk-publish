...
export class Notification$ {
   ...
   */
  getNotificationMe( queryParams?: {endTime?: number, limit?: number, offset?: number, startTime?: number}): Promise<Response<NotificationResponse>> {
   ...
   */
  getNotificationTopics( queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<Response<TopicByNamespacesResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/notification/namespaces/{namespace}/topics'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TopicByNamespacesResponse, 'TopicByNamespacesResponse')
  }
  ...
  getNotificationTopic_ByTopic(topic:string): Promise<Response<NotificationTopicResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, NotificationTopicResponse, 'NotificationTopicResponse')
  }
