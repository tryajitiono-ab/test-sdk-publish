...
export function AdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * Get all templates in a namespace 
   */
  async function getNotificationTemplate_ByTemplateSlug(templateSlug:string,  queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<AxiosResponse<TemplateLocalizationResponse>> {
    const $ = new Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getLanguageNotification_ByTemplateSlug_ByTemplateLanguage(templateSlug:string, templateLanguage:string): Promise<AxiosResponse<TemplateLocalization>> {
    const $ = new Admin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createNotificationFreeform,createNotificationTemplated,getNotificationTemplates,createNotificationTemplate,deleteNotificationTemplate_ByTemplateSlug,getNotificationTemplate_ByTemplateSlug,deleteLanguageNotification_ByTemplateSlug_ByTemplateLanguage,getLanguageNotification_ByTemplateSlug_ByTemplateLanguage,updateLanguageNotification_ByTemplateSlug_ByTemplateLanguage,createPublishNotification_ByTemplateSlug_ByTemplateLanguage,
  }
}
