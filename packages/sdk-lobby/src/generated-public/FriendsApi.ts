...
export function FriendsApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getFriendsMeIncoming( queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<GetUserIncomingFriendsResponseArray>> {
    const $ = new Friends$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getFriendsMeOutgoing( queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<GetUserOutgoingFriendsResponseArray>> {
    const $ = new Friends$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getFriendsMePlatforms( queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<ListBulkUserPlatformsResponse>> {
    const $ = new Friends$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getFriendsMeIncomingTime( queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<LoadIncomingFriendsWithTimeResponseArray>> {
    const $ = new Friends$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getFriendsMeOutgoingTime( queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<LoadOutgoingFriendsWithTimeResponseArray>> {
    const $ = new Friends$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getFriendsMe,patchFriendSyncMe,createFriendMeRequest,getFriendsMeIncoming,getFriendsMeOutgoing,createFriendMeUnfriend,getFriendsMePlatforms,getFriendsMeIncomingTime,getFriendsMeOutgoingTime,createFriendMeRequestAccept,createFriendMeRequestCancel,createFriendMeRequestReject,getFriendMeStatu_ByFriendId,createAddBulkFriend_ByUserId,createDeleteBulkFriend_ByUserId,
  }
}
