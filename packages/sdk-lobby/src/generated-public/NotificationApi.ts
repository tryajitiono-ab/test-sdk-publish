...
export function NotificationApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getNotificationMe( queryParams?: {endTime?: number, limit?: number, offset?: number, startTime?: number}): Promise<AxiosResponse<NotificationResponse>> {
   ...
   */
  async function getNotificationTopics( queryParams?: {after?: string | null, before?: string | null, limit?: number}): Promise<AxiosResponse<TopicByNamespacesResponse>> {
    const $ = new Notification$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createTemplatedNotification_ByUserId(userId:string, data: NotificationWithTemplateRequest): Promise<AxiosResponse<unknown>> {
    const $ = new Notification$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getNotificationMe,getNotificationTopics,createNotificationTopic,deleteNotificationTopic_ByTopic,getNotificationTopic_ByTopic,updateNotificationTopic_ByTopic,createFreeformNotification_ByUserId,createTemplatedNotification_ByUserId,
  }
}
