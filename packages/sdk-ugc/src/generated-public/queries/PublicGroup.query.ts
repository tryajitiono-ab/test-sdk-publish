  ...
  input: Parameters<typeof usePublicGroupApi_GetGroups_ByUserId>[1]
      ...
      const response = 
            (await PublicGroupApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                getGroups_ByUserId(input.userId, input.queryParams))
...
export const usePublicGroupApi_CreateGroup_ByUserId = (
    sdk: AccelByteSDK,
  ...
  const mutationFn = async (input: SdkSetConfigParam & { userId:string, data: CreateGroupRequest }) => {
      const response = 
            (await PublicGroupApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                createGroup_ByUserId(input.userId, input.data))
...
export const usePublicGroupApi_DeleteGroup_ByUserId_ByGroupId = (
    sdk: AccelByteSDK,
...
export const usePublicGroupApi_UpdateGroup_ByUserId_ByGroupId = (
    sdk: AccelByteSDK,
