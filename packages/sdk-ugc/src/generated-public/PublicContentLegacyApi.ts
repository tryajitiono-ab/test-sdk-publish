...
export function PublicContentLegacyApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getContents( queryParams?: {creator?: string | null, ishidden?: string | null, isofficial?: string | null, limit?: number, name?: string | null, offset?: number, orderby?: string | null, sortby?: string | null, subtype?: string | null, tags?: string[], type?: string | null, userId?: string | null}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
   ...
   */
  async function getContents_ByChannelId(channelId:string,  queryParams?: {creator?: string | null, ishidden?: string | null, isofficial?: string | null, limit?: number, name?: string | null, offset?: number, orderby?: string | null, sortby?: string | null, subtype?: string | null, tags?: string[], type?: string | null, userId?: string | null}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createContent_ByUserId_ByChannelId(userId:string, channelId:string, data: CreateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createContentS3_ByUserId_ByChannelId(userId:string, channelId:string, data: PublicCreateContentRequestS3): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createScreenshot_ByUserId_ByContentId(userId:string, contentId:string, data: CreateScreenshotRequest): Promise<AxiosResponse<CreateScreenshotResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateScreenshot_ByUserId_ByContentId(userId:string, contentId:string, data: UpdateScreenshotRequest): Promise<AxiosResponse<UpdateScreenshotResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateContentS3_ByUserId_ByChannelId_ByContentId(userId:string, channelId:string, contentId:string, data: UpdateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteScreenshot_ByUserId_ByContentId_ByScreenshotId(userId:string, contentId:string, screenshotId:string): Promise<AxiosResponse<unknown>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchSharecode_ByUserId_ByChannelId_ByContentId(userId:string, channelId:string, contentId:string, data: UpdateContentShareCodeRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateContentS3Sharecode_ByUserId_ByChannelId_ByShareCode(userId:string, channelId:string, shareCode:string, data: UpdateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new PublicContentLegacy$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getContents,createContentBulk,getContent_ByContentId,getContents_ByUserId,createContentSharecodeBulk,getPreview_ByContentId,getContents_ByChannelId,getContentSharecode_ByShareCode,createContent_ByUserId_ByChannelId,createContentS3_ByUserId_ByChannelId,createScreenshot_ByUserId_ByContentId,updateScreenshot_ByUserId_ByContentId,deleteContent_ByUserId_ByChannelId_ByContentId,updateContent_ByUserId_ByChannelId_ByContentId,updateContentS3_ByUserId_ByChannelId_ByContentId,deleteScreenshot_ByUserId_ByContentId_ByScreenshotId,patchSharecode_ByUserId_ByChannelId_ByContentId,deleteContentSharecode_ByUserId_ByChannelId_ByShareCode,updateContentS3Sharecode_ByUserId_ByChannelId_ByShareCode,
  }
}
