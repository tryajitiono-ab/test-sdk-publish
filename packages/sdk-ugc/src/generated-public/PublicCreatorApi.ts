...
export function PublicCreatorApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsers( queryParams?: {limit?: number, offset?: number, orderby?: string | null, sortby?: string | null}): Promise<AxiosResponse<PaginatedCreatorOverviewResponse>> {
