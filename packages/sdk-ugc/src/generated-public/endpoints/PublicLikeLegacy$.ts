...
export class PublicLikeLegacy$ {
   ...
   */
  getContentsLiked( queryParams?: {isofficial?: boolean | null, limit?: number, name?: string | null, offset?: number, orderby?: string | null, sortby?: string | null, subtype?: string | null, tags?: string[], type?: string | null}): Promise<Response<PaginatedContentDownloadResponse>> {
  ...
  updateLike_ByContentId(contentId:string, data: ContentLikeRequest): Promise<Response<ContentLikeResponse>> {
    ...
    const url = '/ugc/v1/public/namespaces/{namespace}/contents/{contentId}/like'.replace('{namespace}', this.namespace).replace('{contentId}', contentId)     
