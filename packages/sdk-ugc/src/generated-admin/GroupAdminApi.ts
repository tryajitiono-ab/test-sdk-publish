...
export function GroupAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * Get user group paginated 
   */
  async function getGroups_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<PaginatedGroupResponse>> {
    const $ = new GroupAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getContents_ByGroupId(groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
    const $ = new GroupAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getContents_ByGroupId_v2(groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<PaginatedContentDownloadResponseV2>> {
    const $ = new GroupAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Replace group name and contents with new ones. 
   */
  async function updateGroup_ByUserId_ByGroupId(userId:string, groupId:string, data: CreateGroupRequest): Promise<AxiosResponse<CreateGroupResponse>> {
    const $ = new GroupAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Get content belong to a group 
   */
  async function getContents_ByUserId_ByGroupId(userId:string, groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
    const $ = new GroupAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Get contents belong to a group 
   */
  async function getContents_ByUserId_ByGroupId_v2(userId:string, groupId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<PaginatedContentDownloadResponseV2>> {
    const $ = new GroupAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getGroups,createGroup,deleteGroup_ByGroupId,getGroup_ByGroupId,updateGroup_ByGroupId,getGroups_ByUserId,getContents_ByGroupId,getContents_ByGroupId_v2,deleteGroup_ByUserId_ByGroupId,getGroup_ByUserId_ByGroupId,updateGroup_ByUserId_ByGroupId,getContents_ByUserId_ByGroupId,getContents_ByUserId_ByGroupId_v2,
  }
}
