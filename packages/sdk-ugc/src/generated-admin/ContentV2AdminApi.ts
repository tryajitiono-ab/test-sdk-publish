...
export function ContentV2AdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function fetchContentSharecodeBulk_v2(data: GetContentBulkByShareCodesRequest): Promise<AxiosResponse<ContentDownloadResponseV2Array>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createContent_ByChannelId_v2(channelId:string, data: AdminContentRequestV2): Promise<AxiosResponse<CreateContentResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createScreenshot_ByContentId_v2(contentId:string, data: CreateScreenshotRequest): Promise<AxiosResponse<CreateScreenshotResponse>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateScreenshot_ByContentId_v2(contentId:string, data: UpdateScreenshotRequest): Promise<AxiosResponse<UpdateScreenshotResponse>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateHide_ByUserId_ByContentId_v2(userId:string, contentId:string, data: HideContentRequest): Promise<AxiosResponse<CreateContentResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchContent_ByChannelId_ByContentId_v2(channelId:string, contentId:string, data: AdminUpdateContentRequestV2): Promise<AxiosResponse<UpdateContentResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateRollback_ByContentId_ByVersionId_v2(contentId:string, versionId:string): Promise<AxiosResponse<ContentDownloadResponse>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
  ...
  async function createCopy_ByChannelId_ByContentId_v2(channelId:string, contentId:string, data: CopyContentRequest): Promise<AxiosResponse<ContentDownloadResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchUploadUrl_ByChannelId_ByContentId_v2(channelId:string, contentId:string, data: GenerateContentUploadUrlRequest): Promise<AxiosResponse<GenerateContentUploadUrlResponse>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchFileLocation_ByChannelId_ByContentId_v2(channelId:string, contentId:string, data: UpdateFileLocationRequest): Promise<AxiosResponse<UpdateContentResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchContent_ByUserId_ByChannelId_ByContentId_v2(userId:string, channelId:string, contentId:string, data: AdminUpdateContentRequestV2): Promise<AxiosResponse<UpdateContentResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateContentS3Sharecode_ByUserId_ByChannelId_ByShareCode_v2(userId:string, channelId:string, shareCode:string, data: AdminUpdateContentRequestV2): Promise<AxiosResponse<CreateContentResponseV2>> {
    const $ = new ContentV2Admin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getContents_v2,fetchContentBulk_v2,getContent_ByContentId_v2,getContents_ByUserId_v2,fetchContentSharecodeBulk_v2,getContents_ByChannelId_v2,createContent_ByChannelId_v2,getVersions_ByContentId_v2,getContentSharecode_ByShareCode_v2,createScreenshot_ByContentId_v2,updateScreenshot_ByContentId_v2,updateHide_ByUserId_ByContentId_v2,deleteContent_ByChannelId_ByContentId_v2,patchContent_ByChannelId_ByContentId_v2,updateRollback_ByContentId_ByVersionId_v2,createCopy_ByChannelId_ByContentId_v2,deleteScreenshot_ByContentId_ByScreenshotId_v2,patchUploadUrl_ByChannelId_ByContentId_v2,patchFileLocation_ByChannelId_ByContentId_v2,deleteContent_ByUserId_ByChannelId_ByContentId_v2,patchContent_ByUserId_ByChannelId_ByContentId_v2,patchUploadUrl_ByUserId_ByChannelId_ByContentId_v2,deleteContentSharecode_ByUserId_ByChannelId_ByShareCode_v2,patchFileLocation_ByUserId_ByChannelId_ByContentId_v2,updateContentS3Sharecode_ByUserId_ByChannelId_ByShareCode_v2,
  }
}
