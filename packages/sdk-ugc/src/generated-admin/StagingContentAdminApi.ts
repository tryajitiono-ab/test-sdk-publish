...
export function StagingContentAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getStagingContents_v2( queryParams?: {limit?: number, offset?: number, sortBy?: string | null, status?: string | null}): Promise<AxiosResponse<PaginatedListStagingContentResponse>> {
   ...
   */
  async function createApprove_ByContentId_v2(contentId:string, data: ApproveStagingContentRequest): Promise<AxiosResponse<StagingContentResponse>> {
    const $ = new StagingContentAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getStagingContents_v2,getStagingContent_ByContentId_v2,getStagingContents_ByUserId_v2,createApprove_ByContentId_v2,
  }
}
