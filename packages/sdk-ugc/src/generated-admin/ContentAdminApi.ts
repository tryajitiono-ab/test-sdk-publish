...
export function ContentAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getContentsSearch( queryParams?: {creator?: string | null, ishidden?: string | null, isofficial?: string | null, limit?: number, name?: string | null, offset?: number, orderby?: string | null, sortby?: string | null, subtype?: string | null, tags?: string[], type?: string | null, userId?: string | null}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [READ]&lt;/b&gt;. 
   */
  async function getContents_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createContentS3_ByChannelId(channelId:string, data: CreateContentRequestS3): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createScreenshot_ByContentId(contentId:string, data: CreateScreenshotRequest): Promise<AxiosResponse<CreateScreenshotResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateScreenshot_ByContentId(contentId:string, data: UpdateScreenshotRequest): Promise<AxiosResponse<UpdateScreenshotResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:*:CONTENT [READ]&lt;/b&gt; For advance tag filtering supports &amp; as AND operator and | as OR operator and parentheses () for priority. e.g: &lt;code&gt;tags=red&lt;/code&gt; &lt;code&gt;tags=red&amp;animal&lt;/code&gt; &lt;code&gt;tags=red|animal&lt;/code&gt; &lt;code&gt;tags=red&amp;animal|wild&lt;/code&gt; &lt;code&gt;tags=red&amp;(animal|wild)&lt;/code&gt; The precedence of logical operator is AND &gt; OR, so if no parentheses, AND logical operator will be executed first. Allowed character for operand: alphanumeric, underscore &lt;code&gt;_&lt;/code&gt; and dash &lt;code&gt;-&lt;/code&gt; Allowed character for operator: &lt;code&gt;&amp;&lt;/code&gt; &lt;code&gt;|&lt;/code&gt; &lt;code&gt;(&lt;/code&gt; &lt;code&gt;)&lt;/code&gt; &lt;b&gt;Please note that value of tags query param should be URL encoded&lt;/b&gt; 
   */
  async function getContentsSearch_ByChannelId(channelId:string,  queryParams?: {creator?: string | null, ishidden?: string | null, isofficial?: string | null, limit?: number, name?: string | null, offset?: number, orderby?: string | null, sortby?: string | null, subtype?: string | null, tags?: string[], type?: string | null, userId?: string | null}): Promise<AxiosResponse<PaginatedContentDownloadResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateHide_ByUserId_ByContentId(userId:string, contentId:string, data: HideContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [UPDATE]&lt;/b&gt;.\n All request body are required except preview, tags and customAttributes.  
   */
  async function updateContent_ByChannelId_ByContentId(channelId:string, contentId:string, data: CreateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateRollback_ByContentId_ByVersionId(contentId:string, versionId:string): Promise<AxiosResponse<ContentDownloadResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateContentS3_ByChannelId_ByContentId(channelId:string, contentId:string, data: AdminUpdateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [DELETE]&lt;/b&gt;. 
   */
  async function deleteContent_ByUserId_ByChannelId_ByContentId(userId:string, channelId:string, contentId:string): Promise<AxiosResponse<unknown>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [UPDATE]&lt;/b&gt;.\n All request body are required except preview, tags and customAttributes.  
   */
  async function updateContent_ByUserId_ByChannelId_ByContentId(userId:string, channelId:string, contentId:string, data: CreateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [UPDATE]&lt;/b&gt;. All request body are required except &lt;code&gt;payload&lt;/code&gt;, &lt;code&gt;preview&lt;/code&gt;, &lt;code&gt;tags&lt;/code&gt;,&lt;code&gt;contentType&lt;/code&gt;, &lt;code&gt;updateContentFile&lt;/code&gt;, &lt;code&gt;customAttributes&lt;/code&gt; and &lt;code&gt;shareCode&lt;/code&gt;. &lt;code&gt;contentType&lt;/code&gt; values is used to enforce the Content-Type header needed by the client to upload the content using the S3 presigned URL. If not specified, it will use &lt;code&gt;fileExtension&lt;/code&gt; value. To update content file, set &lt;code&gt;updateContentFile&lt;/code&gt; to &lt;code&gt;true&lt;/code&gt; and upload the file using URL in &lt;code&gt;payloadURL.url&lt;/code&gt; in response body. &lt;code&gt;shareCode&lt;/code&gt; format should follows: Max length: 7 Available characters: abcdefhkpqrstuxyz &lt;br&gt;&lt;p&gt;&lt;b&gt;NOTE: Preview is Legacy Code, please use Screenshot for better solution to display preview of a content&lt;/b&gt;&lt;/p&gt; 
   */
  async function updateContentS3_ByUserId_ByChannelId_ByContentId(userId:string, channelId:string, contentId:string, data: AdminUpdateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [DELETE]&lt;/b&gt;. 
   */
  async function deleteContentSharecode_ByUserId_ByChannelId_ByShareCode(userId:string, channelId:string, shareCode:string): Promise<AxiosResponse<unknown>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   * Required permission &lt;b&gt;ADMIN:NAMESPACE:{namespace}:USER:{userId}:CONTENT [UPDATE]&lt;/b&gt;. All request body are required except &lt;code&gt;payload&lt;/code&gt;, &lt;code&gt;preview&lt;/code&gt;, &lt;code&gt;tags&lt;/code&gt;,&lt;code&gt;contentType&lt;/code&gt;, &lt;code&gt;updateContentFile&lt;/code&gt;, &lt;code&gt;customAttributes&lt;/code&gt; and &lt;code&gt;shareCode&lt;/code&gt;. &lt;code&gt;contentType&lt;/code&gt; values is used to enforce the Content-Type header needed by the client to upload the content using the S3 presigned URL. If not specified, it will use &lt;code&gt;fileExtension&lt;/code&gt; value. To update content file, set &lt;code&gt;updateContentFile&lt;/code&gt; to &lt;code&gt;true&lt;/code&gt; and upload the file using URL in &lt;code&gt;payloadURL.url&lt;/code&gt; in response body. &lt;code&gt;shareCode&lt;/code&gt; format should follows: Max length: 7 Available characters: abcdefhkpqrstuxyz &lt;br&gt;&lt;p&gt;&lt;b&gt;NOTE: Preview is Legacy Code, please use Screenshot for better solution to display preview of a content&lt;/b&gt;&lt;/p&gt; 
   */
  async function updateContentS3Sharecode_ByUserId_ByChannelId_ByShareCode(userId:string, channelId:string, shareCode:string, data: AdminUpdateContentRequest): Promise<AxiosResponse<CreateContentResponse>> {
    const $ = new ContentAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getContents,fetchContentBulk,getContentsSearch,getContent_ByContentId,getContents_ByUserId,fetchContentSharecodeBulk,getPreview_ByContentId,createContent_ByChannelId,getVersions_ByContentId,getContentSharecode_ByShareCode,createContentS3_ByChannelId,createScreenshot_ByContentId,updateScreenshot_ByContentId,getContentsSearch_ByChannelId,updateHide_ByUserId_ByContentId,deleteContent_ByChannelId_ByContentId,updateContent_ByChannelId_ByContentId,updateRollback_ByContentId_ByVersionId,updateContentS3_ByChannelId_ByContentId,deleteScreenshot_ByContentId_ByScreenshotId,deleteContent_ByUserId_ByChannelId_ByContentId,updateContent_ByUserId_ByChannelId_ByContentId,updateContentS3_ByUserId_ByChannelId_ByContentId,deleteContentSharecode_ByUserId_ByChannelId_ByShareCode,updateContentS3Sharecode_ByUserId_ByChannelId_ByShareCode,
  }
}
