...
export function ModerationRuleAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getRules( queryParams?: {category?: string | null, extensionCategory?: string | null, limit?: number, offset?: number}): Promise<AxiosResponse<ModerationRulesList>> {
    const $ = new ModerationRuleAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createRule,getRules,deleteRule_ByRuleId,updateRule_ByRuleId,getRule_ByRuleId,updateStatus_ByRuleId,
  }
}
