...
export class ReportsAdmin$ {
   ...
   */
  getReports( queryParams?: {category?: string | null, limit?: number, offset?: number, reportedUserId?: string | null, sortBy?: string | null}): Promise<Response<ReportListResponse>> {
