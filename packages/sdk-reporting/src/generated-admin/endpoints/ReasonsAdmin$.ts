...
export class ReasonsAdmin$ {
   ...
   */
  getReasons( queryParams?: {group?: string | null, limit?: number, offset?: number, title?: string | null}): Promise<Response<AdminReasonListResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/reasons'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AdminReasonListResponse, 'AdminReasonListResponse')
  }
  ...
  getReasonsAll(): Promise<Response<AdminAllReasonsResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, AdminAllReasonsResponse, 'AdminAllReasonsResponse')
  }
  ...
  getReasonGroups( queryParams?: {limit?: number, offset?: number}): Promise<Response<ReasonGroupListResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ReasonGroupListResponse, 'ReasonGroupListResponse')
  }
   ...
   */
  getReasonsUnused( queryParams: {category: string | null, extensionCategory?: string | null}): Promise<Response<UnusedReasonListResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/reasons/unused'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UnusedReasonListResponse, 'UnusedReasonListResponse')
  }
  ...
  deleteReason_ByReasonId(reasonId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/reasons/{reasonId}'.replace('{namespace}', this.namespace).replace('{reasonId}', reasonId)     
  ...
  deleteReasonGroup_ByGroupId(groupId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/reasonGroups/{groupId}'.replace('{namespace}', this.namespace).replace('{groupId}', groupId)     
    const resultPromise = this.axiosInstance.delete(url, {params})
