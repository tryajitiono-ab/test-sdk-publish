...
export class ModerationRuleAdmin$ {
   ...
   */
  getRules( queryParams?: {category?: string | null, extensionCategory?: string | null, limit?: number, offset?: number}): Promise<Response<ModerationRulesList>> {
  ...
  deleteRule_ByRuleId(ruleId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/rule/{ruleId}'.replace('{namespace}', this.namespace).replace('{ruleId}', ruleId)     
  ...
  updateRule_ByRuleId(ruleId:string, data: ModerationRuleRequest): Promise<Response<ModerationRuleResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ModerationRuleResponse, 'ModerationRuleResponse')
  }
  ...
  getRule_ByRuleId(ruleId:string): Promise<Response<ModerationRuleResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/rules/{ruleId}'.replace('{namespace}', this.namespace).replace('{ruleId}', ruleId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  updateStatus_ByRuleId(ruleId:string, data: ModerationRuleActiveRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/reporting/v1/admin/namespaces/{namespace}/rule/{ruleId}/status'.replace('{namespace}', this.namespace).replace('{ruleId}', ruleId)     
    const resultPromise = this.axiosInstance.put(url, data, {params})
