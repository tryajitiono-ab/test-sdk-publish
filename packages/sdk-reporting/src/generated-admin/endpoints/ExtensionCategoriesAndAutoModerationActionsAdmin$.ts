...
export class ExtensionCategoriesAndAutoModerationActionsAdmin$ {
   ...
   */
  getExtensionCategories( queryParams?: {order?: 'asc' | 'ascending' | 'desc' | 'descending', sortBy?: 'extensionCategory' | 'extensionCategoryName'}): Promise<Response<ExtensionCategoryListApiResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ExtensionCategoryListApiResponse, 'ExtensionCategoryListApiResponse')
  }
  ...
  createExtensionCategory(data: ExtensionCategoryApiRequest): Promise<Response<ExtensionCategoryApiResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ExtensionCategoryApiResponse, 'ExtensionCategoryApiResponse')
  }
