...
export function ReasonsAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getReasons( queryParams?: {group?: string | null, limit?: number, offset?: number, title?: string | null}): Promise<AxiosResponse<AdminReasonListResponse>> {
   ...
   */
  async function getReasonsUnused( queryParams: {category: string | null, extensionCategory?: string | null}): Promise<AxiosResponse<UnusedReasonListResponse>> {
    const $ = new ReasonsAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getReasons,createReason,getReasonsAll,getReasonGroups,createReasonGroup,getReasonsUnused,deleteReason_ByReasonId,getReason_ByReasonId,patchReason_ByReasonId,deleteReasonGroup_ByGroupId,getReasonGroup_ByGroupId,patchReasonGroup_ByGroupId,
  }
}
