...
export class Policies$ {
   ...
   */
  getPolicy_ByNamespace( queryParams?: {alwaysIncludeDefault?: boolean | null, defaultOnEmpty?: boolean | null, policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE', tags?: string | null, visibleOnly?: boolean | null}): Promise<Response<RetrievePolicyPublicResponseArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/agreement/public/policies/namespaces/{namespace}'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RetrievePolicyPublicResponseArray, 'RetrievePolicyPublicResponseArray')
  }
   ...
   */
  getPolicyCountry_ByCountryCode(countryCode:string,  queryParams?: {defaultOnEmpty?: boolean | null, policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE', tags?: string | null, visibleOnly?: boolean | null}): Promise<Response<RetrievePolicyPublicResponseArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getPolicyCountry_ByCountryCode_ByNS(countryCode:string,  queryParams?: {alwaysIncludeDefault?: boolean | null, defaultOnEmpty?: boolean | null, policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE', tags?: string | null, visibleOnly?: boolean | null}): Promise<Response<RetrievePolicyPublicResponseArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
