...
export function PoliciesApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getPolicy_ByNamespace( queryParams?: {alwaysIncludeDefault?: boolean | null, defaultOnEmpty?: boolean | null, policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE', tags?: string | null, visibleOnly?: boolean | null}): Promise<AxiosResponse<RetrievePolicyPublicResponseArray>> {
    const $ = new Policies$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPolicyCountry_ByCountryCode(countryCode:string,  queryParams?: {defaultOnEmpty?: boolean | null, policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE', tags?: string | null, visibleOnly?: boolean | null}): Promise<AxiosResponse<RetrievePolicyPublicResponseArray>> {
    const $ = new Policies$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getPolicyCountry_ByCountryCode_ByNS(countryCode:string,  queryParams?: {alwaysIncludeDefault?: boolean | null, defaultOnEmpty?: boolean | null, policyType?: 'LEGAL_DOCUMENT_TYPE' | 'MARKETING_PREFERENCE_TYPE', tags?: string | null, visibleOnly?: boolean | null}): Promise<AxiosResponse<RetrievePolicyPublicResponseArray>> {
    const $ = new Policies$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getPoliciesCountriesList,getPolicy_ByNamespace,getPolicyCountry_ByCountryCode,getPolicyCountry_ByCountryCode_ByNS,
  }
}
