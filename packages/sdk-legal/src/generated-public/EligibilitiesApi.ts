...
export function EligibilitiesApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUserEligibility_ByCountryCode_ByClientId_ByUserId(countryCode:string, clientId:string, userId:string): Promise<AxiosResponse<RetrieveUserEligibilitiesIndirectResponse>> {
    const $ = new Eligibilities$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getEligibility_ByNamespace,getUserEligibility_ByCountryCode_ByClientId_ByUserId,
  }
}
