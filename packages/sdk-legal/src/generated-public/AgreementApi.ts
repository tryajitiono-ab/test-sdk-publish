...
export function AgreementApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function createAgreementPolicyUser_ByUserId(userId:string, data: AcceptAgreementRequest[]): Promise<AxiosResponse<AcceptAgreementResponse>> {
    const $ = new Agreement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createAgreementLocalizedPolicyVersion_ByLocalizedPolicyVersionId(localizedPolicyVersionId:string): Promise<AxiosResponse<unknown>> {
    const $ = new Agreement$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createUserPolicyAgreement_ByCountryCode_ByClientId_ByUserId(countryCode:string, clientId:string, userId:string, data: AcceptAgreementRequest[]): Promise<AxiosResponse<AcceptAgreementResponse>> {
    const $ = new Agreement$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getAgreementsPolicies,createAgreementPolicy,createAgreementPolicyUser_ByUserId,patchAgreementLocalizedPolicyVersionPreference,createAgreementLocalizedPolicyVersion_ByLocalizedPolicyVersionId,createUserPolicyAgreement_ByCountryCode_ByClientId_ByUserId,
  }
}
