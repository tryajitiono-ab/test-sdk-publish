...
export class AgreementAdmin$ {
   ...
   */
  getAgreementsPolicyVersionsUsers( queryParams: {policyVersionId: string | null, keyword?: string | null, limit?: number, offset?: number}): Promise<Response<PagedRetrieveUserAcceptedAgreementResponse>> {
