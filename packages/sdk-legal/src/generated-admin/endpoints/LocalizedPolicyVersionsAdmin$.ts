...
export class LocalizedPolicyVersionsAdmin$ {
  ...
  getLocalizedPolicyVersion_ByLocalizedPolicyVersionId(localizedPolicyVersionId:string): Promise<Response<RetrieveLocalizedPolicyVersionResponse>> {
    ...
    const url = '/agreement/admin/localized-policy-versions/{localizedPolicyVersionId}'.replace('{localizedPolicyVersionId}', localizedPolicyVersionId)     
  ...
  patchDefault_ByLocalizedPolicyVersionId(localizedPolicyVersionId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/agreement/admin/localized-policy-versions/{localizedPolicyVersionId}/default'.replace('{localizedPolicyVersionId}', localizedPolicyVersionId)     
  ...
  createAttachment_ByLocalizedPolicyVersionId(localizedPolicyVersionId:string, data: UploadPolicyVersionAttachmentRequest): Promise<Response<UploadLocalizedPolicyVersionAttachmentResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/agreement/admin/localized-policy-versions/{localizedPolicyVersionId}/attachments'.replace('{localizedPolicyVersionId}', localizedPolicyVersionId)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
