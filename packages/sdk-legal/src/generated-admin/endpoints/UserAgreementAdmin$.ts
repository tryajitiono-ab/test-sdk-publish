...
export class UserAgreementAdmin$ {
   ...
   */
  createAgreementPolicy_ByUserId(userId:string, data: AcceptAgreementRequest[], queryParams: {clientId: string | null, countryCode: string | null, publisherUserId?: string | null}): Promise<Response<AcceptAgreementResponse>> {
