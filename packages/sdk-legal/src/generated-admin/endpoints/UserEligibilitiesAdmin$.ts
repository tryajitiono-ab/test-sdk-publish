...
export class UserEligibilitiesAdmin$ {
   ...
   */
  getEligibilities_ByUserId(userId:string,  queryParams: {clientId: string | null, countryCode: string | null, publisherUserId?: string | null}): Promise<Response<RetrieveUserEligibilitiesIndirectResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, RetrieveUserEligibilitiesIndirectResponse, 'RetrieveUserEligibilitiesIndirectResponse')
  }
