...
export class AgreementWithNamespaceAdmin$ {
  ...
  createAgreement(data: UsersAgreementsRequest): Promise<Response<UserAgreementsResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UserAgreementsResponseArray, 'UserAgreementsResponseArray')
  }
  
  /**
   * This API will return all users who has accepted a specific policy version. 
   */
  getAgreementsPolicyVersionsUsers( queryParams: {policyVersionId: string | null, convertGameUserId?: boolean | null, keyword?: string | null, limit?: number, offset?: number}): Promise<Response<PagedRetrieveUserAcceptedAgreementResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PagedRetrieveUserAcceptedAgreementResponse, 'PagedRetrieveUserAcceptedAgreementResponse')
  }
  
  /**
   * This API will return all accepted Legal Agreements for specified user. 
   */
  getAgreementPolicyUser_ByUserId(userId:string,  queryParams?: {excludeOtherNamespacesPolicies?: boolean | null}): Promise<Response<RetrieveAcceptedAgreementResponseArray>> {
   ...
   */
  getAgreementsPolicyVersionsUsersExportCsvDownload( queryParams: {exportId: string | null}): Promise<Response<DownloadExportedAgreementsInCsvResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/agreement/admin/namespaces/{namespace}/agreements/policy-versions/users/export-csv/download'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DownloadExportedAgreementsInCsvResponse, 'DownloadExportedAgreementsInCsvResponse')
  }
   ...
   */
  createAgreementPolicyVersionUserExportCsvInitiate( queryParams: {policyVersionId: string | null, start: string | null, end?: string | null}): Promise<Response<InitiateExportAgreementsToCsvResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/agreement/admin/namespaces/{namespace}/agreements/policy-versions/users/export-csv/initiate'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.post(url, null, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, InitiateExportAgreementsToCsvResponse, 'InitiateExportAgreementsToCsvResponse')
  }
