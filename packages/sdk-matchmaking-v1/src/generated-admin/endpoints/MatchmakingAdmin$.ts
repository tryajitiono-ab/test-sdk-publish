...
export class MatchmakingAdmin$ {
   ...
   */
  getChannelsExport(): Promise<Response<unknown>> {
   ...
   */
  updateChannelImport(data: {file?: File,strategy?: string | null}): Promise<Response<ImportConfigResponse>> {
    const params = {} as AxiosRequestConfig
...
// TODO file upload not implemented
   ...
   */
  getChannelsAllParties(): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
  ...
  getChannel_ByChannelName(channelName:string): Promise<Response<ChannelV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  patchChannel_ByChannelName(channelName:string, data: UpdateChannelRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
   ...
   */
  getSessionsHistorySearch( queryParams: {limit: number, offset: number, channel?: string | null, deleted?: boolean | null, matchID?: string | null, partyID?: string | null, userID?: string | null}): Promise<Response<GetSessionHistorySearchResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/sessions/history/search'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetSessionHistorySearchResponse, 'GetSessionHistorySearchResponse')
  }
   ...
   */
  getSessionsHistorySearch_v2( queryParams: {limit: number, offset: number, channel?: string | null, deleted?: boolean | null, matchID?: string | null, partyID?: string | null, userID?: string | null}): Promise<Response<GetSessionHistorySearchResponseV2>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/matchmaking/v2/admin/namespaces/{namespace}/sessions/history/search'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetSessionHistorySearchResponseV2, 'GetSessionHistorySearchResponseV2')
  }
  
  /**
   * Bulk get sessions. 
   */
  getChannelsAllSessionsBulk( queryParams?: {matchIDs?: string | null}): Promise<Response<MatchmakingResultArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/all/sessions/bulk'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, MatchmakingResultArray, 'MatchmakingResultArray')
  }
  
  /**
   *  Get a channel&#39;s stat data (mean, stddev, min, max) according to the stats collected from statistics service. &#39; 
   */
  getStats_ByChannelName(channelName:string): Promise<Response<StatResumeResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/stats'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  getParties_ByChannelName(channelName:string): Promise<Response<MatchingPartyArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/parties'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})
   ...
   */
  getSessions_ByChannelName(channelName:string): Promise<Response<MatchmakingResultArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/sessions'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getHistoryDetailed_ByMatchId(matchID:string): Promise<Response<GetSessionHistoryDetailedResponseItemArray>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/sessions/{matchID}/history/detailed'.replace('{namespace}', this.namespace).replace('{matchID}', matchID)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetSessionHistoryDetailedResponseItemArray, 'GetSessionHistoryDetailedResponseItemArray')
  }
  
  /**
   * Delete a session in a channel. 
   */
  deleteSession_ByChannelName_ByMatchId(channelName:string, matchID:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/sessions/{matchID}'.replace('{namespace}', this.namespace).replace('{channelName}', channelName).replace('{matchID}', matchID)     
   ...
   */
  createSession_ByChannelName_ByMatchId(channelName:string, matchID:string, data: MatchAddUserIntoSessionRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/sessions/{matchID}'.replace('{namespace}', this.namespace).replace('{channelName}', channelName).replace('{matchID}', matchID)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
   ...
   */
  deleteUser_ByChannelName_ByMatchId_ByUserId(channelName:string, matchID:string, userID:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/sessions/{matchID}/users/{userID}'.replace('{namespace}', this.namespace).replace('{channelName}', channelName).replace('{matchID}', matchID).replace('{userID}', userID)     
    const resultPromise = this.axiosInstance.delete(url, {params})
