...
export class MockMatchmakingAdmin$ {
  ...
  deleteMock_ByChannelName(channelName:string): Promise<Response<unknown>> {
    ...
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/mocks'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
  ...
  getMocksMatches_ByChannelName(channelName:string): Promise<Response<GetMockMatchesResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/mocks/matches'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetMockMatchesResponse, 'GetMockMatchesResponse')
  }
  ...
  getMocksTickets_ByChannelName(channelName:string): Promise<Response<GetMockTicketsResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/mocks/tickets'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetMockTicketsResponse, 'GetMockTicketsResponse')
  }
  ...
  createMockTicketBulk_ByChannelName(channelName:string, data: MatchingParty[]): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/mocks/tickets/bulk'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  fetchMockTicketQuery_ByChannelName(channelName:string, data: QueryMockBy): Promise<Response<GetMockTicketsResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/admin/namespaces/{namespace}/channels/{channelName}/mocks/tickets/query'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
