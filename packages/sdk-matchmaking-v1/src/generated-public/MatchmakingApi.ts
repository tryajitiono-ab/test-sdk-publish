...
export function MatchmakingApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  return {
    getChannels,createChannel,createSession,updateRebalance,createMatchresult,updateSessionDequeue,deleteChannel_ByChannel,getChannels_ByNS,getStatus_ByMatchId,getMetrics_ByChannelName,getChannel_ByChannelName,
  }
}
