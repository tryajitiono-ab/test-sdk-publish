...
export class Matchmaking$ {
  ...
  deleteChannel_ByChannel(channel:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/namespaces/{namespace}/channels/{channel}'.replace('{namespace}', this.namespace).replace('{channel}', channel)     
  ...
  getStatus_ByMatchId(matchID:string): Promise<Response<MatchmakingResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/namespaces/{namespace}/sessions/{matchID}/status'.replace('{namespace}', this.namespace).replace('{matchID}', matchID)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getMetrics_ByChannelName(channelName:string): Promise<Response<TicketMetricResultRecord>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/namespaces/{namespace}/channels/{channelName}/metrics'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TicketMetricResultRecord, 'TicketMetricResultRecord')
  }
  ...
  getChannel_ByChannelName(channelName:string): Promise<Response<ChannelV1>> {
    const params = {} as AxiosRequestConfig
    const url = '/matchmaking/v1/public/namespaces/{namespace}/channels/{channelName}'.replace('{namespace}', this.namespace).replace('{channelName}', channelName)     
    const resultPromise = this.axiosInstance.get(url, {params})
