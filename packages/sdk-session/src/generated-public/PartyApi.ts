...
export function PartyApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getUsersMeParties( queryParams?: {order?: string | null, orderBy?: string | null, status?: string | null}): Promise<AxiosResponse<PartyQueryResponse>> {
    const $ = new Party$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createParty,getUsersMeParties,getParty_ByPartyId,patchParty_ByPartyId,updateParty_ByPartyId,deleteCode_ByPartyId,updateCode_ByPartyId,createInvite_ByPartyId,updateLeader_ByPartyId,createPartyUserMeJoinCode,createUserMeJoin_ByPartyId,deleteUserMeLeave_ByPartyId,deleteUserMeReject_ByPartyId,deleteKick_ByPartyId_ByUserId,deleteCancel_ByPartyId_ByUserId,
  }
}
