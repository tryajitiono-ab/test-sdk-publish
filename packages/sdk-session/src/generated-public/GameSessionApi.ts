...
export function GameSessionApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function createGamesession(data: CreateGameSessionRequest): Promise<AxiosResponse<GameSessionResponse>> {
   ...
   */
  async function getUsersMeGamesessions( queryParams?: {order?: string | null, orderBy?: string | null, status?: string | null}): Promise<AxiosResponse<GameSessionQueryResponse>> {
    const $ = new GameSession$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchGamesession_BySessionId(sessionId:string, data: UpdateGameSessionRequest): Promise<AxiosResponse<GameSessionResponse>> {
    const $ = new GameSession$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateGamesession_BySessionId(sessionId:string, data: UpdateGameSessionRequest): Promise<AxiosResponse<GameSessionResponse>> {
    const $ = new GameSession$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateTeam_BySessionId(sessionId:string, data: AppendTeamGameSessionRequest): Promise<AxiosResponse<GameSessionResponse>> {
    const $ = new GameSession$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateBackfill_BySessionId(sessionId:string, data: UpdateGameSessionBackfillRequest): Promise<AxiosResponse<GameSessionResponse>> {
    const $ = new GameSession$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    createGamesession,createGamesession_ByNS,getUsersMeGamesessions,createGamesessionJoinCode,deleteGamesession_BySessionId,getGamesession_BySessionId,patchGamesession_BySessionId,updateGamesession_BySessionId,deleteCode_BySessionId,updateCode_BySessionId,createJoin_BySessionId,deleteLeave_BySessionId,updateTeam_BySessionId,getGamesessionServer_ByPodName,createInvite_BySessionId,updateLeader_BySessionId,deleteReject_BySessionId,getSecret_BySessionId,updateBackfill_BySessionId,deleteCancel_BySessionId_ByUserId,deleteKick_BySessionId_ByMemberId,
  }
}
