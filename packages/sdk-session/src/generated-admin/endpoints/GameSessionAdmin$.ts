...
export class GameSessionAdmin$ {
   ...
   */
  getGamesessions( queryParams?: {configurationName?: string | null, dsPodName?: string | null, fromTime?: string | null, gameMode?: string | null, isPersistent?: string | null, isSoftDeleted?: string | null, joinability?: string | null, limit?: number, matchPool?: string | null, memberID?: string | null, offset?: number, order?: string | null, orderBy?: string | null, sessionID?: string | null, status?: string | null, statusV2?: string | null, toTime?: string | null}): Promise<Response<GameSessionQueryResponse>> {
    const params = {limit: 20, ...queryParams} as AxiosRequestConfig
    const url = '/session/v1/admin/namespaces/{namespace}/gamesessions'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GameSessionQueryResponse, 'GameSessionQueryResponse')
  }
  ...
  deleteGamesessionBulk(data: DeleteBulkGameSessionRequest): Promise<Response<DeleteBulkGameSessionsApiResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DeleteBulkGameSessionsApiResponse, 'DeleteBulkGameSessionsApiResponse')
  }
  ...
  updateStatu_BySessionId_ByMemberId_ByStatusType(sessionId:string, memberId:string, statusType:string): Promise<Response<UpdateGameSessionMemberStatusResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UpdateGameSessionMemberStatusResponse, 'UpdateGameSessionMemberStatusResponse')
  }
