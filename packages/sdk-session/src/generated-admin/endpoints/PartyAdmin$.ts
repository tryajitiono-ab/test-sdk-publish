...
export class PartyAdmin$ {
   ...
   * Query parties. 
   */
  getParties( queryParams?: {isSoftDeleted?: string | null, joinability?: string | null, key?: string | null, leaderID?: string | null, limit?: number, memberID?: string | null, memberStatus?: string | null, offset?: number, order?: string | null, orderBy?: string | null, partyID?: string | null, value?: string | null}): Promise<Response<PartyQueryResponse>> {
