...
export function GameSessionAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getGamesessions( queryParams?: {configurationName?: string | null, dsPodName?: string | null, fromTime?: string | null, gameMode?: string | null, isPersistent?: string | null, isSoftDeleted?: string | null, joinability?: string | null, limit?: number, matchPool?: string | null, memberID?: string | null, offset?: number, order?: string | null, orderBy?: string | null, sessionID?: string | null, status?: string | null, statusV2?: string | null, toTime?: string | null}): Promise<AxiosResponse<GameSessionQueryResponse>> {
   ...
   */
  async function updateStatu_BySessionId_ByMemberId_ByStatusType(sessionId:string, memberId:string, statusType:string): Promise<AxiosResponse<UpdateGameSessionMemberStatusResponse>> {
    const $ = new GameSessionAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getGamesessions,fetchGamesession,deleteGamesessionBulk,updateD_BySessionId,deleteKick_BySessionId_ByMemberId,updateStatu_BySessionId_ByMemberId_ByStatusType,
  }
}
