...
export function ConfigurationTemplateAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getConfigurations( queryParams?: {limit?: number, name?: string | null, offset?: number, order?: string | null, orderBy?: string | null}): Promise<AxiosResponse<ConfigurationTemplatesResponse>> {
    const $ = new ConfigurationTemplateAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateConfiguration_ByName(name:string, data: UpdateConfigurationTemplateRequest): Promise<AxiosResponse<ConfigurationTemplateResponse>> {
    const $ = new ConfigurationTemplateAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getDsconfigs,createConfiguration,getConfigurations,getDsconfigsSync,deleteAlertsConfiguration,getAlertsConfiguration,updateAlertsConfiguration,updateAlertsConfiguration_ByNS,deleteConfiguration_ByName,getConfiguration_ByName,updateConfiguration_ByName,
  }
}
