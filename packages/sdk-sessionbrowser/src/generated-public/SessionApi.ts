...
export function SessionApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  return {
    getGamesession,createGamesession,getGamesessionBulk,getRecentplayer_ByUserId,deleteGamesession_BySessionId,getGamesession_BySessionId,updateGamesession_BySessionId,fetchJoin_BySessionId,updatePlayer_BySessionId,deleteLocald_BySessionId,updateSetting_BySessionId,deletePlayer_BySessionId_ByUserId,
  }
}
