...
export function LeaderboardDataApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   * Get rankings in an all time leaderboard. 
   */
  async function getAlltime_ByLeaderboardCode_v2(leaderboardCode:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<GetPublicLeaderboardRankingResponse>> {
    const $ = new LeaderboardData$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getArchived_ByLeaderboardCode(leaderboardCode:string,  queryParams: {leaderboardCodes: string | null, slug?: string | null}): Promise<AxiosResponse<ArchiveLeaderboardSignedUrlResponseArray>> {
    const $ = new LeaderboardData$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getWeek_ByLeaderboardCode,getMonth_ByLeaderboardCode,getToday_ByLeaderboardCode,getSeason_ByLeaderboardCode,getAlltime_ByLeaderboardCode,getAlltime_ByLeaderboardCode_v2,getArchived_ByLeaderboardCode,deleteUser_ByLeaderboardCode_ByUserId,getUser_ByLeaderboardCode_ByUserId,
  }
}
