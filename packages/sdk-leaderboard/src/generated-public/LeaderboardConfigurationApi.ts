...
export function LeaderboardConfigurationApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getLeaderboards( queryParams?: {isArchived?: boolean | null, isDeleted?: boolean | null, limit?: number, offset?: number}): Promise<AxiosResponse<GetAllLeaderboardConfigsPublicResp>> {
   ...
   */
  async function getLeaderboards_v2( queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<GetAllLeaderboardConfigsPublicResp>> {
    const $ = new LeaderboardConfiguration$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getLeaderboards,createLeaderboard,getLeaderboards_v2,
  }
}
