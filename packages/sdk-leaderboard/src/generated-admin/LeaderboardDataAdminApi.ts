...
export function LeaderboardDataAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getLeaderboardsArchived( queryParams: {leaderboardCodes: string | null, slug?: string | null}): Promise<AxiosResponse<ArchiveLeaderboardSignedUrlResponseArray>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getWeek_ByLeaderboardCode(leaderboardCode:string,  queryParams?: {limit?: number, offset?: number, previousVersion?: number}): Promise<AxiosResponse<GetLeaderboardRankingResp>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getMonth_ByLeaderboardCode(leaderboardCode:string,  queryParams?: {limit?: number, offset?: number, previousVersion?: number}): Promise<AxiosResponse<GetLeaderboardRankingResp>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getToday_ByLeaderboardCode(leaderboardCode:string,  queryParams?: {limit?: number, offset?: number, previousVersion?: number}): Promise<AxiosResponse<GetLeaderboardRankingResp>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getSeason_ByLeaderboardCode(leaderboardCode:string,  queryParams?: {limit?: number, offset?: number, previousVersion?: number}): Promise<AxiosResponse<GetLeaderboardRankingResp>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getAlltime_ByLeaderboardCode(leaderboardCode:string,  queryParams?: {limit?: number, offset?: number}): Promise<AxiosResponse<GetLeaderboardRankingResp>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function getUser_ByLeaderboardCode_ByUserId(leaderboardCode:string, userId:string,  queryParams?: {previousVersion?: number}): Promise<AxiosResponse<UserRankingResponse>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function updateUser_ByLeaderboardCode_ByUserId(leaderboardCode:string, userId:string, data: UpdateUserPointAdminV1Request): Promise<AxiosResponse<UpdateUserPointAdminV1Response>> {
    const $ = new LeaderboardDataAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    deleteUser_ByUserId,getLeaderboardsArchived,createLeaderboardArchived,getWeek_ByLeaderboardCode,getMonth_ByLeaderboardCode,deleteReset_ByLeaderboardCode,getToday_ByLeaderboardCode,getSeason_ByLeaderboardCode,getAlltime_ByLeaderboardCode,deleteUser_ByLeaderboardCode_ByUserId,getUser_ByLeaderboardCode_ByUserId,updateUser_ByLeaderboardCode_ByUserId,
  }
}
