...
export class LeaderboardConfigurationAdmin$ {
   ...
   */
  getLeaderboards( queryParams?: {isArchived?: boolean | null, isDeleted?: boolean | null, limit?: number, offset?: number}): Promise<Response<GetAllLeaderboardConfigsResp>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/leaderboard/v1/admin/namespaces/{namespace}/leaderboards'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetAllLeaderboardConfigsResp, 'GetAllLeaderboardConfigsResp')
  }
  ...
  createLeaderboardDelete(data: DeleteBulkLeaderboardsReq): Promise<Response<DeleteBulkLeaderboardsResp>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DeleteBulkLeaderboardsResp, 'DeleteBulkLeaderboardsResp')
  }
  ...
  deleteLeaderboard_ByLeaderboardCode(leaderboardCode:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}'.replace('{namespace}', this.namespace).replace('{leaderboardCode}', leaderboardCode)     
  ...
  getLeaderboard_ByLeaderboardCode(leaderboardCode:string): Promise<Response<GetLeaderboardConfigResp>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetLeaderboardConfigResp, 'GetLeaderboardConfigResp')
  }
   ...
   */
  updateLeaderboard_ByLeaderboardCode(leaderboardCode:string, data: UpdateLeaderboardConfigReq): Promise<Response<GetLeaderboardConfigResp>> {
    const params = {} as AxiosRequestConfig
    const url = '/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}'.replace('{namespace}', this.namespace).replace('{leaderboardCode}', leaderboardCode)     
  ...
  deleteHard_ByLeaderboardCode(leaderboardCode:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/leaderboard/v1/admin/namespaces/{namespace}/leaderboards/{leaderboardCode}/hard'.replace('{namespace}', this.namespace).replace('{leaderboardCode}', leaderboardCode)     
    const resultPromise = this.axiosInstance.delete(url, {params})
