...
export function LeaderboardConfigurationAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getLeaderboards( queryParams?: {isArchived?: boolean | null, isDeleted?: boolean | null, limit?: number, offset?: number}): Promise<AxiosResponse<GetAllLeaderboardConfigsResp>> {
   ...
   */
  async function updateLeaderboard_ByLeaderboardCode(leaderboardCode:string, data: UpdateLeaderboardConfigReq): Promise<AxiosResponse<GetLeaderboardConfigResp>> {
    const $ = new LeaderboardConfigurationAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getLeaderboards,createLeaderboard,createLeaderboardDelete,deleteLeaderboard_ByLeaderboardCode,getLeaderboard_ByLeaderboardCode,updateLeaderboard_ByLeaderboardCode,deleteHard_ByLeaderboardCode,
  }
}
