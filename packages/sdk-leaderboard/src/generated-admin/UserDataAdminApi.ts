...
export function UserDataAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getLeaderboards_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, previousVersion?: number}): Promise<AxiosResponse<GetAllUserLeaderboardsResp>> {
