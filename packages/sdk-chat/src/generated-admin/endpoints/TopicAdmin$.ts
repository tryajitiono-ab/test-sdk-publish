...
export class TopicAdmin$ {
   ...
   */
  getChats( queryParams?: {chatId?: string[], endCreatedAt?: number, keyword?: string | null, limit?: number, offset?: number, order?: string | null, senderUserId?: string | null, shardId?: string | null, startCreatedAt?: number, topic?: string[], unfiltered?: boolean | null}): Promise<Response<ChatMessageWithPaginationResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/chats'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ChatMessageWithPaginationResponse, 'ChatMessageWithPaginationResponse')
  }
   ...
   */
  getTopics( queryParams?: {includeMembers?: boolean | null, includePastMembers?: boolean | null, includePastTopics?: boolean | null, limit?: number, offset?: number, topic?: string[], topicSubType?: 'CLAN' | 'NAMESPACE' | 'NORMAL' | 'PARTY' | 'SESSION', topicType?: 'GROUP' | 'PERSONAL', userId?: string | null}): Promise<Response<TopicInfoArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
   ...
   */
  getTopicLog( queryParams?: {endCreatedAt?: number, limit?: number, offset?: number, senderUserId?: string | null, startCreatedAt?: number, topicId?: string | null, topicIds?: string[], userId?: string | null}): Promise<Response<TopicLogWithPaginationResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/log'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TopicLogWithPaginationResponse, 'TopicLogWithPaginationResponse')
  }
  ...
  fetchChatFilter(data: MessageRequest, queryParams?: {detail?: boolean | null}): Promise<Response<MessageResultWithAttributes>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, MessageResultWithAttributes, 'MessageResultWithAttributes')
  }
  ...
  deleteTopic_ByTopic(topic:string): Promise<Response<ActionDeleteTopicResult>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ActionDeleteTopicResult, 'ActionDeleteTopicResult')
  }
   ...
   */
  getTopicChannel( queryParams?: {limit?: number, offset?: number, topicName?: string | null}): Promise<Response<ChannelTopicWithPaginationResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/channel'.replace('{namespace}', this.namespace)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ChannelTopicWithPaginationResponse, 'ChannelTopicWithPaginationResponse')
  }
   ...
   * Get chat history in a namespace. 
   */
  getChats_ByTopic(topic:string,  queryParams?: {endCreatedAt?: number, keyword?: string | null, limit?: number, offset?: number, order?: string | null, senderUserId?: string | null, shardId?: string | null, startCreatedAt?: number, unfiltered?: boolean | null}): Promise<Response<ChatMessageWithPaginationResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  updateChat_ByTopic(topic:string, data: SendChatParams): Promise<Response<ChatMessageResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ChatMessageResponseArray, 'ChatMessageResponseArray')
  }
   ...
   * Get topic members. 
   */
  getMembers_ByTopic(topic:string,  queryParams?: {isBanned?: boolean | null, isModerator?: boolean | null, limit?: number, offset?: number, shardId?: string | null}): Promise<Response<TopicMemberWithPaginationResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/{topic}/members'.replace('{namespace}', this.namespace).replace('{topic}', topic)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, TopicMemberWithPaginationResponse, 'TopicMemberWithPaginationResponse')
  }
  ...
  getTopicChannelSummary(): Promise<Response<ChannelTopicSummaryResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ChannelTopicSummaryResponse, 'ChannelTopicSummaryResponse')
  }
  
  /**
   * Get user&#39;s topics in a namespace. 
   */
  getTopics_ByUserId(userId:string,  queryParams?: {includePastTopics?: boolean | null, limit?: number, offset?: number, topicSubType?: 'CLAN' | 'NAMESPACE' | 'NORMAL' | 'PARTY' | 'SESSION', topicType?: 'GROUP' | 'PERSONAL'}): Promise<Response<TopicLogWithPaginationResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/users/{userId}/topics'.replace('{namespace}', this.namespace).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  updateBanMember_ByTopic(topic:string, data: BanTopicMemberParam): Promise<Response<BanTopicMemberResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/{topic}/ban-members'.replace('{namespace}', this.namespace).replace('{topic}', topic)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  updateUnbanMember_ByTopic(topic:string, data: UnbanTopicMemberParam): Promise<Response<UnbanTopicMemberResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/{topic}/unban-members'.replace('{namespace}', this.namespace).replace('{topic}', topic)     
    const resultPromise = this.axiosInstance.post(url, data, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, UnbanTopicMemberResult, 'UnbanTopicMemberResult')
  }
  ...
  deleteUser_ByTopic_ByUserId(topic:string, userId:string): Promise<Response<ActionAddUserToTopicResult>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/{topic}/user/{userId}'.replace('{namespace}', this.namespace).replace('{topic}', topic).replace('{userId}', userId)     
    const resultPromise = this.axiosInstance.delete(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ActionAddUserToTopicResult, 'ActionAddUserToTopicResult')
  }
  ...
  deleteChat_ByTopic_ByChatId(topic:string, chatId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/admin/namespaces/{namespace}/topic/{topic}/chats/{chatId}'.replace('{namespace}', this.namespace).replace('{topic}', topic).replace('{chatId}', chatId)     
    const resultPromise = this.axiosInstance.delete(url, {params})
