...
export class ProfanityAdmin$ {
   ...
   */
  getProfanityDictionary( queryParams?: {filterMask?: string | null, includeChildren?: boolean | null, limit?: number, offset?: number, parentId?: string | null, startWith?: string | null, wordType?: string | null}): Promise<Response<DictionaryQueryResult>> {
   ...
   */
  createProfanityDictionaryImport(data: {file: File}, queryParams?: {action?: 'FULLREPLACE' | 'LEAVEOUT' | 'REPLACE', showResult?: boolean | null}): Promise<Response<DictionaryImportResult>> {
...
// TODO file upload not implemented
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DictionaryImportResult, 'DictionaryImportResult')
  }
