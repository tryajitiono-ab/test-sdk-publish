...
export class Topic$ {
  ...
  getMuted(): Promise<Response<MutedTopicResponseArray>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, MutedTopicResponseArray, 'MutedTopicResponseArray')
  }
   ...
   */
  getChats_ByTopic(topic:string,  queryParams?: {limit?: number, order?: string | null, startCreatedAt?: number}): Promise<Response<ChatMessageResponseArray>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  updateBanMember_ByTopic(topic:string, data: PublicBanTopicMembersRequest): Promise<Response<PublicBanTopicMembersResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/public/namespaces/{namespace}/topic/{topic}/ban-members'.replace('{namespace}', this.namespace).replace('{topic}', topic)     
    const resultPromise = this.axiosInstance.post(url, data, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PublicBanTopicMembersResponse, 'PublicBanTopicMembersResponse')
  }
  ...
  updateUnbanMember_ByTopic(topic:string, data: PublicUnbanTopicMembersRequest): Promise<Response<PublicUnbanTopicMembersResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/public/namespaces/{namespace}/topic/{topic}/unban-members'.replace('{namespace}', this.namespace).replace('{topic}', topic)     
    const resultPromise = this.axiosInstance.post(url, data, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PublicUnbanTopicMembersResponse, 'PublicUnbanTopicMembersResponse')
  }
  ...
  deleteChat_ByTopic_ByChatId(topic:string, chatId:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/chat/public/namespaces/{namespace}/topic/{topic}/chats/{chatId}'.replace('{namespace}', this.namespace).replace('{topic}', topic).replace('{chatId}', chatId)     
