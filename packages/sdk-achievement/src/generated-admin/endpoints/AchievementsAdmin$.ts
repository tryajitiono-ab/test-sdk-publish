...
export class AchievementsAdmin$ {
   ...
   */
  getAchievements( queryParams?: {global?: boolean | null, limit?: number, offset?: number, sortBy?: 'listOrder' | 'listOrder:asc' | 'listOrder:desc' | 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'updatedAt' | 'updatedAt:asc' | 'updatedAt:desc', tags?: string[]}): Promise<Response<PaginatedAchievementResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PaginatedAchievementResponse, 'PaginatedAchievementResponse')
  }
...
// TODO file upload not implemented
  ...
  deleteAchievement_ByAchievementCode(achievementCode:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/achievement/v1/admin/namespaces/{namespace}/achievements/{achievementCode}'.replace('{namespace}', this.namespace).replace('{achievementCode}', achievementCode)     
