...
export const useAchievementsAdminApi_GetAchievements = (
    sdk: AccelByteSDK,
    input: SdkSetConfigParam & {  queryParams?: {global?: boolean | null, limit?: number, offset?: number, sortBy?: 'listOrder' | 'listOrder:asc' | 'listOrder:desc' | 'createdAt' | 'createdAt:asc' | 'createdAt:desc' | 'updatedAt' | 'updatedAt:asc' | 'updatedAt:desc', tags?: string[]} },
  ...
  const queryFn = (
  sdk: AccelByteSDK, 
  input: Parameters<typeof useAchievementsAdminApi_GetAchievements>[1]
  ) => async () => {
      const response = 
            (await AchievementsAdminApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
                getAchievements(input.queryParams))
...
export const useAchievementsAdminApi_CreateAchievement = (
    sdk: AccelByteSDK,
    options?: Omit<UseMutationOptions<AchievementResponse, AxiosError<ApiError>, SdkSetConfigParam & { data: AchievementRequest }>, 'mutationKey'>,
...
export const useAchievementsAdminApi_GetAchievementsExport = (
  ...
  const queryFn = (
  sdk: AccelByteSDK, 
  input: Parameters<typeof useAchievementsAdminApi_GetAchievementsExport>[1]
  ) => async () => {
      const response = 
            (await AchievementsAdminApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
...
export const useAchievementsAdminApi_GetAchievement_ByAchievementCode = (
  ...
  const queryFn = (
  sdk: AccelByteSDK, 
  input: Parameters<typeof useAchievementsAdminApi_GetAchievement_ByAchievementCode>[1]
  ) => async () => {
      const response = 
            (await AchievementsAdminApi(sdk, { coreConfig: input.coreConfig, axiosConfig: input.axiosConfig }).
...
export const useAchievementsAdminApi_PatchAchievement_ByAchievementCode = (
    sdk: AccelByteSDK,
    options?: Omit<UseMutationOptions<unknown, AxiosError<ApiError>, SdkSetConfigParam & { achievementCode:string, data: AchievementOrderUpdateRequest }>, 'mutationKey'>,
    callback?: (data: unknown) => void
  ): UseMutationResult<unknown, AxiosError<ApiError>, SdkSetConfigParam & { achievementCode:string, data: AchievementOrderUpdateRequest }> => { 
...
export const useAchievementsAdminApi_UpdateAchievement_ByAchievementCode = (
    sdk: AccelByteSDK,
    options?: Omit<UseMutationOptions<AchievementResponse, AxiosError<ApiError>, SdkSetConfigParam & { achievementCode:string, data: AchievementUpdateRequest }>, 'mutationKey'>,
    callback?: (data: AchievementResponse) => void
  ): UseMutationResult<AchievementResponse, AxiosError<ApiError>, SdkSetConfigParam & { achievementCode:string, data: AchievementUpdateRequest }> => { 
