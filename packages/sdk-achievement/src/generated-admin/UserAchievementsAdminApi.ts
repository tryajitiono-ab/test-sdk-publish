...
export function UserAchievementsAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getAchievements_ByUserId(userId:string,  queryParams?: {limit?: number, offset?: number, preferUnlocked?: boolean | null, sortBy?: string | null, tags?: string[]}): Promise<AxiosResponse<PaginatedUserAchievementResponse>> {
  ...
  return {
    getAchievements_ByUserId,deleteReset_ByUserId_ByAchievementCode,updateUnlock_ByUserId_ByAchievementCode,
  }
}
