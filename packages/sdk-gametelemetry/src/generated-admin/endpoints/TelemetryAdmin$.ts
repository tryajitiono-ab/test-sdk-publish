...
export class TelemetryAdmin$ {
   ...
   */
  getEvents( queryParams?: {startTime?: string | null, endTime?: string | null, offset?: number, limit?: number, userId?: string | null, flightId?: string | null, eventId?: string | null, eventName?: string | null, eventPayload?: string | null, deviceType?: string | null}): Promise<Response<PagedResponseGetNamespaceEventResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, PagedResponseGetNamespaceEventResponse, 'PagedResponseGetNamespaceEventResponse')
  }
