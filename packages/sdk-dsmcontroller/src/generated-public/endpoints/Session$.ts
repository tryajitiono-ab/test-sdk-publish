...
export class Session$ {
   ...
   */
  createSession(data: CreateSessionRequest): Promise<Response<SessionResponse>> {
   ...
   */
  createSessionClaim(data: ClaimSessionRequest): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
   ...
   */
  getSession_BySessionId(sessionID:string): Promise<Response<SessionResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/namespaces/{namespace}/sessions/{sessionID}'.replace('{namespace}', this.namespace).replace('{sessionID}', sessionID)     
   ...
   */
  deleteCancel_BySessionId(sessionID:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/namespaces/{namespace}/sessions/{sessionID}/cancel'.replace('{namespace}', this.namespace).replace('{sessionID}', sessionID)     
