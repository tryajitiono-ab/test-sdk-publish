...
export class Server$ {
  ...
  getSession_ByPodName(podName:string): Promise<Response<ServerSessionResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/namespaces/{namespace}/servers/{podName}/session'.replace('{namespace}', this.namespace).replace('{podName}', podName)     
    const resultPromise = this.axiosInstance.get(url, {params})
  ...
  getConfigSessiontimeout_ByPodName(podName:string): Promise<Response<ServerDeploymentConfigSessionTimeoutResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/namespaces/{namespace}/servers/{podName}/config/sessiontimeout'.replace('{namespace}', this.namespace).replace('{podName}', podName)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ServerDeploymentConfigSessionTimeoutResponse, 'ServerDeploymentConfigSessionTimeoutResponse')
  }
