...
export function ServerApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  return {
    getServers,createServerRegister,createServerShutdown,updateServerHeartbeat,getServersCountDetailed,createServerLocalRegister,createServerLocalDeregister,getSession_ByPodName,getConfigSessiontimeout_ByPodName,
  }
}
