...
export class ImageConfigAdmin$ {
   ...
   */
  getImages( queryParams: {count: number, offset: number, q?: string | null, sortBy?: 'createdAt' | 'updatedAt' | 'version', sortDirection?: 'asc' | 'desc'}): Promise<Response<ListImageResponse>> {
   ...
   */
  deleteImagePatche( queryParams: {imageURI: string | null, version: string | null, versionPatch: string | null}): Promise<Response<unknown>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  getImageVersion_ByVersion(version:string): Promise<Response<GetImageDetailResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/images/versions/{version}'.replace('{namespace}', this.namespace).replace('{version}', version)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetImageDetailResponse, 'GetImageDetailResponse')
  }
  ...
  getPatchesImages_ByVersion(version:string): Promise<Response<ListImagePatchesResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/images/versions/{version}/patches'.replace('{namespace}', this.namespace).replace('{version}', version)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, ListImagePatchesResponse, 'ListImagePatchesResponse')
  }
  ...
  getPatcheImage_ByVersion_ByVersionPatch(version:string, versionPatch:string): Promise<Response<GetImagePatchDetailResponse>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/images/versions/{version}/patches/{versionPatch}'.replace('{namespace}', this.namespace).replace('{version}', version).replace('{versionPatch}', versionPatch)     
    const resultPromise = this.axiosInstance.get(url, {params})

    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, GetImagePatchDetailResponse, 'GetImagePatchDetailResponse')
  }
