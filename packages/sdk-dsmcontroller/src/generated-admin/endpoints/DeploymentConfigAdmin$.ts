...
export class DeploymentConfigAdmin$ {
  ...
  deleteConfigDeployment_ByDeployment(deployment:string): Promise<Response<unknown>> {
    ...
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment)     
  ...
  deleteQueueConfig_ByDeployment_ByVersion(deployment:string, version:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/versions/{version}/queues'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  deleteOverrideRegionConfig_ByDeployment_ByRegion(deployment:string, region:string): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/regions/{region}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{region}', region)     
    const resultPromise = this.axiosInstance.delete(url, {params})
   ...
   */
  patchOverrideRegionConfig_ByDeployment_ByRegion(deployment:string, region:string, data: UpdateRegionOverrideRequest): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/regions/{region}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{region}', region)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
   ...
   */
  createOverrideRegionConfig_ByDeployment_ByRegion(deployment:string, region:string, data: CreateRegionOverrideRequest): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/regions/{region}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{region}', region)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
   ...
   */
  createOverrideVersionConfig_ByDeployment_ByVersion(deployment:string, version:string, data: CreateDeploymentOverrideRequest): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/version/{version}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
  ...
  deleteOverrideVersionConfig_ByDeployment_ByVersion(deployment:string, version:string): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/versions/{version}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version)     
    const resultPromise = this.axiosInstance.delete(url, {params})
   ...
   */
  patchOverrideVersionConfig_ByDeployment_ByVersion(deployment:string, version:string, data: UpdateDeploymentOverrideRequest): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/versions/{version}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
   ...
   */
  deleteRegionOverrideConfig_ByDeployment_ByVersion_ByRegion(deployment:string, version:string, region:string): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/versions/{version}/regions/{region}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version).replace('{region}', region)     
    const resultPromise = this.axiosInstance.delete(url, {params})
   ...
   */
  patchRegionOverrideConfig_ByDeployment_ByVersion_ByRegion(deployment:string, version:string, region:string, data: UpdateRegionOverrideRequest): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/versions/{version}/regions/{region}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version).replace('{region}', region)     
    const resultPromise = this.axiosInstance.patch(url, data, {params})
   ...
   */
  createRegionOverrideConfig_ByDeployment_ByVersion_ByRegion(deployment:string, version:string, region:string, data: CreateRegionOverrideRequest): Promise<Response<DeploymentWithOverride>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/configs/deployments/{deployment}/overrides/versions/{version}/regions/{region}'.replace('{namespace}', this.namespace).replace('{deployment}', deployment).replace('{version}', version).replace('{region}', region)     
    const resultPromise = this.axiosInstance.post(url, data, {params})
