...
export class AdminAdmin$ {
   ...
   */
  getSessions( queryParams: {count: number, offset: number, region?: string | null, withServer?: boolean | null}): Promise<Response<ListSessionResponse>> {
    const params = { ...queryParams} as AxiosRequestConfig
  ...
  deleteServer_ByPodName(podName:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/servers/{podName}'.replace('{namespace}', this.namespace).replace('{podName}', podName)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  deleteServerLocal_ByName(name:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/servers/local/{name}'.replace('{namespace}', this.namespace).replace('{name}', name)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  deleteSession_BySessionId(sessionID:string): Promise<Response<unknown>> {
    const params = {} as AxiosRequestConfig
    const url = '/dsmcontroller/admin/namespaces/{namespace}/sessions/{sessionID}'.replace('{namespace}', this.namespace).replace('{sessionID}', sessionID)     
    const resultPromise = this.axiosInstance.delete(url, {params})
  ...
  getServersCountDetailed( queryParams?: {region?: string | null}): Promise<Response<DetailedCountServerResponse>> {
    ...
    return Validate.validateOrReturnResponse(this.useSchemaValidation, () => resultPromise, DetailedCountServerResponse, 'DetailedCountServerResponse')
  }
