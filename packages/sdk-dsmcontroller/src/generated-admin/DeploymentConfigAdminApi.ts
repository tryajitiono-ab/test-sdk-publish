...
export function DeploymentConfigAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
   ...
   */
  async function getConfigsDeployments( queryParams: {count: number, offset: number, name?: string | null}): Promise<AxiosResponse<ListDeploymentResponse>> {
   ...
   */
  async function patchConfigDeployment_ByDeployment(deployment:string, data: UpdateDeploymentRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createConfigDeployment_ByDeployment(deployment:string, data: CreateDeploymentRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteOverrideRegionConfig_ByDeployment_ByRegion(deployment:string, region:string): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchOverrideRegionConfig_ByDeployment_ByRegion(deployment:string, region:string, data: UpdateRegionOverrideRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createOverrideRegionConfig_ByDeployment_ByRegion(deployment:string, region:string, data: CreateRegionOverrideRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createOverrideVersionConfig_ByDeployment_ByVersion(deployment:string, version:string, data: CreateDeploymentOverrideRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteOverrideVersionConfig_ByDeployment_ByVersion(deployment:string, version:string): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchOverrideVersionConfig_ByDeployment_ByVersion(deployment:string, version:string, data: UpdateDeploymentOverrideRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function deleteRegionOverrideConfig_ByDeployment_ByVersion_ByRegion(deployment:string, version:string, region:string): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function patchRegionOverrideConfig_ByDeployment_ByVersion_ByRegion(deployment:string, version:string, region:string, data: UpdateRegionOverrideRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
   ...
   */
  async function createRegionOverrideConfig_ByDeployment_ByVersion_ByRegion(deployment:string, version:string, region:string, data: CreateRegionOverrideRequest): Promise<AxiosResponse<DeploymentWithOverride>> {
    const $ = new DeploymentConfigAdmin$(axiosInstance, namespace, useSchemaValidation)
  ...
  return {
    getConfigsDeployments,deleteConfigDeployment_ByDeployment,getConfigDeployment_ByDeployment,patchConfigDeployment_ByDeployment,createConfigDeployment_ByDeployment,deleteQueueConfig_ByDeployment_ByVersion,deleteOverrideRegionConfig_ByDeployment_ByRegion,patchOverrideRegionConfig_ByDeployment_ByRegion,createOverrideRegionConfig_ByDeployment_ByRegion,createOverrideVersionConfig_ByDeployment_ByVersion,deleteOverrideVersionConfig_ByDeployment_ByVersion,patchOverrideVersionConfig_ByDeployment_ByVersion,deleteRegionOverrideConfig_ByDeployment_ByVersion_ByRegion,patchRegionOverrideConfig_ByDeployment_ByVersion_ByRegion,createRegionOverrideConfig_ByDeployment_ByVersion_ByRegion,
  }
}
