...
export function ConfigAdminApi(sdk: AccelByteSDK, args?: SdkSetConfigParam) {
  ...
  return {
    getConfigs,createConfig,deleteConfig,getConfigs_ByNS,patchConfig,createConfig_ByNS,deleteConfigCache,getConfigsExport,createConfigImport,deleteConfigPort_ByName,patchConfigPort_ByName,createConfigPort_ByName,
  }
}
