...
|-----------------------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|
| `clientId` (required)            | string  | The client ID associated with your SDK. You can obtain this from the AGS Admin Portal under IAM Clients.                                                                                                                                                |           |
...
- **onSessionExpired** and **onGetUserSession** (**createAuthInterceptor**)
  ...
  createAuthInterceptor({
    /**
     * The client ID used by the SDK, obtained from the Admin Portal under IAM Clients.
     */
    clientId: string
    /**
...
You can live test the TypeScript SDK on the [AccelByte Web SDK Playground](https://development.accelbyte.io/web-sdk-playground/).
